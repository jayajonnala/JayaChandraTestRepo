...
'''*****************TC1_Test_Import - regular goods_p1_TASE***************************
...
'''*****************DT1_2_DataTransfer_OneValue_Optimised_TASE***************************
DT_gstrInputExcelFilePathAndName= Parameter("DT1_2_gstrInputExcelFilePathAndName")	
DT_datatable_row= Parameter("DT1_2_datatable_row")	
DT_sourceField= Parameter("DT1_2_sourceField")	
DT_gstrTargetExcelFilePathAndName= Parameter("DT1_2_gstrTargetExcelFilePathAndName")	
DT_targetField= Parameter("DT1_2_targetField")	
DT_targetexcelrow= Parameter("DT1_2_targetexcelrow")	
DT_Path = Parameter("DT_Path")

LoadAndRunAction DT_Path,ActionName,TestIterationVal,DT_gstrInputExcelFilePathAndName,DT_datatable_row,DT_sourceField,DT_gstrTargetExcelFilePathAndName,DT_targetField,DT_targetexcelrow,gstrresultFolderPath,RunTimeResultFolder
Call PublishTestResults_PY(TestSetName,  StrValueOfLastElement(DT_Path,"\"), Environment.Value("TCExecutionStatus"), OpCoName, TargetCycle,  Environment.Value("HtmlResultReportpath"))

'''*****************DT1_3_DataTransfer_OneValue_Optimised_TASE***************************
DT_gstrInputExcelFilePathAndName= Parameter("DT1_3_gstrInputExcelFilePathAndName")	
DT_datatable_row= Parameter("DT1_3_datatable_row")	
DT_sourceField= Parameter("DT1_3_sourceField")	
DT_gstrTargetExcelFilePathAndName= Parameter("DT1_3_gstrTargetExcelFilePathAndName")	
DT_targetField= Parameter("DT1_3_targetField")	
DT_targetexcelrow= Parameter("DT1_3_targetexcelrow")	
DT_Path = Parameter("DT_Path")

LoadAndRunAction DT_Path,ActionName,TestIterationVal,DT_gstrInputExcelFilePathAndName,DT_datatable_row,DT_sourceField,DT_gstrTargetExcelFilePathAndName,DT_targetField,DT_targetexcelrow,gstrresultFolderPath,RunTimeResultFolder
Call PublishTestResults_PY(TestSetName,  StrValueOfLastElement(DT_Path,"\"), Environment.Value("TCExecutionStatus"), OpCoName, TargetCycle,  Environment.Value("HtmlResultReportpath"))

'''*****************DT1_4_DataTransfer_OneValue_Optimised_TASE***************************
DT_gstrInputExcelFilePathAndName= Parameter("DT1_4_gstrInputExcelFilePathAndName")	
DT_datatable_row= Parameter("DT1_4_datatable_row")	
DT_sourceField= Parameter("DT1_4_sourceField")	
DT_gstrTargetExcelFilePathAndName= Parameter("DT1_4_gstrTargetExcelFilePathAndName")	
DT_targetField= Parameter("DT1_4_targetField")	
DT_targetexcelrow= Parameter("DT1_4_targetexcelrow")	
DT_Path = Parameter("DT_Path")

LoadAndRunAction DT_Path,ActionName,TestIterationVal,DT_gstrInputExcelFilePathAndName,DT_datatable_row,DT_sourceField,DT_gstrTargetExcelFilePathAndName,DT_targetField,DT_targetexcelrow,gstrresultFolderPath,RunTimeResultFolder
Call PublishTestResults_PY(TestSetName,  StrValueOfLastElement(DT_Path,"\"), Environment.Value("TCExecutionStatus"), OpCoName, TargetCycle,  Environment.Value("HtmlResultReportpath"))

'''*****************DT1_5_DataTransfer_OneValue_Optimised_TASE***************************
DT_gstrInputExcelFilePathAndName= Parameter("DT1_5_gstrInputExcelFilePathAndName")	
DT_datatable_row= Parameter("DT1_5_datatable_row")	
DT_sourceField= Parameter("DT1_5_sourceField")	
DT_gstrTargetExcelFilePathAndName= Parameter("DT1_5_gstrTargetExcelFilePathAndName")	
DT_targetField= Parameter("DT1_5_targetField")	
DT_targetexcelrow= Parameter("DT1_5_targetexcelrow")	
DT_Path = Parameter("DT_Path")
...
'''*****************TC2_Test_Import - regular goods_p2_TASE***************************
...
''*****************TC3_Test_Import - regular goods_p3_TASE**************************
...
''*****************TC4_Test_Import - regular goods_p4_TASE***************************
