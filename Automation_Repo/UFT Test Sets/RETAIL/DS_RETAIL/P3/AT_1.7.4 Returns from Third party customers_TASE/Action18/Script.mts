...
'''*****************TC6_[1]Test_Returns from third party customers - Addition_TASE*****************This test case is having 3 Iterations*********************
'''***1st Iteration**
TC_Path = Parameter("TC6_Path")
TC_ExcelInputFile = Parameter("TC6_ExcelinputFile")
TC_DataRowNumber = Parameter("TC6_DataRowNumber")
...
'
''''***2nd Iteration**
'TC_DataRowNumber = Parameter("TC6_DataRowNumber_1")
'LoadAndRunAction TC_Path,ActionName,TestIterationVal,TC_ExcelInputFile,TC_DataRowNumber,gstrresultFolderPath,RunTimeResultFolder
'Call PublishTestResults_PY(TestSetName,  StrValueOfLastElement(TC_Path,"\"), Environment.Value("TCExecutionStatus"), OpCoName, TargetCycle,  Environment.Value("HtmlResultReportpath"),RunTimeId,Priority)
'
''''***3rd Iteration**
'TC_DataRowNumber = Parameter("TC6_DataRowNumber_2")
'LoadAndRunAction TC_Path,ActionName,TestIterationVal,TC_ExcelInputFile,TC_DataRowNumber,gstrresultFolderPath,RunTimeResultFolder
'Call PublishTestResults_PY(TestSetName,  StrValueOfLastElement(TC_Path,"\"), Environment.Value("TCExecutionStatus"), OpCoName, TargetCycle,  Environment.Value("HtmlResultReportpath"),RunTimeId,Priority)
'
'
