...
'''*****************TC1_[1]Test_P2P_01_01_0279-Duplicate invoice check_P1_TASE
TC_Path = Parameter("TC1_Path")
TC_ExcelInputFile = Parameter("TC1_ExcelinputFile")
TC1_DataRowNumber = Parameter("TC1_1_DataRowNumber")
TC2_DataRowNumber = Parameter("TC1_2_DataRowNumber")
gstrresultFolderPath= Parameter("gstrresultFolderPath")	
RunTimeResultFolder= Parameter("RunTimeResultFolder")	

Call UpdateTestPath(TC_Path)
LoadAndRunAction TC_Path,ActionName,TestIterationVal,TC_ExcelInputFile,TC1_DataRowNumber,gstrresultFolderPath,RunTimeResultFolder
...
LoadAndRunAction TC_Path,ActionName,TestIterationVal,TC_ExcelInputFile,TC2_DataRowNumber,gstrresultFolderPath,RunTimeResultFolder
Call PublishTestResults_PY(TestSetName,  StrValueOfLastElement(TC_Path,"\"), Environment.Value("TCExecutionStatus"), OpCoName, TargetCycle,  Environment.Value("HtmlResultReportpath"),RunTimeId,Priority)
