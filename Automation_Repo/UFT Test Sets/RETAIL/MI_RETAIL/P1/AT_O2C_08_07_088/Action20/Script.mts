...
'''*****************TC9_[1]Test_O2C_08_07_088-Direct Export to foreign customers - manual SO - EUR customer invoice_P9_VL03N_Check out mess for deliv_TASE***************************
TC_Path = Parameter("TC9_Path")
TC_ExcelInputFile = Parameter("TC9_ExcelinputFile")
TC_DataRowNumber = Parameter("TC9_DataRowNumber")
