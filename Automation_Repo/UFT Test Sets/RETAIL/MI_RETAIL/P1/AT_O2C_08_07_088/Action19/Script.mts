...
'''*****************TC8_[1]Test_O2C_08_07_088-Direct Export to foreign customers - manual SO - EUR customer invoice_P8_MB03_Check FI for GI_TASE***************************
TC_Path = Parameter("TC8_Path")
TC_ExcelInputFile = Parameter("TC8_ExcelinputFile")
TC_DataRowNumber = Parameter("TC8_DataRowNumber")
