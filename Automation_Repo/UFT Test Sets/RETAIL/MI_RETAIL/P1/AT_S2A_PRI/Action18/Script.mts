...
'''*****************TC15_[1]Test_S2A_PRI_03_04-Calculate wholesale price for PL optional - tariff 96-_TASE
TC_Path = Parameter("TC15_Path")
TC_ExcelInputFile = Parameter("TC15_ExcelinputFile")
TC_DataRowNumber = Parameter("TC15_DataRowNumber")
