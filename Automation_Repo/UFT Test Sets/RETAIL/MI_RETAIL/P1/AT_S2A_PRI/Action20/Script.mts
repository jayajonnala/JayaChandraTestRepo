...
'''*****************TC17_[1]Test_S2A_PRI_03_02-Calculate wholesale price for NB optional - tariff 96_TASE
TC_Path = Parameter("TC17_Path")
TC_ExcelInputFile = Parameter("TC17_ExcelinputFile")
TC_DataRowNumber = Parameter("TC17_DataRowNumber")
