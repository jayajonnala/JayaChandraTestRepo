...
'''*****************TC18_Test_P2P_01_01_024-Import from EU Vendors GR before Invoice_P5_Invoice_Postings_TASE
TC_Path = Parameter("TC18_Path")
TC_ExcelInputFile = Parameter("TC18_ExcelinputFile")
TC_DataRowNumber = Parameter("TC18_DataRowNumber")
