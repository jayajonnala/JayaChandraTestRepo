...
'''*****************TC20_Test_P2P_01_01_024-Import from EU Vendors GR before Invoice_P6_Inv_del_cost_TASE
TC_Path = Parameter("TC20_Path")
TC_ExcelInputFile = Parameter("TC20_ExcelinputFile")
TC_DataRowNumber = Parameter("TC20_DataRowNumber")
