...
'''*****************TC1_Test_P2P_01_01_0268-Self consumption for between Store and DC cnxl_P1_SO_OD_GI_INV_TASE
...
TC1_DataRowNumber_1 = Parameter("TC1_DataRowNumber_1")

Call UpdateTestPath(TC_Path)
LoadAndRunAction TC_Path,ActionName,TestIterationVal,TC_ExcelInputFile,TC_DataRowNumber,gstrresultFolderPath,RunTimeResultFolder,TC1_DataRowNumber_1
