...
Cal8ikll ReporterEventRunTimeID(RunTimeId)

'''*****************DT8_1_DataTransfer_OneValue_Optimised_TASE***************************

NumofIterations = 4
For Iteration = 1 To NumofIterations

	DT_gstrInputExcelFilePathAndName= Parameter("DT8_"&Iteration&"_gstrInputExcelFilePathAndName")	
	DT_datatable_row= Parameter("DT8_"&Iteration&"_datatable_row")	
	DT_sourceField= Parameter("DT8_"&Iteration&"_sourceField")	
	DT_gstrTargetExcelFilePathAndName= Parameter("DT8_"&Iteration&"_gstrTargetExcelFilePathAndName")	
	DT_targetField= Parameter("DT8_"&Iteration&"_targetField")	
	DT_targetexcelrow= Parameter("DT8_"&Iteration&"_targetexcelrow")	
