...
'''*****************TC25_Test_AR0036 Post with Clearing (Compensation Note)-Residual Item_TASE**********************
TC_Path = Parameter("TC25_Path")
TC_ExcelInputFile = Parameter("TC25_ExcelinputFile")
TC_DataRowNumber = Parameter("TC25_DataRowNumber")
