...
'''*****************TC31_Test_AR0057 - Manage Manual Guarantees for Current trade receivables_TASE
TC_Path = Parameter("TC31_Path")
TC_ExcelInputFile = Parameter("TC31_ExcelinputFile")
TC_DataRowNumber = Parameter("TC31_DataRowNumber")
