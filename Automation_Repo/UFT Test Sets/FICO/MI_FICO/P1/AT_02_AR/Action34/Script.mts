...
'''*****************TC32_Test_AR0058 Manage Manual Guarantees for Other receivables - rent_TASE
TC_Path = Parameter("TC32_Path")
TC_ExcelInputFile = Parameter("TC32_ExcelinputFile")
TC_DataRowNumber = Parameter("TC32_DataRowNumber")
