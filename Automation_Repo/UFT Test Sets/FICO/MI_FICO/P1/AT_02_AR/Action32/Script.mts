...
'''*****************TC30_Test_AR0056_Manage_Manual_Guarantees_for_Curr_trade_receivables-wholesale_cust_(3rd party)_TASE
TC_Path = Parameter("TC30_Path")
TC_ExcelInputFile = Parameter("TC30_ExcelinputFile")
TC_DataRowNumber = Parameter("TC30_DataRowNumber")
