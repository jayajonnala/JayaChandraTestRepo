...
'''*****************TC27_Test_AR0053 Manage Manual Downpayments for Other receivables - rent_TASE
TC_Path = Parameter("TC27_Path")
TC_ExcelInputFile = Parameter("TC27_ExcelinputFile")
TC_DataRowNumber = Parameter("TC27_DataRowNumber")
