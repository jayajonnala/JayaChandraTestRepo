...
'''*****************TC24_Test_AR0035 Clear AR Accounts (Manual & Automatic) - automatic clearing in EUR for Customers (without special GL)_TASE
TC_Path = Parameter("TC24_Path")
TC_ExcelInputFile = Parameter("TC24_ExcelinputFile")
TC_DataRowNumber = Parameter("TC24_DataRowNumber")
