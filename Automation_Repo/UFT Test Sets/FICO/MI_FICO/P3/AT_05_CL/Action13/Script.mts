...
'''*****************TC10_[1]Test_CL0026 Manage Accrual deferral for Invoice to be Issue for Current trade receivables - 3rd party  in local currency_TASE
TC_Path = Parameter("TC10_Path")
TC_ExcelInputFile = Parameter("TC10_ExcelinputFile")
TC_DataRowNumber = Parameter("TC10_DataRowNumber")
