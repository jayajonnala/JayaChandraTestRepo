...
'''*****************TC1_Test_Post GL Reccuring Documents_p1_TASE***************************
...
'''*****************TC2_Test_Post GL Reccuring Documents_p2_TASE***************************
...
'''*****************DT2_2_DataTransfer_OneValue_Optimised_TASE***************************

DT_gstrInputExcelFilePathAndName= Parameter("DT2_2_gstrInputExcelFilePathAndName")	
DT_datatable_row= Parameter("DT2_2_datatable_row")	
DT_sourceField= Parameter("DT2_2_sourceField")	
DT_gstrTargetExcelFilePathAndName= Parameter("DT2_2_gstrTargetExcelFilePathAndName")	
DT_targetField= Parameter("DT2_2_targetField")	
DT_targetexcelrow= Parameter("DT2_2_targetexcelrow")	
DT_Path = Parameter("DT_Path")
...
'''*****************DT2_2_DataTransfer_OneValue_Optimised_TASE***************************
DT_gstrInputExcelFilePathAndName= Parameter("DT2_3_gstrInputExcelFilePathAndName")	
DT_datatable_row= Parameter("DT2_3_datatable_row")	
DT_sourceField= Parameter("DT2_3_sourceField")	
DT_gstrTargetExcelFilePathAndName= Parameter("DT2_3_gstrTargetExcelFilePathAndName")	
DT_targetField= Parameter("DT2_3_targetField")	
DT_targetexcelrow= Parameter("DT2_3_targetexcelrow")	
DT_Path = Parameter("DT_Path")

LoadAndRunAction DT_Path,ActionName,TestIterationVal,DT_gstrInputExcelFilePathAndName,DT_datatable_row,DT_sourceField,DT_gstrTargetExcelFilePathAndName,DT_targetField,DT_targetexcelrow,gstrresultFolderPath,RunTimeResultFolder
Call PublishTestResults_PY(TestSetName,  StrValueOfLastElement(DT_Path,"\"), Environment.Value("TCExecutionStatus"), OpCoName, TargetCycle,  Environment.Value("HtmlResultReportpath"))

'''*****************TC3_Test_Post GL Reccuring Documents_p3_TASE***************************
