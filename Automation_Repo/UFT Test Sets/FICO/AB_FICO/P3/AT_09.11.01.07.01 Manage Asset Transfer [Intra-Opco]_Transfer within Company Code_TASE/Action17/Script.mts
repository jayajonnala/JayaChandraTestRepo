...
For Iteration = 1 To NumofIterations
	...
	DT_gstrInputExcelFilePathAndName= Parameter("DT2_"&Iteration&"_gstrInputExcelFilePathAndName")	
	DT_datatable_row= Parameter("DT2_"&Iteration&"_datatable_row")	
	DT_sourceField= Parameter("DT2_"&Iteration&"_sourceField")	
	DT_gstrTargetExcelFilePathAndName= Parameter("DT2_"&Iteration&"_gstrTargetExcelFilePathAndName")	
	DT_targetField= Parameter("DT2_"&Iteration&"_targetField")	
	DT_targetexcelrow= Parameter("DT2_"&Iteration&"_targetexcelrow")	
