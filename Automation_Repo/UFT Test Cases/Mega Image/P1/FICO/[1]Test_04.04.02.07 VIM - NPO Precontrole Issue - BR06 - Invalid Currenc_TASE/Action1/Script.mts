...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.07 VIM - NPO Precontrole Issue - BR06 - Invalid Currenc
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.07 VIM-NPO Precontrole Issue-BR06"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\Program Files (x86)\TCS\Test Automation Solution for Enterprise Applications\DEmopractice\Data\P1_DATA\P1_FICO\DT_04.04.02.07 VIM - NPO Precontrole Issue - BR06 - Invalid Currenc_TASE.xls"
...
Call SetTextbox("Document Currency","/OPT/VIM_BL_1RIDX_OCR_DATA-WAERS","",FormatBlank(DT_OPTVIM_7AX2_2002_DOCUMENT_CURRENCY),False)
...
'Call VerifyGridCellContent("",6,"Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_5_STATUS)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","202","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_5_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)

Call SelectTab("TAB_MAIN","Basic Data",False)
Call SetTextbox("Gross Amount","GH_IDX_APPLICATION->MS_IDX_HEADER-WAERS","",DT_OPTVIM_7AX2_9100_GROSS_AMOUNT,False)
Call TakeScreenShot()
Call PressEnter()   ' 

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","202","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_5_STATUS_OCC1)
'Call VerifyGridCellContent("",6,"Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_5_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
