...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_AR0054 Manage Manual Downpayments for Current trade receivables_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_AR0054_TASE"
...
Call DoubleClickGuiGridCell("",0, 1, "Company code", False)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex(DT_FD03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_HKONT_OCC1,0)
Call ClickButton("Cancel   \(F12\)",True)
'Call VerifyGridCellContent("",1,"HKONT","",DT_FD03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_HKONT_OCC1)
Call DoubleClickGuiGridCell("",0, 2, "Company code", False)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex(DT_FD03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_HKONT_OCC1,0)
Call ClickButton("Cancel   \(F12\)",True)
'Call VerifyGridCellContent("",2,"HKONT","",DT_FD03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_HKONT_OCC1)
Call DoubleClickGuiGridCell("",0, 3, "Company code", False)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex(DT_FD03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_HKONT_OCC1,0)
Call ClickButton("Cancel   \(F12\)",True)
