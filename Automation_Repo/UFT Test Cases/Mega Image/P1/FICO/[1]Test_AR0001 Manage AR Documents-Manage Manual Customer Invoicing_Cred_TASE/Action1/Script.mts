...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_AR0001 Manage AR Documents-Manage Manual Customer Invoicing_Cred 
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_AR0001 Manage AR Documents-Manage Manual Customer Invoicing_Cred"
...
Call SetTextbox("Amount","INVFO-WAERS","",DT_FB70_0510_AMOUNT,False)
...
Call VerifyGridCellContent("", 1, "Posting Key", 0, DT_PK_1)
Call VerifyGridCellContent("", 2, "Posting Key", 0, DT_PK_2)
Call VerifyGridCellContent("", 3, "Posting Key", 0, DT_PK_3)
Call DoubleClickGuiGridCell("",0, 1, "Company code", False)
Call TakeScreenShot
Call VerifyTextBoxContent("G/L Acc","BSEG-HKONT",0,DT_GL_1, False)
Call ClickButton("Back   \(F3\)", False)
'Call VerifyGridCellContent("", 1, "Account", 0, DT_GL_1)
Call VerifyGridCellContent("", 2, "Account", 0, DT_GL_2)
Call VerifyGridCellContent("", 3, "Account", 0, DT_GL_3)
Call VerifyGridCellContent("", 1, "AZBET", 0, DT_AMT_1)
Call VerifyGridCellContent("", 2, "AZBET", 0, DT_AMT_2)
Call VerifyGridCellContent("", 3, "AZBET", 0, DT_AMT_3)
...
'Call VerifyifGuiLabelExists_ByIndex(lcase(DT_FB70_0120_CHECK_TEXT_OF_NO_NAME_OCC1),0)
Call VerifyifGuiLabelExists_ByIndex(trim(DT_FB70_0120_CHECK_TEXT_OF_NO_NAME_OCC2),0)
...
Call SetTextbox("Document Number","RF05L-BELNR","",DT_INVOICE_NO_OUTPUT,False)
Call SetTextbox("Company Code","RF05L-BUKRS","",DT_FB70_0100_COMPANY_CODE_OCC1,False)
Call SetTextbox("Fiscal Year","RF05L-GJAHR","",DT_FB70_0100_FISCAL_YEAR_OCC1,False)
Call TakeScreenShot
Call PressEnter()
...
Call ClickButtonIfExist("Continue   \(Enter\)", True)
Call VerifyStatusBar(DT_FB70_0750_CHECK_TEXT_OF_STATUSBAR)

'''''''--------TransactionCode-/F.62----------''''

Call SetTcode(DT_FB70_0100_OKCD_OCC3)     
Call PressEnter()     
Call TakeScreenShot
...
Call SetTextbox("Document number","RBELNR-LOW","",DT_INVOICE_NO_OUTPUT,False)
