...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.03 VIM - NPO Precontrole Issue - BR03 - Missing Vendor Invoice Reference (NPO)
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.03 VIM - BR03"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\Program Files (x86)\TCS\Test Automation Solution for Enterprise Applications\DEmopractice\Data\P1_DATA\P1_FICO\DT_04.04.02.03 VIM - NPO Precontrole Issue - BR03 - Missing Vendor_TASE.xls"
...
Call TakeScreenShot()
Call SetTextbox("Search Term:","GS_SEARCH-VALUE","",DT_OPTVIM_7AX2_0841_SEARCH_TERM,True)
Call TakeScreenShot()
...
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","233","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_2_STATUS)
'Call VerifyGridCellContent("",3,"Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_2_STATUS)
...
Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
'Call VerifyGridCellContent("",3,"Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_2_STATUS_OCC1)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","233","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_2_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
