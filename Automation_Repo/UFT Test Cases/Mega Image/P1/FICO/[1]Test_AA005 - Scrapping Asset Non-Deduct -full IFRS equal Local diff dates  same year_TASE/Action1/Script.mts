...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_AA005 - Scrapping Asset Non-Deduct -full IFRS equal Local diff dates  same year
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_AA005 - Scrapping Asset Non-Deduct -full IFRS equal Local diff dates  same year"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\FICO\TASE_DT_AA005 - Scrapping Asset Non-Deduct -full IFRS equal Local di.xls"
...
Call TakeScreenShot
'
'Call WriteRunTimeDataToExcelGlobalSheet ("DT_IFRESULT","FALSE")
...
Call TakeScreenShot
Call GetGridContent("",0,"Asset",4,"<NA>","<NA>","DT_ASSET_OUTPUT")
Call GetGridContent("",0,"Sub-number",4,"<NA>","<NA>","DT_SUB_NUM_OUTPUT")
...
Call ClickButton("All Selections   \(Shift\+F7\)",False)
Call SelectRadioButton("XEINZEL", "List assets", False)
Call SetTextbox("Asset number","ANLAGE-LOW","",DT_ASSET_OUTPUT,False)
Call SetTextbox("Subnumber","UNTNR-LOW","",DT_SUB_NUM_OUTPUT,False)
...
Call ClickButton("Execute   \(F8\)",False)
Call TakeScreenShot
Call VerifyTextBoxContent("Information Message", "MESSTXT1", "", lcase(DT_S_ALR_87011966_0010_CHECK_TEXT_OF_MESSTXT1), True)
Call ClickButton("Continue   \(Enter\)",True)
Call WriteRunTimeDataToExcelGlobalSheet ("DT_IFRESULT","TRUE")
...
Call PressEnter()     
Call SetTextbox("Asset","RAIFP2-ANLN1","",DT_ASSET_OUTPUT,False)
Call SetTextbox("Asset","RAIFP2-ANLN2","",DT_SUB_NUM_OUTPUT,False)
Call TakeScreenShot
Call PressEnter()
...
If Month(Date()) = 2 Then
	DT_S_ALR_87011966_0201_POSTING_DATE_IP = "28."&ConvertDoubledigit(Cstr(Month(Date)))&"."&Year(Date)
	Else
	DT_S_ALR_87011966_0201_POSTING_DATE_IP = "30."&ConvertDoubledigit(Cstr(Month(Date)))&"."&Year(Date)
End If
Call SetTextbox("Posting Date","RAIFP1-BUDAT","",DT_S_ALR_87011966_0201_POSTING_DATE,False)
Call TakeScreenShot
Call PressEnter()
...
Call TakeScreenShot
Call SetTextbox("Amount posted","RAIFP2-ANBTR","","",False)
Call TakeScreenShot
...
''Call VerifyTextBoxContent("Posting Date", "BKPF-BUDAT", "", ConvertDate(DT_S_ALR_87011966_0201_POSTING_DATE_IP), False)
Call VerifyTextBoxContent("Posting Date", "BKPF-BUDAT", "", DT_S_ALR_87011966_0201_POSTING_DATE, False)
...
Call TakeScreenShot
Call PressEnter()     
Call SetTextbox("Asset","ANLA-ANLN1","",DT_ASSET_OUTPUT,False)
Call SetTextbox("Sub-number","ANLA-ANLN2","",DT_SUB_NUM_OUTPUT,False)
...
'Call VerifyGridCellContent("Transactions", 4, "Amount posted", 0, DT_S_ALR_87011966_0301_CHECK_GETCELLVALUE_OF_GRIDCELL_3_VERAENDERUNG)
