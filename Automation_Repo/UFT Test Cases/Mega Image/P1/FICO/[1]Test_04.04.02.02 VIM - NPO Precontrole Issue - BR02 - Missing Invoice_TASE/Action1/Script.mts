...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.02 VIM - NPO Precontrole Issue - BR02 - Missing Invoice
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.02-BR02"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\Program Files (x86)\TCS\Test Automation Solution for Enterprise Applications\DEmopractice\Data\P1_DATA\P1_FICO\DT_04.04.02.02 VIM - NPO Precontrole Issue - BR02 - Missing Invoice_TASE.xls"
...
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","223","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_STATUS)
'Call VerifyGridCellContent("",2,"Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)
Call SetTextbox("Document Date","GH_IDX_APPLICATION->MS_IDX_HEADER-BLDAT","",ConvertDate(DT_OPTVIM_7AX2_9100_DOCUMENT_DATE),False)
Call TakeScreenShot()
Call PressEnter()     ' 
   ' 

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
'Call VerifyGridCellContent("",2,"Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_STATUS_OCC1)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","223","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_STATUS_OCC1)
Call LogOff()
Call FinalStatus ()
