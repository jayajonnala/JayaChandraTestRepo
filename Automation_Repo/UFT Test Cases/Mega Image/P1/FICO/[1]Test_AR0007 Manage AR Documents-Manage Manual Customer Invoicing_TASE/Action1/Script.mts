...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_AR0007 Manage AR Documents-Manage Manual Customer Invoicing
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
Call VerifyGridCellContent("",3,"Posting Key",0,DT_FB75_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_BSCHL)
...
Call VerifyGridCellContent("",3,"Account",0,DT_FB75_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_KTONR)
...
Call VerifyGridCellContent("",3,"Alternative Account No.",0,DT_FB75_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_LOKKT)
...
Call VerifyGridCellContent("",3,"Amount",0,DT_FB75_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_AZBET)
...
'Call VerifyGridCellContent("",1,"Negative posting",0," ")
Call VerifyGridCellContent("",2,"Negative posting",0,"X")
Call VerifyGridCellContent("",3,"Negative posting",0,"X")
...
Call VerifyTextBoxContent("Currency","BKPF-WAERS",0,DT_FB75_1710_CHECK_TEXT_OF_CURRENCY,True)
'Call VerifyTextBoxContent("Document Date","BKPF-BLDAT",0,DT_FB75_1710_CHECK_TEXT_OF_DOCUMENT_DATE,True)
'Call VerifyTextBoxContent("Posting Date","BKPF-BUDAT",0,DT_FB75_1710_CHECK_TEXT_OF_POSTING_DATE,True)
...
Call SelectCheckbox("NORMBL", 0, "OFF", False)
Call TakeScreenShot()
