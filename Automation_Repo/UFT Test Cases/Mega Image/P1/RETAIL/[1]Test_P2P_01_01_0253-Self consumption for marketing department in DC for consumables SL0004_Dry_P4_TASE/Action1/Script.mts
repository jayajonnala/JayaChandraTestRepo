...
gstrTestCaseName = "Test_P2P_01_01_0253_Dry_P4_TASE"
...
Call SetTextBox("Billing document","VBRK-VBELN",0,DT_VF03_0101_BILLING_DOCUMENT,False)
Call PressEnter()
Call TakeScreenShot
...
Call TakeScreenShot
Call VerifyGridCellContent("", 1, "BSCHL", 0, DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BSCHL)
Call VerifyGridCellContent("", 2, "BSCHL", 0, DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_BSCHL)
Call VerifyGridCellContent("", 1, "KTONR", 0,DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_KTONR)
Call VerifyGridCellContent("", 2, "KTONR", 0,DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_KTONR)

Call SetTcode(DT_VF03_0750_OKCD)     
Call PressEnter()     
Call TakeScreenShot

Call SetTextBox("Billing document","VBRK-VBELN",0,DT_VF03_0101_BILLING_DOCUMENT_OCC1,False)
Call PressEnter()
Call TakeScreenShot
Call ClickButton("Accounting overview   \(Shift\+F4\)",False)
Call SelectRowGuiGrid("Documents in Accounting", 0, "Object type text", "Accounting document", True)
Call ClickButton("Display Document   \(F2\)",True)
Call TakeScreenShot
Call VerifyGridCellContent("", 1, "BSCHL", 0, DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BSCHL_OCC1)
Call VerifyGridCellContent("", 2, "BSCHL", 0, DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_BSCHL_OCC1)
Call VerifyGridCellContent("", 3, "BSCHL", 0, DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_BSCHL)
Call VerifyGridCellContent("", 1, "KTONR", 0,DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_KTONR_OCC1)
Call VerifyGridCellContent("", 2, "KTONR", 0,DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_KTONR_OCC1)
Call VerifyGridCellContent("", 3, "KTONR", 0,DT_VF03_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_KTONR)
