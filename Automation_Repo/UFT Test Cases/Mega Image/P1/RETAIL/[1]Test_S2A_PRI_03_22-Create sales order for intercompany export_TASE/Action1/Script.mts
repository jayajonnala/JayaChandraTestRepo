...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_S2A_PRI_03_22-Create sales order for intercompany export
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_S2A_PRI_03_22-Create sales order"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_S2A_PRI_03_22-Create sales order for intercompany export.xls"
...
'Call SetTableData("SAPMV45ATCTRL_U_ERF_AUFTRAG", "Site", 2, "", "", DT_VA01_4900_TABLECELL_SITE_1, false)
Call PressEnter()
Call PressEnter()
Call PressEnter()
Call TakeScreenShot
...
Call SelectRowGuiTable("SAPMV45ATCTRL_U_ERF_AUFTRAG", "Article", DT_VA01_4900_TABLECELL_ARTICLE_1, False)
...
Call TakeScreenShot
Call VerifyTableCellContent(1, "CnTy", "SAPLV69ATCTRL_KONDITIONEN", DT_VA01_6201_CHECK_TEXT_OF_TABLECELL_CNTY_0_OCC1)
Call VerifyTableCellContent(3, "CnTy", "SAPLV69ATCTRL_KONDITIONEN", DT_VA01_6201_CHECK_TEXT_OF_TABLECELL_CNTY_2_OCC1)
Call VerifyTableCellContent(5, "CnTy", "SAPLV69ATCTRL_KONDITIONEN", DT_VA01_6201_CHECK_TEXT_OF_TABLECELL_CNTY_4_OCC1)
...
Call GetStatusBar("item2", "DT_ORDER_OUTPUT")
Call VerifyStatusBar("Sales Order Push "&DT_ORDER_OUTPUT&" has been saved")
