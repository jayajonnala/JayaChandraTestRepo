...
gstrTestCaseName = "Test_P2P_01_01_0253_P1_TASE"
...
Call SetTableData("SAPMV45ATCTRL_U_ERF_AUFTRAG","Article",5,"","",DT_VA01_4900_TABLECELL_ARTICLE_4,False)
Call SetTableData("SAPMV45ATCTRL_U_ERF_AUFTRAG","Article",6,"","",DT_VA01_4900_TABLECELL_ARTICLE_5,False)
...
Call SetTableData("SAPMV45ATCTRL_U_ERF_AUFTRAG","Order Quantity",5,"","",DT_VA01_4900_TABLECELL_ORDER_QUANTITY_4,False)
Call SetTableData("SAPMV45ATCTRL_U_ERF_AUFTRAG","Order Quantity",6,"","",DT_VA01_4900_TABLECELL_ORDER_QUANTITY_5,False)
...
Call SetTextBox("Site","VBAP-WERKS",0,DT_VA01_4452_SITE,False)
Call SetTextBox("Storage Loc\.","VBAP-LGORT",0,DT_VA01_4452_STOR_LOCATION,False)
Call PressEnter()

Call ClickButton("btn\[19\]",False)

Call SetTextBox("Site","VBAP-WERKS",0,DT_VA01_4452_SITE_OCC1,False)
Call SetTextBox("Storage Loc\.","VBAP-LGORT",0,DT_VA01_4452_STOR_LOCATION_OCC1,False)
Call PressEnter()

Call ClickButton("btn\[19\]",False)

Call SetTextBox("Site","VBAP-WERKS",0,DT_VA01_4452_SITE_OCC2,False)
Call SetTextBox("Storage Loc\.","VBAP-LGORT",0,DT_VA01_4452_STOR_LOCATION_OCC2,False)
Call PressEnter()

Call ClickButton("btn\[19\]",False)

Call SetTextBox("Site","VBAP-WERKS",0,DT_VA01_4452_SITE_OCC3,False)
Call SetTextBox("Storage Loc\.","VBAP-LGORT",0,DT_VA01_4452_STOR_LOCATION_OCC3,False)
Call PressEnter()

Call ClickButton("btn\[19\]",False)

Call SetTextBox("Site","VBAP-WERKS",0,DT_VA01_4452_SITE_OCC4,False)
Call SetTextBox("Storage Loc\.","VBAP-LGORT",0,DT_VA01_4452_STOR_LOCATION_OCC4,False)
Call PressEnter()

Call ClickButton("btn\[19\]",False)

Call SetTextBox("Site","VBAP-WERKS",0,DT_VA01_4452_SITE_OCC5,False)
Call SetTextBox("Storage Loc\.","VBAP-LGORT",0,DT_VA01_4452_STOR_LOCATION_OCC5,False)
Call PressEnter()
...
Call SetTextBox("Profit Center","COBL-PRCTR",0,DT_VA01_1006_PROFIT_CENTER,False)
...
Call SetTextBox("Profit Center","COBL-PRCTR",0,DT_VA01_1006_PROFIT_CENTER_OCC1,False)
...
Call SetTextBox("Profit Center","COBL-PRCTR",0,DT_VA01_1006_PROFIT_CENTER_OCC2,False)
...
Call SetTextBox("Profit Center","COBL-PRCTR",0,DT_VA01_1006_PROFIT_CENTER_OCC3,False)
...
Call SetTextBox("Profit Center","COBL-PRCTR",0,DT_VA01_1006_PROFIT_CENTER_OCC4,False)
...
Call SetTextBox("Profit Center","COBL-PRCTR",0,DT_VA01_1006_PROFIT_CENTER_OCC5,False)
...
Call SetTextbox("Order","VBAK-VBELN","",DT_OUTPUT,False)
Call PressEnter()
Call TakeScreenShot
'''Call VerifyTextBoxNoLabelContent("VBAK-VBELN",0,DT_VA01_4001_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OUTPUT,False)
Call VerifyTextBoxNoLabelContent("VBAK-VBELN",0,DT_OUTPUT,False)
