...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_MD_01_01_250 Select several articles Mntn all char_p2
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_MD_01_01_250_p2"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="C:\Users\ssahoo\Desktop\TASEWork\Data\P1-MI\TASE_DT_MD_01_01_250 Select several articles Mntn all char_p2.xls"
...
Call ClickButton("Next Page",False)'
Call ClickButton("Next Page",False)
Call VerifyTextBoxContent("Electronic shelf label","RCTMS-MWERT",0,lcase(trim(DT_MM43_4000_CHECK_TEXT_OF_RCTMSMWERT)),False)
Call TakeScreenShot
...
Call ClickButton("Next Page",False)
Call ClickButton("Next Page",False)
Call VerifyTextBoxContent("Electronic shelf label","RCTMS-MWERT","",lcase(trim(DT_MM43_4000_CHECK_TEXT_OF_RCTMSMWERT)),False)
