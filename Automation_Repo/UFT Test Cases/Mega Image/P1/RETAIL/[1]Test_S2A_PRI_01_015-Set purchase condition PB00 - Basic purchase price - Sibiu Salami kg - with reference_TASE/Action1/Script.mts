...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_S2A_PRI_01_015-Set purchase condition PB00 - Basic purchase price - Sibiu Salami kg - with reference
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_S2A_PRI_01_015- PB00 - Sibiu Salami kg -  reference"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_S2A_PRI_01_015-Set purchase condition PB00 - Basic purchase pric.xls"
...
Call SetTableData("SAPMV13ATCTRL_D0201", "Amount", 1, "", "", DT_MM42_0201_TABLECELL_AMOUNT_0, False)
Call PressEnter()
Call TakeScreenShot
...
Call SetTextbox("Purchasing Org.","RMMW1-EKORG","",DT_MM42_0100_PURCHASING_ORG_OCC1,False)
'''Call SetTextbox("Vendor","RMMW1-LIFNR","",DT_MM42_0100_VENDOR_OCC1,False)
Call SetTextboxNoLabel("RMMW1-LIFNR","",DT_MM42_0100_VENDOR_OCC1,False)
Call ClickButton("Deselect All   \(Shift\+F7\)",False)
Call SelectRowGuiTable("SAPLMGMWTAB_CONT_0100", "Screen description", "Purchasing", False)
Call PressEnter()
Call ClickButton("For the Conditions",False)
...
Call VerifyTableCellContent(1, "Amount", "SAPMV13ATCTRL_D0201", DT_MM42_0201_CHECK_TEXT_OF_TABLECELL_AMOUNT_0)
