...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_REB_12_01-ZMU3 - Enter Service Invoice Contract in SAP_P3_Upload CN ZM53
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_REB_12_01-ZMU3 - Enter Service Invoice Contract in SAP_P3_Upload CN ZM53"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_REB_12_01-ZMU3 - Enter Service Invoice Contract  in SAP_P3_Upload CN ZM53.xls"
...
''Call ActivateCellGuiGridByRefVal("",0,"Payment type",DT_REF,"Payment document",False)
...
If SAPGuiSession(sessionObject).SapGuiWindow(windowobject).SAPGuiEdit("guicomponenttype:=32","attachedtext:=Document Date","name:=BKPF-BLDAT","Index:=0").Exist(5)=False Then 
