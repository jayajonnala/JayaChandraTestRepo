...
gstrTestCaseName = "Test_REB_01_01-ZMU1-Enter CN Contract in SAP_P3_settlement"
...
Call TakeScreenShot()
'
'Call ClickCellGuiGrid("Column Set", 0, "Column Name", 2,"", "", True)
'Call TakeScreenShot()

Call  ClickButtonToolBar("&MB_FILTER", 0)
Call ClickButtonToolBar("&FIND",True)
Call SetTextBox("Search Term:","GS_SEARCH-VALUE",0,lcase("Message Text"),True)
...
Call TakeScreenShot()
Call SetTextBox("Message text","%%DYN001-LOW",0,DT_WB2R_SV_1105_MESSAGE_TEXT,True)
Call PressEnter()
