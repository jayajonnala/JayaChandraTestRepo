...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :S2A_PRI_02_023 Maint margin driv ret pri tariff 49 ShopnGO_Artemis_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "S2A_PRI_02_023 49 ShopnGO_Artemis_TASE"
...
Call CaptureScreenshot_Mainframe("A")
Call SetTEField("A",DT_P_FIELD_NAME_C4,DT_P_FIELD_ID_VAL_MASTER_ITEM_C4)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C4)
Call CaptureScreenshot_Mainframe("A")
Call SetTEField("A",DT_P_FIELD_NAME_C5,DT_P_FIELD_ID_VAL_TARIF_C5)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C5)
Call CaptureScreenshot_Mainframe("A")
Call SendTEScreenKey ("A",DT_P_KEY_C1)
Call CaptureScreenshot_Mainframe("A")
Call VerifyTEFieldByID("A",DT_P_FIELD_ID,DT_P_FIELD_ID_VERIFY_PRICE_C6,"")
Call SendTEScreenKey ("A",DT_P_KEY_C2)
Call CaptureScreenshot_Mainframe("A")
Call SetTEField("A",DT_P_FIELD_NAME_C6,DT_P_FIELD_ID_VAL_MASTER_ITEM_C7)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C6)
Call CaptureScreenshot_Mainframe("A")
Call SetTEField("A",DT_P_FIELD_NAME_C7,DT_P_FIELD_ID_VAL_TARIF_C8)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C7)
Call CaptureScreenshot_Mainframe("A")
Call SendTEScreenKey ("A",DT_P_KEY_C3)
Call VerifyTEFieldByID("A",DT_P_FIELD_ID_C1,DT_P_FIELD_ID_VERIFY_PRICE_C9,"")
