...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_PRE_Add_Stock_with_MIGO
...
gstrTestCaseName = "Test_PRE_Add_Stock_with_MIGO"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_PRE_Add_Stock_with_MIGO.xls"
...
Call SetTextbox("Qty in Unit of Entry","GOITEM-ERFMG","",DT_MOVEMENT_TYPE,False)
Call SelectTab("TS_GOITEM","Where", False)
Call SetTextbox("Movement type","GOITEM-BWART","",DT_MIGO_0010_GODEFAULT_TVBWART,False)
...
Call TakeScreenShot
Call SetTextbox("Vendor","GOITEM-VENDORNAME","",DT_VENDOR,False)
Call PressEnter()
Call TakeScreenShot
