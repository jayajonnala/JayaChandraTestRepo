...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_S2C_05_01_052-Scrapping of products - deductible cancellation
...
gstrTestCaseName = "Test_S2C_05_01_052 - deductible cancellation"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_S2C_05_01_052-Scrapping of products - deductible cancellation.xls"
...
Call SetTextbox("Article Doc\.","RM07M-MBLNR","",DT_MBST_0460_ARTICLE_DOC,False)
Call SetTextbox("Art\. Doc\. Year","RM07M-MJAHR","",DT_MBST_0460_ART_DOC_YEAR,False)
Call TakeScreenShot
Call PressEnter()
Call VerifyTextBoxContent("Movement Type","MSEGK-BWART",0,DT_MBST_0421_CHECK_TEXT_OF_MOVEMENT_TYPE,False)
Call TakeScreenShot
Call ClickButton("Post   \(Ctrl\+S\)",False)
Call GetStatusBar("item1","DT_CANCELATION_NUMBER_OUTPUT")
Call TakeScreenShot
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
Call VerifyStatusBar("Document "&DT_CANCELATION_NUMBER_OUTPUT&" posted")
Call SetTcode(DT_MBST_0460_OKCD)     
Call PressEnter()  
Call SetComboByKey("GODYNPRO-ACTION", DT_MBST_0010_GODYNPROACTION)
Call PressEnter()
Call TakeScreenShot
Call PressEnter()
...
Call TakeScreenShot
Call VerifyTextBoxContent("Reference","BKPF-XBLNR",0,DT_MBST_0750_CHECK_TEXT_OF_REFERENCE,False)
