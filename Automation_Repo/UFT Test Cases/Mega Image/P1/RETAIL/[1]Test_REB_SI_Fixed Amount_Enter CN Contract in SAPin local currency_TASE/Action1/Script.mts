...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_REB_01_01-ZMU1 - Enter CN Contract in SAPin local currency
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_REB_SI_Fixed Amount_Enter CN Contract in SAPin local currency_TASE"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_REB_01_01-ZMU1 - Enter CN Contract  in SAPin local currency.xls"
'//---------------------------------------------------------------------------------------------------------------------------------------------------AUTOMATION TEST SCRIPT------------------------------------------------------------------------------------------------------------------------------------------------------------//

'DT_SAPSYSTEM = "RGB - SAP RETAIL Sandbox GLOBAL"
...
Call PressEnter()
Call TakeScreenShot()
'''Uncomment below step for execution in R1E
...
Call SetMultipleGridData("Business Volume Base", 0, 1, "Sales Organization",DT_WCOCO_0628_GRIDCELL_0_SALES_ORG, False)

Call SetMultipleGridData("Business Volume Base", 0, 1, "Distribution Channel", DT_WCOCO_0628_GRIDCELL_0_DISTRIBUTION_CHNL, False)
...
Call ClickButtonToolBar("WB2R_NEW_LINE", 1)
Call TakeScreenShot()
Call  SetFocusGuiLabel(DT_WCOCO_0800_FIND_OCC1, 11, 72, True)
Call PressEnter()
Call TakeScreenShot()

If SAPGuiSession(sessionObject).SapGuiWindow(windowobject).SAPGuiEdit("guicomponenttype:=32","attachedtext:=Number of new rows","name:=SVALD-VALUE","Index:=0").Exist(5)=True Then 
Call SetTextboxPopupIfExist("SVALD-VALUE","Number of new rows","4")
Call TakeScreenShot()
Call PressEnter()  
Else 
...
Call TakeScreenShot()
Call SetMultipleGridData("Business Volume Base", 0, 2, "Article", DT_WCOCO_0628_GRIDCELL_0_ARTICLE, False)
Call SetMultipleGridData("Business Volume Base", 0, 3, "Article", DT_WCOCO_0628_GRIDCELL_1_ARTICLE, False)
Call SetMultipleGridData("Business Volume Base", 0, 4, "Article", DT_WCOCO_0628_GRIDCELL_2_ARTICLE, False)
Call SetMultipleGridData("Business Volume Base", 0, 5, "Article",DT_WCOCO_0628_GRIDCELL_3_ARTICLE, False)
Call TakeScreenShot()
Call PressEnter()
...
Call ActivateCellGuiGridByRefVal("Conditions", 0,"Condition Type","ZM43","Calculation type",False)
...
Call SetMultipleGridData("Conditions", 0, 1, "Condition Currency", DT_WCOCO_0621_CONTRACT_CURRENCY, False)
