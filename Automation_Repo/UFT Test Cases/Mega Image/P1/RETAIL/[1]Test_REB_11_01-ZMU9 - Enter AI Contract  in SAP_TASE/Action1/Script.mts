...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_REB_11_01-ZMU9 - Enter AI Contract  in SAP
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_REB_11_01-ZMU9 - Enter AI Contract  in SAP"
...
Call SetMultipleGridData("Conditions", 0, 1, "Supplier", DT_WCOCO_0628_GRIDCELL_0_VENDOR, False)

Call SetMultipleGridData("Conditions", 0, 1, "Purch. Organization",DT_WCOCO_0623_PURCH_ORGANIZATION, False)

Call SetMultipleGridData("Conditions", 0, 1, "Condition Type", DT_COND_TYPE, False)

Call SetMultipleGridData("Conditions", 0, 1, "Condition Rate", DT_COND_RATE, False)

Call SetMultipleGridData("Conditions", 0, 1, "Condition Currency", DT_UNIT, False)

Call SetMultipleGridData("Conditions", 0, 1, "Valid From", DT_WCOCO_0510_FROM, False)

Call SetMultipleGridData("Conditions", 0, 1, "Valid to", DT_WCOCO_0510_TO, False)
