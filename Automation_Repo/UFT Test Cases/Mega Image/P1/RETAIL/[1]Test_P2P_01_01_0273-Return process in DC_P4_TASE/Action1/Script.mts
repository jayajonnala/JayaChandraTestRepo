...
gstrTestCaseName = "Test_P2P_01_01_0273DC_P4"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_P2P_01_01_0273-Return process in DC_P4.xls"
...
Call SetComboByKey("RM08M-VORGANG",DT_CREDIT_MEMO)

Call TakeScreenShot()

Call SetTextBoxNoLabel("INVFO-BLDAT",0,ConvertDate(DT_MIRO_0010_INVOICE_DATE),False)

Call SetTextBoxNoLabel("INVFO-BUDAT",0,ConvertDate(DT_MIRO_0010_POSTING_DATE),False)
Call PressEnter()
...
Call VerifyGridCellContent("", 1, "Company code", 0, DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BUKRS)
