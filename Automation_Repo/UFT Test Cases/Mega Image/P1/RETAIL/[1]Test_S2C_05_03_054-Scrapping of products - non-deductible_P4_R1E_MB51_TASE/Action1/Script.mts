...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_S2C_05_03_054-Scrapping of products - non-deductible_P4_R1E_MB51      
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_S2C_05_03_054_P4_R1E_MB51"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_S2C_05_03_054-Scrapping of products - non-deductible_P4_R1E_MB51.xls"
...
Call VerifyGridCellContent("", 13, "XREF3", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_12_XREF3)
Call VerifyGridCellContent("", 14, "XREF3", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_13_XREF3)
Call VerifyGridCellContent("", 15, "XREF3", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_14_XREF3)
Call VerifyGridCellContent("", 16, "XREF3", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_15_XREF3)
Call VerifyGridCellContent("", 17, "XREF3", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_16_XREF3)
...
Call VerifyGridCellContent("", 13, "BSCHL", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_12_BSCHL)
Call VerifyGridCellContent("", 13, "KTONR", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_12_KTONR)
Call VerifyGridCellContent("", 14, "BSCHL", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_13_BSCHL)
Call VerifyGridCellContent("", 14, "KTONR", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_13_KTONR)
Call VerifyGridCellContent("", 15, "BSCHL", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_14_BSCHL)
Call VerifyGridCellContent("", 15, "KTONR", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_14_KTONR)
Call VerifyGridCellContent("", 16, "BSCHL", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_15_BSCHL)
Call VerifyGridCellContent("", 16, "KTONR", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_15_KTONR)
Call VerifyGridCellContent("", 17, "BSCHL", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_16_BSCHL)
Call VerifyGridCellContent("", 17, "KTONR", 0, DT_MB51_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_16_KTONR)
...
'''
'''SAPGuiSession("Session_2").SAPGuiWindow("Display Document: Data").SAPGuiToolbar("GridToolbar").PressButton "&MB_VARIANT"
'''SAPGuiSession("Session_2").SAPGuiWindow("Choose Layout").SAPGuiGrid("GridViewCtrl").SelectCell 6,"Layout"
'''SAPGuiSession("Session_2").SAPGuiWindow("Choose Layout").SAPGuiGrid("GridViewCtrl").SelectRow 6
'''SAPGuiSession("Session_2").SAPGuiWindow("Choose Layout").SAPGuiGrid("GridViewCtrl").ClickCell 6,"Layout"

'''SAPGuiSession("Session_2").SAPGuiWindow("Display Document: Data").SAPGuiToolbar("GridToolbar").PressContextButton "&MB_FILTER"
'''SAPGuiSession("Session_2").SAPGuiWindow("Display Document: Data").SAPGuiToolbar("GridToolbar").PressButton "&MB_FILTER"
'''SAPGuiSession("Session_2").SAPGuiWindow("Define Filter Criteria").SAPGuiButton("Cancel   (F12)").Click
