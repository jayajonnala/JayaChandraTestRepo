...
gstrTestCaseName = "Test_P2P_01_01_0234- cancellation MVT 985_Dry_P1"
...
Call SetGridData("", 4, "MENGE", DT_ZMDIM_DESTR_STOCK_0500_GRIDCELL_3_QUANTITY, False)

Call SetGridData("", 5, "MENGE", DT_ZMDIM_DESTR_STOCK_0500_GRIDCELL_4_QUANTITY, False)

Call SetGridData("", 6, "MENGE", DT_ZMDIM_DESTR_STOCK_0500_GRIDCELL_5_QUANTITY, False)
...
Call GetGridContent("", 0, "Created Document", 1, "<NA>", "<NA>", "DT_MBLNR_OUTPUT")

Call SetTcode(DT_ZMDIM_DESTR_STOCK_0500_OKCD)

Call PressEnter()

Call SetTextBox("Article Document","RG_MBLNR-LOW",0,DT_MBLNR_OUTPUT,False)
...
Call SetTextBox("Article Document","MBLNR-LOW",0,DT_MBLNR_OUTPUT,False)
