...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_P2P_01_01_024-Import from EU Vendors GR before Invoice_P5_Invoice_Postings     
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_P2P_01_01_024- Invoice_P5_Invoice_Postings"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_P2P_01_01_024-Import from EU Vendors GR before Invoice_P5_Invoic.xls"
...
Call PressEnter()
Call GetTableCellData("SAPLMR1MTC_MR1M","Amount",1,"Item","1","DT_MIRO_6310_CHECK_TEXT_OF_TABLECELL_AMOUNT_0_OUTPUT",False)
Call TakeScreenShot
...
Call VerifyStatusBar("Document no. "&DT_MIRO_6000_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OUTPUT&" created (Blocked for payment)")
...
Call VerifyGridCellContent("", 6, "BSCHL", 0, DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_3_BSCHL)
Call VerifyGridCellContent("", 7, "BSCHL", 0, DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_4_BSCHL)
'''Call VerifyGridCellContent("", 7, "BSCHL", 0, DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_3_BSCHL)
...
Call VerifyGridCellContent("", 6, "KTONR", 0, DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_3_KTONR)
Call VerifyGridCellContent("", 7, "KTONR", 0, DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_4_KTONR)
'''Call VerifyGridCellContent("", 7, "KTONR", 0, DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_3_KTONR)
...
Call VerifyGridCellContent("", 6, "KTOSL", 0,DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_3_KTOSL)
Call VerifyGridCellContent("", 7, "KTOSL", 0, DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_4_KTOSL)
'''Call VerifyGridCellContent("", 7, "KTOSL", 0,DT_MIRO_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_3_KTOSL)
Call SetTcode(DT_MRBR_TRANSACTION_CODE)     
Call PressEnter() 
Call SetTextbox("Company Code","SO_BUKRS-LOW","",DT_MRBR_1000_COMPANY_CODE,False)
Call SetTextbox("Invoice Document","SO_BELNR-LOW","",DT_MIRO_6000_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OUTPUT,False)
Call SetTextbox("Fiscal Year","SO_GJAHR-LOW","",DT_MRBR_1000_FISCAL_YEAR,False)
Call ClickButton("Execute   \(F8\)",false)
Call VerifyGridCellContent("", 1, "Blockg Reas. Price (Icon)", 0,DT_MRBR_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_ICON_SPGRP)
