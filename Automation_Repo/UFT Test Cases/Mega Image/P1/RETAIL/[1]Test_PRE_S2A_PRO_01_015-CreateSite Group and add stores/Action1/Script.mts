...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_S2A_PRO_01_015-Create low level promotion New Store opening new tariff_P1
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_PRE_S2A_PRO_01_015-CreateSite Group add stores"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_S2A_PRO_01_015-Create low level promotion New Store opening new tariff_P1.xls"
...
Call PressEnter()
''Creation of site group

Call WriteRunTimeDataToExcelGlobalSheet ("DT_INCREMENT_1",(Cint(DT_INCREMENT_1)+1))
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
Call SetTcode(DT_PRE_TCODE)     
Call PressEnter()  
Call SetFocusGuiLabel("030", 11, 56, False)
Call ClickButton("Copy   \(Enter\)",False)
Call TakeScreenShot()
Call SetTextBox("Class","RMCLM-CLASS",0,DT_CLASS,False)
Call PressEnter()
Call TakeScreenShot()
Call SetTextBox("Description","RMCLM-KLBEZ",0,DT_CLASS_DESCRIPTION,False)
Call SelectCheckbox("RMCLM-LOCLA", 0, "ON", False)
Call ClickButton("Change Language   \(Shift\+F8\)",False)
Call SetTextBox("Language","RMCLM-NEUSP",0,DT_CLASS_LANGUAGE,True)
...
Call VerifyStatusBar(DT_CLASS_STATUSBAR)

'''Adding stores to the site group
Call SetTcode(DT_PRE_TCODE_1)     
Call PressEnter()  
Call TakeScreenShot()
Call SetFocusGuiLabel("030", 11, 56, False)
Call ClickButton("Copy   \(Enter\)",False)
Call TakeScreenShot()
Call SetTextBox("Class","RMCLF-CLASN",0,DT_CLASS,False)
Call TakeScreenShot()
Call ClickButton("Create new assignments   \(Ctrl\+F9\)",False)
Call SelectRadioButtonByIndexIfPopupExists("RMCLF-RADIO", 1)
Call FocusRadioButtonByIndexIfPopupExists("RMCLF-RADIO", 1)
Call ClickButton("Continue   \(Enter\)",False)
Call TakeScreenShot()
Call SetTableDataNoRef("SAPLCBCMTC_OBJ_CLASS", "CustomerNoSite", 1, DT_SITE, False)
Call PressEnter()  
Call TakeScreenShot()
Call ClickButton("Save   \(Ctrl\+S\)",False)
...
'''Call VerifyStatusBar("Promotion "&DT_DOCUMENT_NUMBER_OUTPUT&" created")
'''Call TakeScreenShot()
