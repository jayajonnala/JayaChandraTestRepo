...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_S2A_PRI_03_04-Calculate wholesale price for PL optional - tariff 96-
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_S2A_PRI_03_04-tariff 96-"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\MI\RETAIL\TASE_DT_S2A_PRI_03_04-Calculate wholesale price for PL optional - tariff 96-.xls"
...
Call TakeScreenShot
Call SelectRowGuiGrid("", 0, "Article", DT_VKP5_3010_TABLECELL_SINGLE_VALUE_1, False)
Call ClickButtonToolBar("KALK", 0)
Call TakeScreenShot
Call GetTextboxValue("KOMP-MATNR", "", "DT_VKP5_6201_CHECK_TEXT_OF_ARTICLE_OUTPUT", False)
Call GetTableCellData("SAPLV69ATCTRL_KONDITIONEN", "Amount", 1, "<NA>", "<NA>", "DT_VKP5_6201_CHECK_TEXT_OF_TABLECELL_AMOUNT_0_OUTPUT", False)
...
Call SetTcode(DT_VK13)     
Call PressEnter()     

Call SetTextbox("Condition Type","RV13A-KSCHL","",DT_VK13_COND_TYPE,False)
Call ClickButton("Condition Information   \(Shift\+F4\)",False) 
Call SetTextbox("Article","F001-LOW","",DT_VK13_ARTICLE,False)
Call SetTextbox("Sales Organization","F002-LOW","",DT_VK13_SALES_ORG,False)
Call SetTextbox("Distribution Channel","F003-LOW","",DT_VK13_DISTR_CHANNEL,False)
Call SetTextbox("from / on","SEL_DATE","","",False)
Call ClickButton("Execute   \(F8\)",False)
'Call SelectCheckboxNoLabel(0, DT_VK11_0120_NO_NAME, False)
Call ClickButton("btn\[16\]",False)
Call ClickButton("Display   \(F5\)",False)
Call TakeScreenShot
Call VerifyTableCellContent(2, "CnTy", "SAPMV13ATCTRL_D0201", DT_VK13_CHECK_COND)
Call VerifyTableCellContent(2, "Amount", "SAPMV13ATCTRL_D0201", DT_VK13_AMOUNT)
