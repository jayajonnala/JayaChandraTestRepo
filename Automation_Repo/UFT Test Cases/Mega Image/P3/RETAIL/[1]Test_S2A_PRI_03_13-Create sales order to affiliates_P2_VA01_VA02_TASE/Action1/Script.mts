...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_S2A_PRI_03_13-Create sales order to affiliates_P2_VA01_VA02
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_S2A_PRI_03_13-Create sales order to affiliates_P2_VA01_VA02"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\P3\MI\RETAIL\TASE_DT_S2A_PRI_03_13-Create sales order to affiliates_P2_VA01_VA02.xls"
...
Call SetTextbox("Order","VBAK-VBELN","",DT_VA01_4001_GET_SALES_ORDER_NO_OUTPUT,False)
Call PressEnter()     
Call TakeScreenShot
Call PressEnter()     
Call TakeScreenShot
Call SetTableData("SAPMV45ATCTRL_U_ERF_AUFTRAG", "Order Quantity", 3, "", "", DT_VA01_4900_TABLECELL_ORDER_QUANTITY_3_OCC1, false)
Call TakeScreenShot
Call PressEnter()
Call ClickButtonIfExist("Save   \(Ctrl\+S\)",False)
Call GetStatusBar("item2", "DT_VA01_4001_GET_SALES_ORDER_NO_OUTPUT")
