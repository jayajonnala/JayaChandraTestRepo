...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_P2P_01_01_062-Matching invoice with 2 GR for Articles_P6_IDOC_POST   
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_P2P_01_01_062 Articles_P6_IDOC_POST"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\P3\MI\RETAIL\DT_P2P_01_01_062-Matching invoice with 2 GR for Articles_P6_IDOC_POST.xls"
...
Call SetTextbox("Changed On","SX_UPDDA-LOW","",ConvertDate(DT_WE05_1100_CHANGED_ON_DATE),False)      
Call TakeScreenShot
Call ClickButton("Execute   \(F8\)",False)
Call TakeScreenShot

''''Wait untill the required path appears on tree  (Retail Pre-Production;IDoc in inbound processing;Application document posted)
Call ActivateNodeGuiTree(0, "#2;#1;#1")
Call TakeScreenShot


Call GetGridContent("IDoc Selection", "", "Status text", "1", "IDoc number", DT_IDOC_VALUE_OUTPUT, "DT_WE05_0100_CHECK_GETCELLVALUE_OF_GRIDCELL_0_STAT_TXT_OUTPUT")
Call TakeScreenShot
...
Call VerifyGridCellContent("",6,"Posting Key","",DT_WE05_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_3_BSCHL)
Call VerifyGridCellContent("",6,"Account","",DT_WE05_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_3_KTONR)
