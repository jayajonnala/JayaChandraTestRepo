...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_REB_07_01-ZMU8 - Enter CN Contract in SAP_P2_Create PO  
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_REB_07_01-ZMU8_P2_Create PO"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\P3\MI\RETAIL\TASE_DT_REB_07_01-ZMU8 - Enter CN Contract  in SAP_P2_Create PO.xls"
...
Call SetComboByKey("MEPO_TOPLINE-BSART", DT_PO_TYPE)
...
call GetTableCellData("SAPLV69ATCTRL_KONDITIONEN","CnTy",7,"","","DT_ME21N_6201_CHECK_TEXT_OF_TABLECELL_CNTY_6",false)

' VerifyTableCellContent(tableRowNumber, tableColumnName, tableName, expectedValue)
'VerifyTableCellContent

Call VerifyTableCellContent(7, "CnTy", "SAPLV69ATCTRL_KONDITIONEN", DT_ME21N_6201_CHECK_TEXT_OF_TABLECELL_CNTY_6)
Call TakeScreenShot
Call ClickButton("Save   \(Ctrl\+S\)",False)
Call ClickButtonIfExist("Save",True)
Call TakeScreenShot
Call GetStatusBar("item2","DT_PO_NUMBER_OUTPUT")
Call VerifyStatusBar("Standard PO created under the number "&DT_PO_NUMBER_OUTPUT)
Call TakeScreenShot
