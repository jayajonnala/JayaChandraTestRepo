...
'
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_P2P_01_01_070-Physical inventory DC WMS RW04_P1_TASE
'.................Author : TCS        :Bitan
...
gstrTestCaseName = "Test_P2P_01_01_070 WMS RW04_P1_TASE"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\TASE Files\DATA\DT_P2P_01_01_070-Physical inventory DC WMS RW04_P1_TASE.xls"
''''--------------------------------------------------
...
Call ClickButton("%_R_MTART_%_APP_%-VALU_PUSH",False)
Wait(2)
...
Call ClickButton("%_R_LGORT_%_APP_%-VALU_PUSH",False)
Wait(2)
Call SetTableDataNoRef("SAPLALDBSINGLE","Single value",1,DT_MI31_0120_CHECK_TEXT_OF_NO_NAME,True)'select
Call SetTableDataNoRef("SAPLALDBSINGLE","Single value",2,DT_MI31_0120_CHECK_TEXT_OF_NO_NAME_OCC1,True)'select
Call SetTableDataNoRef("SAPLALDBSINGLE","Single value",3,DT_MI31_0120_CHECK_TEXT_OF_NO_NAME_OCC2,True)'select
Call SetTableDataNoRef("SAPLALDBSINGLE","Single value",4,DT_MI31_0120_CHECK_TEXT_OF_NO_NAME_OCC3,True)'select
Call SetTableDataNoRef("SAPLALDBSINGLE","Single value",5,DT_MI31_0120_CHECK_TEXT_OF_NO_NAME_OCC4,True)'select
Call SetTableDataNoRef("SAPLALDBSINGLE","Single value",6,DT_MI31_0120_CHECK_TEXT_OF_NO_NAME_OCC5,True)'select
'Capture the screenshot
Call TakeScreenShot()
Call ClickButton("Copy   \(F8\)",True)
Wait(1)
...
Call VerifyifGuiLabelExists(DT_MI31_0120_CHECK_TEXT_OF_NO_NAME_OCC2)
Call VerifyifGuiLabelExists(DT_MI31_0120_CHECK_TEXT_OF_NO_NAME_OCC3)
Call VerifyifGuiLabelExists(DT_MI31_0120_CHECK_TEXT_OF_NO_NAME_OCC4)
Call VerifyifGuiLabelExists(DT_MI31_0120_CHECK_TEXT_OF_NO_NAME_OCC5)
Wait(2)
...
'select row
Call SelectRowGuiTable("SAPMSBDC_CCTC_APQI","Session Name",DT_MI31_1005_SESS,False)
...
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL","Message",5,"Index","4","DT_MI31_0400_GET_TEXT_OF_TABLECELL_MESSAGE_4_OUTPUT",False)
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL","Message",6,"Index","5","DT_MI31_0400_GET_TEXT_OF_TABLECELL_MESSAGE_5_OUTPUT",False)
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL","Message",7,"Index","6","DT_MI31_0400_GET_TEXT_OF_TABLECELL_MESSAGE_6_OUTPUT",False)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
