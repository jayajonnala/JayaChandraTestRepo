...
'
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_P2P_01_01_070-Physical inventory DC WMS RW04_P2_TASE
'.................Author : TCS        :Bitan
...
gstrTestCaseName = "Test_P2P_01_01_070- WMS RW04_P2_TASE"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\TASE Files\DATA\DT_P2P_01_01_070-Physical inventory DC WMS RW04_P2_TASE.xls"
...
Call SetTextbox("Layout","P_VARI","","",False)'DT_MI24_1000_LAYOUT
...
'Capture the screenshot
Call TakeScreenShot()
 ''SelectCheckBoxByGuiLabel(refLabelContent, xDifferenceValue, yDifferenceValue, OnOffStatus)


''Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME,"17","1","ON")
Call SelectCheckBoxByGuiLabel(DT_VALUE_1,"17","1","ON")
...
Call VerifyifGuiLabelExists(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC6)
Call VerifyifGuiLabelExists(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC7)
...
Call VerifyifGuiLabelExists(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC10)
Call VerifyifGuiLabelExists(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC11)

SAPGuiSession("transaction:=MI24").SAPGuiWindow("transaction:=MI24").HorizontalScrollbarPosition 157
Call VerifyifGuiLabelWithIndexExists(Lcase(DT_MI24_0120_CHECK_TEXT_OF_NOT_YET_COUNTED_OCC5),"5")
Call VerifyifGuiLabelWithIndexExists(Lcase(DT_MI24_0120_CHECK_TEXT_OF_NOT_YET_COUNTED_OCC4),"4")
Call VerifyifGuiLabelWithIndexExists(Lcase(DT_MI24_0120_CHECK_TEXT_OF_NOT_YET_COUNTED_OCC3),"3")
...
''Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC8,"17","1","ON")
''Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME,"17","1","ON")
Call SelectCheckBoxByGuiLabel(DT_VALUE_2,"17","1","ON")
Call SelectCheckBoxByGuiLabel(DT_VALUE_1,"17","1","ON")
...
'''''Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC2,"17","1","ON")
'''''Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC4,"17","1","ON")
'''''Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC6,"17","1","ON")
'''''Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC10,"17","1","ON")
call SelectCheckBoxByGuiLabel(DT_VALUE_3,"17","1","ON")
Call SelectCheckBoxByGuiLabel(DT_VALUE_4,"17","1","ON")
Call SelectCheckBoxByGuiLabel(DT_VALUE_5,"17","1","ON")
Call SelectCheckBoxByGuiLabel(DT_VALUE_6,"17","1","ON")
'Capture the screenshot
Call TakeScreenShot()
...
Call SelectCheckbox("ISEG-XNULL","1",DT_MI24_0731_CHECK_SELECTED_OF_ISEGXNULL_OCC2,False)
Call VerifyTextBoxContent("Site","IKPF-WERKS","",DT_MI24_0731_CHECK_TEXT_OF_SITE_OCC4,False)
Call VerifyTextBoxContent("Stor\. Loc\.","IKPF-LGORT","",DT_MI24_0731_CHECK_TEXT_OF_STOR_LOC_OCC4,False)
'Capture the screenshot
Call TakeScreenShot()
Call ClickButton("Post   \(Ctrl\+S\)",False)
...
Call SelectCheckbox("ISEG-XNULL","1",DT_MI24_0731_CHECK_SELECTED_OF_ISEGXNULL_OCC3,False)
Call VerifyTextBoxContent("Site","IKPF-WERKS","",DT_MI24_0731_CHECK_TEXT_OF_SITE_OCC5,False)
Call VerifyTextBoxContent("Stor\. Loc\.","IKPF-LGORT","",DT_MI24_0731_CHECK_TEXT_OF_STOR_LOC_OCC5,False)
'Capture the screenshot
Call TakeScreenShot()
Call ClickButton("Post   \(Ctrl\+S\)",False)
...
Call SetTextbox("Layout","P_VARI","","",False)'DT_MI24_1000_LAYOUT_OCC1
...
Call VerifyifGuiLabelExists(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC18)
Call VerifyifGuiLabelExists(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC19)
...
Call VerifyifGuiLabelExists(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC22)
Call VerifyifGuiLabelExists(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC23)

SAPGuiSession("transaction:=MI24").SAPGuiWindow("transaction:=MI24").HorizontalScrollbarPosition 157

Call VerifyifGuiLabelWithIndexExists(Lcase(DT_MI24_0120_CHECK_TEXT_OF_COUNTED_OCC5),"5")
Call VerifyifGuiLabelWithIndexExists(Lcase(DT_MI24_0120_CHECK_TEXT_OF_COUNTED_OCC4),"4")
Call VerifyifGuiLabelWithIndexExists(Lcase(DT_MI24_0120_CHECK_TEXT_OF_COUNTED_OCC3),"3")
...
Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC18,"17","1",DT_MI24_0120_NO_NAME_OCC12)
Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC20,"17","1",DT_MI24_0120_NO_NAME_OCC13)
Call SelectCheckBoxByGuiLabel(DT_MI24_0120_CHECK_TEXT_OF_NO_NAME_OCC22,"17","1",DT_MI24_0120_NO_NAME_OCC14)
'Capture the screenshot
Call TakeScreenShot()
...
'Capture the screenshot
Call TakeScreenShot()
Call GetTextStatusBar("DT_MI24_0701_GET_TEXT_OF_STATUSBAR_OCC6_OUTPUT")
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
...
'Capture the screenshot
Call TakeScreenShot()
Call GetTextStatusBar("DT_MI24_0120_GET_TEXT_OF_STATUSBAR_OUTPUT")
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
