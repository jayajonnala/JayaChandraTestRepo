...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_PRE_Destroy_Full_Stock_of_Article_TASE     
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_PRE_Destroy_Full_Stock_of_Article"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\P3\MI\RETAIL\TASE_DT_PRE_Destroy_Full_Stock_of_Article.xls"
...
Call SetTextbox("Posting Date","P_BUDAT", "", ConvertDate(DT_POSTING_DATE), False)
...
Call SetTextbox("Article","S_MATNR-LOW", "", DT_ARTICLE, False)
...
Call SetTextbox("Material Type","S_MTART-LOW", "", "", False)
...
Call TakeScreenShot
Call SelectRowGuiGrid("", 1, "Article", DT_ARTICLE, False)
Call ClickButton("Save Documents   \(F8\)", False)
Call TakeScreenShot
Call GetGridContent("", 0, "MBLNR", 1, "<NA>", "<NA>", "DT_DESTRUCTION_DOC_NUMBER_OUTPUT")
Call VerifyGridCellContent("", 1, "MBLNR", 0, DT_DESTRUCTION_DOC_NUMBER_OUTPUT)
Call TakeScreenShot
