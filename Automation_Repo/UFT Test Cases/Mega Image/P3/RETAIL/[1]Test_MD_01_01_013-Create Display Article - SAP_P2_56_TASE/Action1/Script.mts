...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_AA010- Asset Creation - create asset directly in SAP
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_AA010- Asset Creation - create asset directly in SAP"
...
Call GetTableCellData("SAPLAISTTC_EQUI", "Equipment number", 1, "<NA>", "<NA>", "DT_AS01_1170_CHECK_TEXT_OF_TABLECELL_EQUIPMENT_NUMBER_0_OUTPUT", False)
Call SelectTab("TABSTRIP100", "Origin", False)
...
Call VerifyTableCellContent(1, "Area number", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_AREA_NUMBER_0)
Call VerifyTableCellContent(2, "Area number", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_AREA_NUMBER_1)
Call VerifyTableCellContent(3, "Area number", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_AREA_NUMBER_2)
Call VerifyTableCellContent(4, "Area number", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_AREA_NUMBER_3)
Call VerifyTableCellContent(5, "Area number", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_AREA_NUMBER_4)

Call VerifyTableCellContent(1, "Depreciation area", "SAPLAISTTC_ANLB", lcase(DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_DEPRECIATION_AREA_0))
Call VerifyTableCellContent(2, "Depreciation area", "SAPLAISTTC_ANLB", lcase(DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_DEPRECIATION_AREA_1))
Call VerifyTableCellContent(3, "Depreciation area", "SAPLAISTTC_ANLB", lcase(DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_DEPRECIATION_AREA_2))
Call VerifyTableCellContent(4, "Depreciation area", "SAPLAISTTC_ANLB", lcase(DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_DEPRECIATION_AREA_3))
Call VerifyTableCellContent(5, "Depreciation area", "SAPLAISTTC_ANLB", lcase(DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_DEPRECIATION_AREA_4))
...
Call VerifyTableCellContent(5, "DKey", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_DKEY_4)

Call VerifyTableCellContent(1, "Prd", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_PRD_0)
Call VerifyTableCellContent(2, "Prd", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_PRD_1)
Call VerifyTableCellContent(3, "Prd", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_PRD_2)
Call VerifyTableCellContent(4, "Prd", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_PRD_3)
Call VerifyTableCellContent(5, "Prd", "SAPLAISTTC_ANLB", DT_AS01_1190_CHECK_TEXT_OF_TABLECELL_PRD_4)
