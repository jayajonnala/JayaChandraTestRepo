...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_MD_01_01_005-Create Article using DAP ZUNB
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_MD_01_01_005- DAP ZUNB"
...
'Call SelectWebList(0,"","Article_View\.Artc_Basic_Info\.country_code_iso",0,DT_ARTICLE_VIEWARTC_BASIC_INFOVEND_COUNTRYORI,False)
'Wait(5)
...
'Enter the details
Call SelectWebCheckbox(0,"","Article_View\.Artc_Base_Units\[0\]\.vend_sales_uom_flag","INPUT",0,DT_ARTICLE_VIEWARTC_BASE_UNITS0VEND_SALES_UOM_FLAG,False)
Wait(1)
Call SelectWebCheckbox(0,"","Article_View\.Artc_Base_Vend_GTINs\[0\]\.vend_gtin_main_flag","INPUT",0,DT_ARTICLE_VIEWARTC_BASE_VEND_GTINS0VEND_GTIN_MAIN_FLAG,False)
Wait(1)
Call SelectWebCheckbox(0,"","Article_View\.Artc_Base_Units\[0\]\.vend_po_uom_flag","INPUT",0,DT_ARTICLE_VIEWARTC_BASE_UNITS0VEND_PO_UOM_FLAG,False)
Wait(1)
Call SelectWebCheckbox(0,"","Article_View\.Artc_Base_Units\[0\]\.vend_deli_uom_flag","INPUT",0,DT_ARTICLE_VIEWARTC_BASE_UNITS0VEND_DELI_UOM_FLAG,False)
Wait(1)
