...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_P2P_01_01_0134-Production of juice in RW29 DPL Cancelation_P2_Check_MAP     
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_P2P_01_01_0134- DPL Cancelation_P2_Check_MAP"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\P3\MI\RETAIL\TASE_DT_P2P_01_01_0134-Production of juice in RW29 DPL Cancelation_P2_Check_MAP.xls"
...
'''''--------TransactionCode-/nZMDIM_MBMAPCHANGES----------''''

Call SetTcode(DT_MIGO_3000_OKCD_OCC4)     
Call PressEnter()   

Call SelectRadioButtonIfExist("P_FROM", "", False)
...
Call SetTextbox("Year","P_YEAR","",DT_ZMDIM_MBMAPCHANGES_1000_YEAR,False)
Call SetTextbox("Reference Document","P_DOCU","",DT_ZMDIM_MBMAPCHANGES_1000_REFERENCE_DOCUMENT,False)
Call TakeScreenShot
Call PressEnter() 
Call ClickButton("Execute   \(F8\)",false)
Call SelectColumnGuiGrid("", 0, "AWREF", False)
...
Call TakeScreenShot
Call VerifyGridCellContent("", 1, "ICON", 0, DT_ZMDIM_MBMAPCHANGES_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_ICON)
