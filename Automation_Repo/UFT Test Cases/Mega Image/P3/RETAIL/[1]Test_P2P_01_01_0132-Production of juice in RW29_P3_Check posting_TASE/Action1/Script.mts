...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_P2P_01_01_0132-Production of juice in RW29_P3_Check posting     
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_P2P_01_01_0132_P3_Check posting"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''gstrInputExcelFilePathAndName="S:\TASETestData\P3\MI\RETAIL\TASE_DT_P2P_01_01_0132-Production of juice in RW29_P3_Check posting.xls"
...
Call TakeScreenShot
Call VerifyTableCellContent(2, "Status", "SAPDV70ATC_NAST3", DT_MIGO_0100_CHECK_TEXT_OF_TABLECELL_STATUS_1)
Call VerifyTableCellContent(2, "Output Type", "SAPDV70ATC_NAST3", DT_MIGO_0100_CHECK_TEXT_OF_TABLECELL_OUTPUT_TYPE_1)
...
Call SetTextbox("Article Document","RG_MBLNR-LOW","",DT_MIGO_1000_ARTICLE_DOCUMENT,False)
Call SetTextbox("Article Doc. Year","PM_MJAHR","",DT_MIGO_1000_ARTICLE_DOC_YEAR,False)
Call TakeScreenShot
...
Call VerifyifGuiLabelExists(DT_MIGO_0120_CHECK_TEXT_OF_PRODUSE_FINITE)
Call VerifyifGuiLabelExists(DT_MIGO_0120_CHECK_TEXT_OF_NO_NAME)


'''''--------TransactionCode-/nMIGO----------''''
...
Call PressEnter() 
Call SetTextboxNoLabel("GODYNPRO-MAT_DOC", 0, DT_MIGO_1000_ARTICLE_DOCUMENT_OCC1, False)
Call PressEnter() 
Call ClickButton("Execute",false)
Call TakeScreenShot
...
Call GetTextboxValue("BKPF-BELNR", "", "DT_MIGO_0750_CHECK_TEXT_OF_DOCUMENT_NUMBER_OUTPUT", False)
