...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_117_SRM Standard SC Catalog Item Different PO Currency (All Opco)_P1
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_117_SRM Standard SC Catalog Item Different PO Currency (All Opco)_P1_TASE"
...
Call CaptureWebScreen(0,"Personal Object Work List")
...
Wait(5)
Call CaptureWebScreen(0,"AFter data filling")
...
'''Call ClickWebElementFrame(1, "Shopping Cart", "SPAN", "Purchase order created", 0)
Call ClickWebElementFrame(1, "Shopping Cart", "SPAN", "Purchase Order", 0)
Wait 20
Call CaptureWebScreen(1,"View created Purchase order")

''Call GetValueWebElementSAPFrame(1, "Floor Plan Manager application for OIF", "WD036A", "lsTextView.*", "DT_PONUM_OUTPUT")
...
'''Call GetValueWebEditSapFrame(1, "Floor Plan Manager application for OIF", "lsField.*", "INPUT", "WD036F", 0, "DT_ITEM_NUMBER")
...
Call ClickWebElementFrame(1, "Shopping Cart", "SPAN",DT_LINK, 0)
Wait 30
Browser("CreationTime:=2").FullScreen

Call CaptureWebScreen(2,"Capture screen:Purchase Order Overview")

Call VerifySAPEditFrame(2,"DG SRM  PO.*","Purchasing Document","text",0,DT_PONUMBER)
Wait 10
...
Wait 10
Call CaptureWebScreen(0,"Close button")
