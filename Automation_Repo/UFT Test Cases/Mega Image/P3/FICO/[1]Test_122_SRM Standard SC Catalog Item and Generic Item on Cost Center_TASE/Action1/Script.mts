...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_122_SRM Standard SC Catalog Item and Generic Item on Cost Center
'.................Author : TCS 	   :
'................ Creation Date    :
'.................Modified By :
...
gstrTestCaseName = "Test_122_SRM Standard SC Catalog Item and Generic Item on Cost Center_TASE"
...
Call CaptureWebScreen(1,"Shopping Cart Screen")
...
Wait 15
Call CaptureWebScreen(1,"Item Search screen")
...
Call CaptureWebScreen(1,"Item number  screen")
...
Set wsh= nothing
Wait(30)
Call CaptureWebScreen(1,"Item Link  screen")
Call ClickWebElementSAPFrame(1,"Floor Plan Manager application for OIF","/SAPSRM/WDC_SH_CATALOGS\.ID_FEBF028F729D3D320AF9860321669ADF:V_CATALOGS\.CI000010102-text","MI SRM-MDM Pre\. EU - RO","lsLink__text",0)
Wait 15
Call ClickWebElementFrame(1, "ProcurementCatalog7Ehp1", "SPAN", "Advanced Search", 0)
Wait 10
