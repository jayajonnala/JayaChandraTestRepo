...
gstrTestCaseName = "Test_136_SRM Regularization SC Generic item on cost Center (MI)_TASE"
...
Call ClickWebElementFrameHtmlID(1, "Create Shopping Cart", "SPAN", "/SAPSRM/WDC_UI_SC_DOFC_HD\.ID_77C46A3FE491AE899896FA457CF4DA7F:V_SC_BOFC_HD\.ZMDIP_REG_SC_ATTR", 0)
Wait(5)
...
Set wsh= nothing
Wait(30)
Call CaptureWebScreen(1,"Item value")
Call ClickWebElementSAPFrame(1,"Floor Plan Manager application for OIF","/SAPSRM/WDC_SH_CATALOGS\.ID_FEBF028F729D3D320AF9860321669ADF:V_CATALOGS\.CI000010102-text","MI SRM-MDM Pre\. EU - RO","lsLink__text",0)
Wait 15
Call CaptureWebScreen(1,"Advanced Search")
Call ClickWebElementFrame(1, "ProcurementCatalog7Ehp1", "SPAN", "Advanced Search", 0)
Wait 10
...
Call SetWebEditFrame(1, "Shopping Cart", "/SAPSRM/WDC_DODC_SC_I_BD\.ID_C3B4C372BB7F609EE2C58F327F2D2036:V_DODC_SC_I_BD\.QUANTITY", "text", 0, DT_ORDER_QUANTITY__UNIT_OCC1)
Call SetWebEditFrame(1, "Shopping Cart", "/SAPSRM/WDC_DODC_SC_I_BD\.ID_C3B4C372BB7F609EE2C58F327F2D2036:V_DODC_SC_I_BD\.PRICE", "text", 0, DT_PRICE__CURRENCY_OCC1)
Call CaptureWebScreen(1,"Quantity updation")
