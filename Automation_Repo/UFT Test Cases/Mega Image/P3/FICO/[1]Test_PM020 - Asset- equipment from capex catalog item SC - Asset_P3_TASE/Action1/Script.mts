...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_PM020 - Asset- equipment from capex catalog item SC - Asset_P3
'.................Author : TCS 	   :
'................ Creation Date    :
'.................Modified By :
...
gstrTestCaseName = "Test_PM020 - Asset- equipment from capex catalog item SC - Asset_P3_TASE"
...
Wait 10
Call CaptureWebScreen(1,"Capture Home Screen")
...
'Call ClickWebElementFrameHtmlID(1, "Create Shopping Cart", "SPAN", "WDD2", 0)
Wait(5)
...
Set wsh= nothing
Wait(30)
Call CaptureWebScreen(1,"Capture Add item popup Screen")
...
Call CaptureWebScreen(1,"COSTCENTER updation")
...
wait 20
Call CaptureWebScreen(0,"Capture screen:Approval Flow")
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
