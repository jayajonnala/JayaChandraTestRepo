...
gstrTestCaseName = "Test_SRM_Approve_SC_Submit_SC_TASE"
...
' LaunchSAPWebApplication(DT_SAPURL)
...
'Call ClickFrameSAPButton(1,"Approve Shopping Cart","Submit","SPAN",0)
Call ClickFrameSAPButton(1,"Approve Shopping Cart","Submit","DIV",0)
Wait 45
Call CaptureWebScreen(1,"Submit button")

Call VerifyFrameWebElement(1, "", "Display Document:", "DIV", DT_, "ls.*", 0, False)
Wait 10
...
'Call VerifyFrameWebElement(1, "", "Document:", "SPAN", DT_APPROVAL_MESSAGE, "lsTextView.*", 0, False)
Wait 10
'Call ClickFrameSAPButton(1,"Document:","Close","SPAN",0)
