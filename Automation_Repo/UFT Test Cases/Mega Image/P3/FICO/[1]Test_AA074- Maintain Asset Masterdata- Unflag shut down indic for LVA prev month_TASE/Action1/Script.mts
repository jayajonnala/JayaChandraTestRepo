...
'
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_AA074- Maintain Asset Masterdata- Unflag shut down indic for LVA prev month_TASE
'.................Author : TCS        :Bitan
...
gstrTestCaseName = "Test_AA074- Maintain Asset Masterdata- Unflag shut down indic for LVA prev month_TASE"
...
'
Call StartDateof445PeriodByDate(DT_DATE,"DT_STARTING_DATE_PERIOD")
Call StartDateof445PeriodByDate(DT_TODAY,"DT_STARTING_DATE_PERIOD_OCC1")
...
Call SetTextbox("Document Date","BKPF-BLDAT","",DT_DOCUMENT_DATE,False)
...
Call VerifyTextBoxContent("Ord\.dep\.start date","AW01_DEP_PAR-AFABG","",DT_AS01_0304_CHECK_TEXT_OF_ORDDEPSTART_DATE,False)
...
Call VerifyTextBoxContent("Ord\.dep\.start date","AW01_DEP_PAR-AFABG","",DT_AS01_0304_CHECK_TEXT_OF_ORDDEPSTART_DATE_OCC1,False)
