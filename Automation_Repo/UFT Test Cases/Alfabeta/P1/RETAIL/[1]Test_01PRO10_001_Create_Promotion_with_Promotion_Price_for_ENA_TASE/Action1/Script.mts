...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_01PRO10_001_Create_Promotion_with_Promotion_Price_for_ENA
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_01PRO10_001_Create_Promotion_with_Promotion_Price_for_ENA"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\Program Files (x86)\TCS\Test Automation Solution for Enterprise Applications\DEmopractice\Data\P1_DATA\DT_01PRO10_001_Create_Promotion_with_Promotion_Price_for_ENA_TASE.xls"
...
Call SetComboByKey("WAKHD-KALKE",DT_WAK1_PRICE_ACTIV_TYPE)
...
Call SetTableData("SAPMWAKAUEB_SERF","Article","2","","",DT_WAK1_8210_TABLECELL_ARTICLE_1,False) 
...
'--------------------------------------------  WAK5------------------------------------------------
Call SelectMenuBar("Promotion;Subseq. processing")
Call CheckTCodeScreen(DT_EXPECTEDTRANSACTIONCODE_OCC2)

Call  ClickButton("Price activation overview   \(Ctrl\+F1\)",False)
Call VerifyTextBoxContent("Promotion","WAKTD-AKTKT",0,UCASE(DT_WAK1_0520_CHECK_TEXT_OF_PROMOTION),False)
Call SetTableData("SAPMWAKAPREISAK","S","1","","",DT_WAK1_2400_TABLECELL_S_0,False) 
Call SetTableData("SAPMWAKAPREISAK","S","2","","",DT_WAK1_2400_TABLECELL_S_1,False)
Call  ClickButton("Activate prices",False)
Call TakeScreenShot()
Call VerifyTableCellContentPopup(1,"Site group","SAPLWAK1ACTIVATE_DATES",DT_WAK1_1500_CHECK_TEXT_OF_TABLECELL_SITE_GROUP_0)
Call SelectCheckbox("RWAKA-KZ_WALE_PRICES",0,"ON",True)
Call TakeScreenShot()
Call  ClickButton("Display Cost Estimate   \(F5\)",True)
Call TakeScreenShot()
