'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_MD_AB_005 Create ZCXT Franchise  
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_MD_AB_005 Create ZCXT Franchise"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\Program Files (x86)\TCS\Test Automation Solution for Enterprise Applications\DEmopractice\Data\P1_DATA\DT_MD_AB_005 Create ZCXT Franchise_TASE.xls"
...
Call SetTextbox("Tax Number 2","KNA1-STCD2","",DT_TAX_NUMBER_2,False) 
Call SetTextbox("VAT Reg\. No\.","KNA1-STCEG","",DT_VAT,False) 
Call TakeScreenShot()
...
Call PressEnter()
Call SetTableData("SAPLCTMSCHARS_S","Value","8","","",DT_XD01_5100_TABLECELL_VALUE_7,False)
Call TakeScreenShot()
...
Call  SelectCheckbox("KNVV-UEBTK",0,DT_XD01_7316_UNLIMITED_TOL,False)
Call TakeScreenShot()
...
Call VerifyStatusBar("Customer "& DT_CUSTOMER_OUTPUT &" has been created for company code GR02 sales area GS02 05 01")
