...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_Article Creation via DAP_V2
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_Article Creation via DAP_V2"
...
Call ClickLink(0,"","","Empties",False)
Wait(1)
Call CaptureWebScreen(0,"Create New Article:OpCo Specific View")
Call SelectWebList(0,"","Article_View\.Artc_MDM_ABs\[0\]\.empties_article_matnr",0,"000000000007124236 - KENH ΦIAΛ.330 AMSTEL",False)
Wait(1)
Call SetWebEdit(0,"","Article_View\.Artc_MDM_ABs\[0\]\.empties_nbr_in_ea","text",0,DT_ARTC_ARTICLE_NBR_IN_EA,False)
Wait(1)
Call CaptureWebScreen(0,"Create New Article:OpCo Specific View")
