...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_01PRI00_019_Creation_of_SPC_DSD_article_margin_logic
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_01PRI00_019_Creation_of_SPC_DSD_article_margin_logic"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\Program Files (x86)\TCS\Test Automation Solution for Enterprise Applications\DEmopractice\Data\P1_DATA\DT_01PRI00_019_Creation_of_SPC_DSD_article_margin_logic_TASE.xls"
...
Call SetTextbox("Validity","S_DATUM-LOW","",ConvertDate(DT_VALIDITY_DATE),False)
...
Call VerifyGridCellContent("",1,"LIFNR",0,FormatBlank(DT_VKP5_100_CHECK_GETCELLVALUE_OF_GRIDCELL_0_LIFNR))
Call VerifyGridCellContent("",2,"LIFNR",0,FormatBlank(DT_VKP5_100_CHECK_GETCELLVALUE_OF_GRIDCELL_1_LIFNR))
Call VerifyGridCellContent("",1,"MATNR",0,DT_VKP5_100_CHECK_GETCELLVALUE_OF_GRIDCELL_0_MATNR)
Call VerifyGridCellContent("",2,"MATNR",0,DT_VKP5_100_CHECK_GETCELLVALUE_OF_GRIDCELL_1_MATNR)

'''Call SelectCellGuiGrid("",0,1,"Vendor",False)
Call SelectCellGuiGrid("",0,1,"Supplier",False)
...
Call VerifyGridCellContent("",1,"ENDPR",0,DT_VKP5_CHECK_GRIDCELL_0_ENDPR)

'''Call SelectCellGuiGrid("",0,2,"Vendor",False)
Call SelectCellGuiGrid("",0,2,"Supplier",False)
Call ClickButtonToolBar("KALK",0)
Call TakeScreenShot()
...
Call ClickButtonIfExist("Back   \(F3\)",False)
Call GetGridContent("",0,"EKPNN",2,"<NA>","<NA>","DT_VKP5_100_GETCELLVALUE_OF_GRIDCELL_1_EKPNN_OUTPUT")
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
'''Call VerifyGridCellContent("",2,"ENDPR",0,DT_VKP5_100_CHECK_GETCELLVALUE_OF_GRIDCELL_1_ENDPR)
Call VerifyGridCellContent("",2,"ENDPR",0,DT_VKP5_CHECK_GRIDCELL_1_ENDPR)
