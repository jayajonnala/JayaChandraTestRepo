...
End If
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_01PRO11_002_Create_Vendor_Sales_Promotion_for_Bonus_Buy_via_WAK1_Scenario06
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_01PRO11_002_Create_Vendor_WAK1_Scenario06"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\Program Files (x86)\TCS\Test Automation Solution for Enterprise Applications\DEmopractice\Data\P1_DATA\DT_01PRO11_002_Create_Vendor_Sales_Promotion_for_Bonus_Buy_via_WAK1_TASE.xls"
...
End If
If DT_PP_DETERM_SEQUENCE<>"" Then
  Call SetTextbox("PP determ\. sequence","WAKHD-EKERV","",DT_PP_DETERM_SEQUENCE,False)	
End If
If DT_SALES_PRICE_COND<>"" Then
   Call SelectCheckbox("WAKHD-VKKON",0,DT_SALES_PRICE_COND,False) 	
End If
If DT_LISTING_CHECK<>"" Then
   Call SetTextbox("Listing Check","WAKHD-VTART","",DT_LISTING_CHECK,False)	
End If
Call TakeScreenShot()
Call PressEnter()
