...
Call GetTableCellData("SAPLMGD2TC_ME_8022", "Number", "","AUoM", "EA", "DT_EA_VALUE", False)
Call GetTableCellData("SAPLMGD2TC_ME_8022", "Number", "","AUoM", "CV", "DT_CV_VALUE", False)
Call ClickButton("Goto Component Creation",False)
Call TakeScreenshot()
Call SetTextbox("Unit of Measure","WSTR_DYNP-MEINH","","EA",False)
Call PressEnter()
CAll VerifyTableCellContent(1, "Component qty", "SAPLWST1TC_COMPONENTS", Left(DT_EA_VALUE,1))
Call ClickButton("Back   \(F3\)",False)
Call TakeScreenshot()
Call ClickButton("Goto Component Creation",False)
Call TakeScreenshot()
Call SetTextbox("Unit of Measure","WSTR_DYNP-MEINH","","CV",False)
Call PressEnter()
CAll VerifyTableCellContent(1, "Component qty", "SAPLWST1TC_COMPONENTS", Left(DT_CV_VALUE,1))
Call ClickButton("Back   \(F3\)",False)
Call TakeScreenshot()
