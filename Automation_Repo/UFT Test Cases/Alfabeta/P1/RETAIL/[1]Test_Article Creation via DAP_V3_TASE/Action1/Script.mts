...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_Article Creation via DAP_V3
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_Article Creation via DAP_V3"
...
Wait(1)
Call SetWebEdit(0,"","Article_View\.Artc_Descriptions\[0\]\.matl_vdescr","text",0,DT_ARTICLE_VIEWARTC_DESCRIPTIONS0MATL_SDESCR,False)
Wait(1)
...
Wait(1)
Call SetWebEdit(0,"","Article_View\.Artc_Descriptions\[1\]\.matl_vdescr","text",0,DT_ARTICLE_VIEWARTC_DESCRIPTIONS1MATL_SDESCR,False)
Wait(1)
...
Call SelectWebCheckbox(0,"","Article_View\.Artc_Alt_Vend_GTINs\[1\]\.vend_gtin_main_flag","INPUT",0,DT_ARTICLE_VIEWARTC_ALT_UNITS1VEND_PO_UOM_FLAG,False)
Call CaptureWebScreen(0,"Create New Article:Enter Article description")
...
Call ClickWebButton(0,"",".*btn-link btn-xs.*","Click here to add a new Alternative UOM!","BUTTON",0,False)
Wait 5
Call SelectWebCheckbox(0,"","Article_View\.Artc_Alt_Vend_GTINs\[2\]\.vend_gtin_main_flag","INPUT",0,DT_ARTICLE_VIEWARTC_ALT_UNITS1VEND_PO_UOM_FLAG,False)
...
Call ClickWebButton(0,"",".*btn-link btn-xs.*","Click here to add a new Alternative UOM!","BUTTON",0,False)
Wait(5)
Call SelectWebCheckbox(0,"","Article_View\.Artc_Alt_Vend_GTINs\[3\]\.vend_gtin_main_flag","INPUT",0,DT_ARTICLE_VIEWARTC_ALT_UNITS1VEND_PO_UOM_FLAG,False)
...
Wait(5)
Call SelectWebCheckbox(0,"","Article_View\.Artc_Alt_Vend_GTINs\[4\]\.vend_gtin_main_flag","INPUT",0,DT_ARTICLE_VIEWARTC_ALT_UNITS1VEND_PO_UOM_FLAG,False)
...
Wait(8)
'
''Call ClickLink(0,"","","Logistics",False)

Browser("Delhaize Article Portal").Page("Delhaize Article Portal").Link("Logistics").Click
''Call ClickLinkText(0,"","","Logistics",False)
...
''''-------Below lines of code is newly added due to DAP phase 2 changes--------
