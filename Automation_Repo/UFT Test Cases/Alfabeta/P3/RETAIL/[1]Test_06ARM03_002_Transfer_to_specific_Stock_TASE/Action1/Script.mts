...
gstrTestCaseName = "Test_06ARM03_002_Transfer_to_specific_Stock"
...
Call PressEnter()
'Updated Inspection Code Value
Call SetComboByKey("MSR_S_INSP_UI_ITM-FU_CODE",DT_MSR_INSPWH_2010_FOLLOWUP_ACTIVITY)
Call TakeScreenShot()
Call PressEnter()
'Added script for Target Location
Call SetTextbox("Target Storage Loc.","MSR_S_INSP_UI_ITM-IM_LGORT","",DT_MSR_TARGET_STORAGE_LOCATION,False)
Call PressEnter()
'''''Click on Next Entry
Call ClickButton("Next Entry",False) 
Call VerifyTextBoxContent("Article","MSR_S_INSP_UI_ITM-MATNR",0,DT_SECOND_ITEM,False)
Call SetTextbox("Inspection Code","MSR_S_INSP_UI_ITM-DEC_CODE","",DT_MSR_INSPWH_2010_INSPECTION_CODE_OCC1,False)
call SetComboByKey("MSR_S_INSP_UI_ITM-FU_CODE",DT_MSR_INSPWH_2010_FOLLOWUP_ACTIVITY_OCC1)
Call PressEnter()
'Click on Next Entry
Call ClickButton("Next Entry",False) 
Call VerifyTextBoxContent("Article","MSR_S_INSP_UI_ITM-MATNR",0,DT_THIRD_ITEM,False)
Call SetTextbox("Inspection Code","MSR_S_INSP_UI_ITM-DEC_CODE","",DT_MSR_INSPWH_2010_INSPECTION_CODE_OCC2,False)
Call SetCombo("MSR_S_INSP_UI_ITM-FU_CODE","No Further Activities")
...
Call TakeScreenShot()
'Updated below code as per TAO log
''----------------------Tcode  MSR_CRD----------------------------
...
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
'Call VerifyStatusBar("AB: ARM Credit Req. "&DT_ARM_CRED_REQ_OUTPUT&" has been saved")
...
Call TakeScreenShot()
'****** Need to Add code for getting Document status Value******************
