...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................06DCIM03_007_Pallet_File_Quantity_Surplus_in_status_10_P02_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_06DCIM03_007_Surplus_10_P02_TASE"
...
Call VerifyTEFieldByID("A", DT_P_FIELDID_C8, DT_P_FIELDVALUE_C12, DT_P_DESCRIPTION_C8)

Call SetTEFieldBY_ID ("A",DT_P_FIELDID_C9,DT_P_FIELDVALUE_C13,DT_P_DESCRIPTION_C9)
Call SendTEScreenKey ("A",DT_P_SENDKEY_C6)

'Call SetTEFieldBY_ID ("A",DT_P_FIELDID_C6,DT_P_FIELDVALUE_C10,DT_P_DESCRIPTION_C6)
'Call SendTEScreenKey ("A",DT_P_SENDKEY_C5)

Call CaptureScreenshot_Mainframe("A")

CAll Get_TEFieldValue_byID("A", DT_P_FIELDID_C10, "DT_PC_KG_PER_CASE_OUTPUT", DT_P_DESCRIPTION_C10)
CAll Get_TEFieldValue_byID("A", DT_P_FIELDID_C11, "DT_GET_CASES_PER_LAYER_OUTPUT", DT_P_DESCRIPTION_C11)
CAll Get_TEFieldValue_byID("A", DT_P_FIELDID_C12, "DT_GET_LAYERS_PER_PALLET_OUTPUT", DT_P_DESCRIPTION_C12)

Call SetTEField("A", DT_P_FIELDNAME_C4, DT_P_FIELDVALUE_C14)
...
Call SetTEFieldBY_ID ("A",DT_P_FIELDID_C15,DT_P_FIELDVALUE_C17,DT_P_DESCRIPTION_C15)

Call SetTEFieldBY_ID ("A",DT_P_FIELDID_C16,DT_P_FIELDVALUE_C18,DT_P_DESCRIPTION_C16)
Call SendTEScreenKey ("A",DT_P_SENDKEY_C10)

Call VerifyTEFieldByID("A", DT_P_FIELDID_C17, DT_P_FIELDVALUE_C19, DT_P_DESCRIPTION_C17)
Call CaptureScreenshot_Mainframe("A")

Call VerifyTEFieldByID("A", DT_P_FIELDID_C18, DT_P_FIELDVALUE_C20, DT_P_DESCRIPTION_C19)
Call CaptureScreenshot_Mainframe("A")
