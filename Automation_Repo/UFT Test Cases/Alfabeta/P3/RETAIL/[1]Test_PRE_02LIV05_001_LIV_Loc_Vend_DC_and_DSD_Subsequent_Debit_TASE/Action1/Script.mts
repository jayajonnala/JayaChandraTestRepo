...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_PRE_02LIV05_001_LIV_Loc_Vend_DC_and_DSD_Subsequent_Debit
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_PRE_02LIV05_001_LIV_Loc_Vend_DC_and_DSD_Subsequent_Debit"
...
Call PressEnter()
Call ClickButtonIfExist("Check   \(Ctrl\+Shift\+F3\)",True) 
...
'
call SetComboByKey("GODYNPRO-ACTION",DT_MIGO_DROPDOWN_ACTION_TYPE)
call SetComboByKey("GODYNPRO-REFDOC",DT_MIGO_DROPDOWN_DOC_TYPE)
...
Call VerifyStatusBar("Document no. "& DT_DOC_NO_OUTPUT & " created")
