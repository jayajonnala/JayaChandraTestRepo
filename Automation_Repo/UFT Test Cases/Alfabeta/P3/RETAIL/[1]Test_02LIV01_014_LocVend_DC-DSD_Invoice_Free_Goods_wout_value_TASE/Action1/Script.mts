...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_02LIV01_014_LocVend_DC-DSD_Invoice_Free_Goods_wout_value
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_02LIV01_014_LocVend_DC-DSD_Invoice_Free_Goods_wout_value"
...
Call SetTableData("SAPLMEGUITC_1211","Article","4","","",DT_ART_4TH,False)
...
Call SetTableData("SAPLMEGUITC_1211","PO Quantity","4","","",DT_QUANTITY_4,False)
...
Call SetTableData("SAPLMEGUITC_1211","Plnt","4","","",DT_SITE_4,False)
Call PressEnter()
...
Call SetTableData("SAPLMEGUITC_1211","Deliv. Date","4","","",ConvertDate(DT_DELIV_DATE_4),False) 
Call PressEnter()

Call SetTableData("SAPLMEGUITC_1211","Returns Item","1","","",DT_ME21N_1211_TABLECELL_RETURNS_ITEM_0,False) 
Call SetTableData("SAPLMEGUITC_1211","Returns Item","2","","",DT_ME21N_1211_TABLECELL_RETURNS_ITEM_0,False)
Call SetTableData("SAPLMEGUITC_1211","Returns Item","3","","",DT_ME21N_1211_TABLECELL_RETURNS_ITEM_0,False) 
Call SetTableData("SAPLMEGUITC_1211","Returns Item","4","","",DT_ME21N_1211_TABLECELL_RETURNS_ITEM_0,False)
Call PressEnter()
...
Call VerifyTableCellContent(2,"Amount","SAPLMR1MTC_MR1M",DT_ME21N_6310_CHECK_TEXT_OF_TABLECELL_AMOUNT_1)
Call VerifyTableCellContent(3,"Amount","SAPLMR1MTC_MR1M",DT_ME21N_6310_CHECK_TEXT_OF_TABLECELL_AMOUNT_2)
Call SetTableData("SAPLMR1MTC_MR1M","Amount","4","","",DT_4TH_ART_AMOUNT,False)
Call PressEnter()
