...
gstrTestCaseName = "Test_09.06.05.17.011 Other minor expenses_Movement Type FE11_Retail_C1E"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="S:\TASETestData\AB\RETAIL\DT_09.06.05.17.011 Other minor expenses_Movement Type FE11_Retail_C1E_TASE.xls"
...
Call GetGridContentByRefColumn("", 1, "Transaction Type", DT_POSDWMON1_1000_CHECK_GETCELLVALUE_OF_GRIDCELL_0_TRANSTYPECODE, "Transaction Number", "DT_REFERENCE_OUTPUT")
Call TakeScreenSHot()
...
'call ActivateItemGuiTree(1,"Inbound Monitor;"&"(\d\d)\.(\d\d)\.(\d\d)"&";G061;Financial Transactions","Financial Transactions")
'call ActivateItemGuiTree(1,"Inbound Monitor;"&ConvertDate(DT_POSDWMON1_0301_POSTING_DATE)&";G061;Financial Transactions","Financial Transactions")
'
'SAPGuiSession("Session_2").SAPGuiWindow("POS Workbench").Maximize
'SAPGuiSession("Session_2").SAPGuiWindow("POS Workbench").SAPGuiTree("TableTreeControl").ActivateItem "Inbound Monitor;01.01.2018","01.01.2018"
'SAPGuiSession("Session_2").SAPGuiWindow("POS Workbench").SAPGuiTree("TableTreeControl").ActivateItem "Inbound Monitor;01.01.2018;G061;Business transaction","Business transaction"
'SAPGuiSession("Session_2").SAPGuiWindow("POS Workbench").SAPGuiTree("TableTreeControl").ActivateItem "Inbound Monitor;02.01.2018;G061;Business transaction","Business transaction"
'SAPGuiSession("Session_2").SAPGuiWindow("POS Workbench").SAPGuiTree("TableTreeControl").ActivateItem "Inbound Monitor;03.01.2018;G061","G061"
'//------------------------------------------(       ......        UTILITY STATEMENTS    ......        )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
