...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_02LIV09_004_Credit_Note_DSD_for_Return_Cancellation
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_02LIV09_004_Credit_Note_DSD_for_Return_Cancellation"
...
Call GetStatusBar("item1","DT_MR8M_300_GET_IDOC_NUMBER_OUTPUT")
Call VerifyStatusBar("Document reversed with no. "& DT_MR8M_300_GET_IDOC_NUMBER_OUTPUT &": Please manually clear FI documents")
...
Call SetTextbox("for Value \.\.\.","VALUE1_1","",DT_MR8M_300_GET_IDOC_NUMBER_OUTPUT,False)
Call TakeScreenShot()
...
Call SetTextbox("Company Code","S_BUKRS","",DT_COMPANY_CODE,False)
...
Call VerifyifGuiLabelExists( "Document "& "PU" & RIGHT(DT_MIRO_120_GETTEXT_PU_NBR_OUTPUT,8) &" was posted in company code "& DT_COMPANY_CODE)
