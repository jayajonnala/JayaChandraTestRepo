...
gstrTestCaseName = "Test_09.06.05.12.06 Deposit EFG Bank_Movement Type F916_Retail_R1E_TASE"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''''gstrInputExcelFilePathAndName="S:\TASETestData\AB\RETAIL\DT_09.06.05.12.06 Deposit EFG Bank_Movement Type F916_Retail_R1E_TASE.xls"
...
Wait 5
Call  SelectColumnGuiGrid("", 0, DT_FBL5N_0841_SEARCH_TERM_OCC1, False)
call ClickButton("Set Filter   \(Ctrl\+Shift\+F2\)",fALSE)
Call TakeScreenSHot()
...
CAll VerifyTextBoxContent("Reference", "BKPF-XBLNR", "", DT_FAGLL03_1105_REFERENCE, False)
