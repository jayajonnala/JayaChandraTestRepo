...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_07.01.05.05.32 Goods Return of Meat Cutting Purchased Product AB DSD unique component
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_07.01.05.05.32 unique component_TASE"
...
Call SetTextboxNoLabel("MBLNR-LOW",0,FormatBlank(DT_MEK3_1000_MIGO_DOC),False)
Call TakeScreenShot()

Call ClickButton("Execute   \(F8\)",False) 
Call TakeScreenShot()
Call ClickButton("Detail List   \(Ctrl\+Shift\+F12\)",False) 
Call VerifyGridCellContent("",1,"ERFMG",0,Replace(DT_MEK3_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_ERFMG,",","."))
