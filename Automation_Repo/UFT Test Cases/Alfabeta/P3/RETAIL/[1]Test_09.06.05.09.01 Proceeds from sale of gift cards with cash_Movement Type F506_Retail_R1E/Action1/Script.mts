...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.06.05.09.01 Proceeds from sale of gift cards with cash_Movement Type F506_Retail_R1E
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_09.06.05.09.01_F506_Retail_R1E"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
''''gstrInputExcelFilePathAndName="S:\TASETestData\AB\RETAIL\DT_09.06.05.09.01 Proceeds from sale of gift cards with cash_Movement Type F506_Retail_R1E_TASE.xls"
...
call ClickButton("Change layout\.\.\.   \(Ctrl\+F8\)",fALSE)
call ClickButtonToolBar("&FIND",0)
Call SetTextBox("Search Term:","GS_SEARCH-VALUE",0,"Reference",True)
Call SelectCheckBox("GS_SEARCH-EXACT_WORD",0,"ON",True)
Call ClickButton("OK   \(Enter\)",True)
Call TakeScreenSHot()
Call ClickButton("Cancel   \(F12\)",True)
