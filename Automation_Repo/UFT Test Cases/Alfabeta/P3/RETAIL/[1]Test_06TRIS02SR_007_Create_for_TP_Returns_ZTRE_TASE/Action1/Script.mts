...
Call SelectRowGuiGrid("Variant Catalog for Program ZMDSO_TRIANGULAR_SO_FROM_GR.*","","Variant name",DT_ME21N_0600_GRIDCELL_3_VARIANT_NAME,True)
Call TakeScreenShot()
Call ClickButtonIfExist("Choose   \(F2\)",True) 

call SetComboByKey("P_ACTION",DT_ME21N_1000_ACTION)
Call SetTextbox("Article Document","P_MBLNR","",DT_ME21N_1000_ARTICLE_DOCUMENT,False)
Call SetTextbox("Article Doc\. Year","P_MJAHR","",Year(DT_ME21N_1000_ARTICLE_DOC_YEAR),False)
...
Call ClickButton("Execute   \(F8\)",False)
'Call GetGridContentByRefColumn("",0,"Purchasing Document",DT_ME21N_2000_GODYNPROPO_NUMBER,"SD Document","DT_ME21N_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_VBELN_OUTPUT")
