...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
gstrTestCaseName = "Test_02LIV03_003_LIV_DSD_Deliv_Note-Invoice_Store_AB_tied_empties"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="S:\TASETestData\AB\RETAIL\DT_02LIV03_003_LIV_DSD_Deliv_Note-Invoice_Store_AB_tied_empties_TASE.xls"
...
Call TakeScreenShot
Call GetTableCellData("ZMDIV_FENTRYTC_EMPTIES","Master Data QTY",1,"","","DT_ZMDIV_FENTRY_0202_QUANTITY_OCC2_OUTPUT",True)
Call ClickButton("Continue   \(Enter\)",true)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
Call SetTextbox("Quantity","GS_NEW_ITEM-MENGE","",DT_ZMDIV_FENTRY_0202_QUANTITY_OCC2,False)
Call TakeScreenShot
Call PressEnter()
Call PressEnter()
Call SetTextbox("UoM","GS_NEW_ITEM-MEINS","",DT_ZMDIV_FENTRY_0202_UOM_OCC2,False)
call FocusTextBox("UoM","GS_NEW_ITEM-MEINS",false)
Call TakeScreenShot
Call PressEnter()
Call TakeScreenShot

Call GetTableCellData("ZMDIV_FENTRYTC_0400","Purchase Value",1,"","","DT_ZMDIV_FENTRY_0400_TABLECELL_NET_INVOICE_VALUE_0",False)
Call SetTableData("ZMDIV_FENTRYTC_0400","Net Invoice Value",1,"","",DT_ZMDIV_FENTRY_0400_TABLECELL_NET_INVOICE_VALUE_0,False)
Call TakeScreenShot

Call GetTableCellData("ZMDIV_FENTRYTC_0400","Purchase Value",2,"","","DT_ZMDIV_FENTRY_0400_TABLECELL_NET_INVOICE_VALUE_1",False)
Call SetTableData("ZMDIV_FENTRYTC_0400","Net Invoice Value",2,"","",DT_ZMDIV_FENTRY_0400_TABLECELL_NET_INVOICE_VALUE_1,False)
Call TakeScreenShot
Call PressEnter()

Call GetTextboxValue("GS_HEADER-WDIFF","","DT_ZMDIV_FENTRY_0201_AMOUNT_DIFF_OUTPUT",False)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
...
Call GetTableCellData("ZMDIV_FENTRYTC_TAX","Tax Amount",1,"","","DT_ZMDIV_FENTRY_0201_TAX_AMOUNT",True)
Call ClickButton("Continue   \(F5\)",True)


Call SetTextbox("Tax Amount","GS_HEADER-WMWST","",DT_ZMDIV_FENTRY_0201_TAX_AMOUNT,False)
Call TakeScreenShot
Call PressEnter()
Call TakeScreenShot

Call VerifyTextBoxContentIconName("GV_TAX_ICON","",DT_ZMDIV_FENTRY_0201_CHECK_ICONNAME_OF_TAX_AMOUNT,False)
Call VerifyTextBoxContentIconName("GV_EMPT_ICON","",DT_ZMDIV_FENTRY_0201_CHECK_ICONNAME_OF_TAX_AMOUNT_OCC2,False)
