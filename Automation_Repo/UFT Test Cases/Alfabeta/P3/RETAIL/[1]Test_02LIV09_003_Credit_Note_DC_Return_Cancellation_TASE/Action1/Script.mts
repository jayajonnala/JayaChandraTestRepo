...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_02LIV09_003_Credit_Note_DC_Return_Cancellation
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_02LIV09_003_Credit_Note_DC_Return_Cancellation"
...
Call SelectRowGuiGrid("Variant Catalog for Program RSEIDOC9.*","","Variant name",DT_MR8M_600_GRIDCELL_5_VARIANT_NAME_OCC2,True)
Call ClickButtonIfExist("Choose   \(F2\)",True) 
Call SetTextbox("for Value \.\.\.","VALUE1_1","",DT_DOCUMENT_REVERSED_NUMBER_OUTPUT,False)
Call TakeScreenShot()
Call ClickButton("Execute   \(F8\)",False) 
Call VerifyStatusBarMessageType(DT_EXPECTEDVALUE)
Call VerifyifGuiLabelExists(DT_MR8M_120_CHECK_TEXT_OF_DATA_PASSED_TO_PORT_OK)
'Call GetLabelContentByRefLabel(Right(DT_MR8M_600_GRIDCELL_5_VARIANT_NAME_OCC2,Len(DT_MR8M_600_GRIDCELL_5_VARIANT_NAME_OCC2)-1),994,0,"DT_IDOC_OUTPUT",False)
Call GetLabelContentByRefLabel(Right(DT_MR8M_600_GRIDCELL_5_VARIANT_NAME_OCC2,Len(DT_MR8M_600_GRIDCELL_5_VARIANT_NAME_OCC2)-1),1136,0,"DT_IDOC_OUTPUT",False)
