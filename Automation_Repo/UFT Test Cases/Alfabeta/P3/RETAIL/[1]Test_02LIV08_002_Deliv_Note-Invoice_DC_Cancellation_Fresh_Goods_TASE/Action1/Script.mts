...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_02LIV08_002_Deliv_Note-Invoice_DC_Cancellation_Fresh_Goods
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_02LIV08_002_Deliv_Note-Invoice_DC_Cancellation_Fresh_Goods"
...
'Call GetGridContentByTitle("Documents in Accounting",0,"Document Number",1,"DT_ACC_DOC_NUM_OUTPUT")
Call GetGridContentByTitle("Documents in Accounting",0,"Doc. Number",1,"DT_ACC_DOC_NUM_OUTPUT")
...
Call SetTextbox("Document","S_BELNR-LOW","",DT_ACC_DOC_NUM_OUTPUT,False)
Call SelectCheckbox("S_TEST",0,DT_MR8M_1000_TEST_MODE,False)
Call  ClickButton("Execute   \(F8\)",False)
Call VerifyStatusBarMessageType(DT_EXPECTEDVALUE_OCC2)

Call GetStatusBar("item1","DT_PU_OUTPUT")
Call VerifyStatusBar("Document "&DT_PU_OUTPUT&" was posted in company code GR02")
...
Call SetTcode(DT_MR8M_120_OKCD_OCC2)  
Call PressEnter()   
