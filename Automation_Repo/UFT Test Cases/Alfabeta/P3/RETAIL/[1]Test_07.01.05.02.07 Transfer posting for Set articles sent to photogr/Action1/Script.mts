...
gstrTestCaseName = "Test_07.01.05.02.07 Transfer posting for Set articles sent to photogr"
...
'Call SetTableData("SAPLMIGOTV_GOITEM","SLoc",1,"","",DT_MIGO_0390_STOR_LOC,false)
'Call SetTableData("SAPLMIGOTV_GOITEM","Site",1,"","",DT_MIGO_0390_SITE,false)
'Call SetTableData("SAPLMIGOTV_GOITEM","Art. Short Text",1,"","",DT_MIGO_0390_ARTICLE,false)
'Call SetTableData("SAPLMIGOTV_GOITEM","Qty in UnE",1,"","",DT_MIGO_0390_QTY_IN_UNE,false)
'Call SetTableData("SAPLMIGOTV_GOITEM","SLoc Transfer Pstg",1,"","",DT_MIGO_0390_STOR_LOC,false)
'Call PressEnter()
'
'
'
...
'Call SetTextbox("Article Slip","GOHEAD-MTSNR","",DT_ARTICLE_SLIP,False) 
''Call SetTextbox("Stor\. Loc\.","GODYNPRO-LGOBE","",DT_MIGO_0390_STOR_LOC,False)    '''field not exist
''''
...
'call SetTableData("SAPLMIGOTV_GOITEM","Site",1,"","",DT_MIGO_0390_SITE,false)
''call SetTableData("SAPLMIGOTV_GOITEM","Site",2,"","",DT_MIGO_0200_TABLECELL_SITE_1,false)
'call SetTableData("SAPLMIGOTV_GOITEM","SLoc Transfer Pstg",1,"","",DT_MIGO_0390_STOR_LOC,false)
'call SetTableData("SAPLMIGOTV_GOITEM","SLoc",1,"","",DT_MIGO_0390_STOR_LOC,false)
''call SetTableData("SAPLMIGOTV_GOITEM","SLoc Transfer Pstg",2,"","","SCM-EWM",false)
''DT_MIGO_0200_TABLECELL_SLOC_TRANSFER_PSTG_0
''Call PressEnter()
''call SetTableData("SAPLMIGOTV_GOITEM","Site Trfr Pstg",1,"","","ΨΥΧΙΚΟ",false)
''call SetTableData("SAPLMIGOTV_GOITEM","Site Trfr Pstg",2,"","","ΨΥΧΙΚΟ",false)
''DT_MIGO_0200_TABLECELL_SITE_TRFR_PSTG_0
'Call PressEnter()
'
''''''
''Call SetTextbox("SLoc Transfer Pstg","GOITEM-UMLGOBE","",DT_MIGO_0390_STOR_LOC,False) 
''Call SetTextbox("Site","GODYNPRO-NAME1","",DT_MIGO_0390_SITE,False) 
...
'call GetStatusBar("item1","DT_Article docnum")
'
'
'Call LogOff()
'Call FinalStatus ()
