...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_02LIV11_001
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_02LIV11_001"
...
Call SetTableData("SAPLMEGUITC_1211","Returns Item","1","","","OFF",False) 
Call SetTableData("SAPLMEGUITC_1211","Returns Item","2","","","OFF",False)
Call SetTableData("SAPLMEGUITC_1211","Returns Item","3","","","OFF",False)
Call PressEnter()
...
Call SetComboByKey("RM08M-VORGANG",DT_ME21N_6000_TRANSACTION_OCC1)
...
Call ClickButton("Post   \(Ctrl\+S\)",False)
Call ClickButtonIfExist("Save",True) 
Call GetStatusBar("item1","DT_DOC_NUM_OUTPUT1")
Call VerifyStatusBar("Document no. "& DT_DOC_NUM_OUTPUT1 & " created")
'
'--------------------------------------  Subsequent other traction in MIRO ------

Call SetComboByKey("RM08M-VORGANG",DT_ME21N_6000_TRANSACTION_OCC2)
...
Call GetStatusBar("item1","DT_DOC_NUM_OUTPUT2")
Call VerifyStatusBar("Document no. "& DT_DOC_NUM_OUTPUT2 & " created")
