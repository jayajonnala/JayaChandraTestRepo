...
gstrTestCaseName = "Test_09.06.05.17.010 Other expenses_Movement Type FE10_Retail_R1E"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="S:\TASETestData\AB\RETAIL\DT_09.06.05.17.010 Other expenses_Movement Type FE10_Retail_R1E_TASE.xls"
...
Call SetTextbox("Posting Date","SO_BUDAT-LOW","",Replace(DT_FAGLL03_1000_POSTING_DATE,"/","."),False)
Call TakeScreenSHot()
...
Call SetTextBox("Search Term:","GS_SEARCH-VALUE",0,DT_REFERNCE,True)
...
CAll SelectColumnGuiGrid("", 1, DT_REFERNCE, False)
call ClickButton("Set Filter   \(Ctrl\+Shift\+F2\)",fALSE)
Call TakeScreenSHot()
Call SetTextboxNoName(DT_REFERNCE,"",DT_FAGLL03_1105_REFERENCE,False)
Call TakeScreenSHot()
call ClickButton("Execute   \(Enter\)",fALSE)
