...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'................Test_06DCIM03_012_Pallet_File_Quantity_Surplus_in_status_36_P02
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_06DCIM03_012_Surplus_36_P02_TASE"
...
Call  Get_TEFieldValue_byID("A", DT_P_FIELDID_C9, "DT_PIECES_OUTPUT", DT_P_DESCRIPTION_C8)
Call SetTEField("A", DT_P_FIELDNAME_C4, DT_P_FIELDVALUE_C13)
Call SendTEScreenKey ("A",DT_P_SENDKEY_C7)

Call SetTEFieldBY_ID ("A",DT_P_FIELDID_C10,DT_P_FIELDVALUE_C14,DT_P_DESCRIPTION_C10)
Call SendTEScreenKey ("A",DT_P_SENDKEY_C8)

Call SetTEFieldBY_ID ("A",DT_P_FIELDID_C11,DT_P_FIELDVALUE_C15,DT_P_DESCRIPTION_C11)
Call SendTEScreenKey ("A",DT_P_SENDKEY_C9)

Call  Get_TEFieldValue_byID("A", DT_P_FIELDID_C12, "DT_PIECES_BEFORE_OUTPUT", DT_P_DESCRIPTION_C12)
Call CaptureScreenshot_Mainframe("A")
...
Call SetTEFieldBY_ID ("A",DT_P_COLUMN_C1,DT_P_VALUE_C1,"")
Call SendTEScreenKey ("A",DT_P_KEY_C3)

Call SetTEFieldBY_ID ("A",DT_P_FIELDID_C13,DT_P_FIELDVALUE_C16,DT_P_DESCRIPTION_C13)

Call SetTEFieldBY_ID ("A",DT_P_FIELDID_C14,DT_P_FIELDVALUE_C17,DT_P_DESCRIPTION_C14)
Call SendTEScreenKey ("A",DT_P_SENDKEY_C10)

Call SetTEFieldBY_ID ("A",DT_P_FIELDID_C15,DT_P_FIELDVALUE_C18,DT_P_DESCRIPTION_C15)
Call CaptureScreenshot_Mainframe("A")
Call VerifyTEFieldByID("A", DT_P_FIELDID_C16, DT_P_FIELDVALUE_C19, DT_P_DESCRIPTION_C17)
