...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_02LIV10_001
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_02LIV10_001"
...
wait 2
Call GetStatusBar("item2","DT_DELIVERY_NUM_OUTPUT")
VerifyStatusBar("Direct Delivery created under the number " & DT_DELIVERY_NUM_OUTPUT )
...
Call PressEnter()
Call SetComboByKey("RM08M-REFERENZBELEGTYP","2") '------ Selecting Delivery Note 
...
Call VerifyStatusBar("Document no. "& DT_DOC_OUTPUT & " created")
'
...
Call VerifyStatusBar("Document no. "& DT_DOC_2_OUTPUT & " created")
