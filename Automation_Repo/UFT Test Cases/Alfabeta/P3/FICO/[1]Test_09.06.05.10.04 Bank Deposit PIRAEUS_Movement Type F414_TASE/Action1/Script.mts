...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.06.05.10.04 Bank Deposit PIRAEUS_Movement Type F414
...
gstrTestCaseName = "Test_09.06.05.10.04 Bank Deposit PIRAEUS_Movement Type F414_TASE"
...
DT_FAGLL03_1000_POSTING_DATE= "01.01."& CSTR(Year(Date)-7)
...
Call SetTextBox("Profit Center","%%DYN001-LOW","",DT_FAGLL03_3010_TABLECELL_SINGLE_VALUE_0,False)
...
Call VerifyGridCellContent("", 1, "Assignment", 0, DT_CHECK_ASSIGN)
