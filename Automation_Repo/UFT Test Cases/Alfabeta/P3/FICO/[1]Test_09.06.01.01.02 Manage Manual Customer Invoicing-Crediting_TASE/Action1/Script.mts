...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.06.01.01.02 Manage Manual Customer Invoicing-Crediting
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_09.06.01.01.02 Manage Manual Customer Invoicing-Crediting"
...
Call SetComboByKey("RF05A-BUSCS",DT_FB70_1200_TRANSACTN)
Call TakeScreenShot
...
Call SetTableData("SAPLFSKBTABLE", "G/L acct", "2", "", "", DT_FB70_0100_TABLECELL_GL_ACCT_1, False)
Call SetTableData("SAPLFSKBTABLE", "Amount in doc.curr.", "2", "", "", DT_FB70_0100_TABLECELL_AMOUNT_IN_DOCCURR_1, False)
Call SetTableData("SAPLFSKBTABLE", "Cost center", "2", "", "", DT_FB70_0100_TABLECELL_COST_CENTER_1, False)
Call SetTableData("SAPLFSKBTABLE", "Tax code", "2", "", "", DT_FB70_0100_TABLECELL_TAX_CODE_1, False)
Call SetTableData("SAPLFSKBTABLE", "Business area", "2", "", "", DT_FB70_0100_TABLECELL_BUSINESS_AREA_1, False)
...
Call GetTextboxValue("RF05A-AZSAL","", "DT_FB70_1200_CHECK_TEXT_OF_BAL_OUTPUT", False)
...
Call TakeScreenShot
Call SetTextbox("Language","SVALD-VALUE","",DT_FB70_0300_LANGUAGE,True)
Call TakeScreenShot
Call ClickButton("Continue   \(Enter\)",True)
Call TakeScreenShot
Call GetspecialTextboxValue("EENO_DYNP-BZCHNG","0", "DT_FB70_1001_CHECK_TEXT_OF_MEANING_OUTPUT", False)
Call WriteRunTimeDataToExcelGlobalSheet("DT_FB70_1001_CHECK_TEXT_OF_MEANING_OUTPUT",DT_FB70_1001_CHECK_TEXT_OF_MEANING)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",GetRowNo)
Call SetSpecialTextbox("1st line","EENO_DYNP-ZEILE", "0",DT_FB70_1001_CHECK_TEXT_OF_MEANING, True)
Call ClickButton("Copy text   \(F5\)",True)
Call TakeScreenShot

Call ClickCellTableByRowNo("SAPLFSKBTABLE","Long Txt", "2", False)
Call TakeScreenShot
Call ClickButton("Other languages",True)
Call TakeScreenShot
Call SetTextbox("Language","SVALD-VALUE","",DT_FB70_0300_LANGUAGE_OCC1,True)
Call TakeScreenShot
Call ClickButton("Continue   \(Enter\)",True)
Call TakeScreenShot
Call GetspecialTextboxValue("EENO_DYNP-BZCHNG","0", "DT_FB70_1001_CHECK_TEXT_OF_MEANING_OCC1_OUTPUT", False)
Call WriteRunTimeDataToExcelGlobalSheet("DT_FB70_1001_CHECK_TEXT_OF_MEANING_OCC1_OUTPUT",DT_FB70_1001_CHECK_TEXT_OF_MEANING_OCC1)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",GetRowNo)
Call SetSpecialTextbox("1st line","EENO_DYNP-ZEILE", "0",DT_FB70_1001_1ST_LINE_OCC1, True)
Call ClickButton("Copy text   \(F5\)",True)
Call TakeScreenShot
...
Call ClickButtonToolBar("&FIND",0)
Call TakeScreenShot
Call SetTextbox("Search Term:","GS_SEARCH-VALUE","",DT_FB70_0841_SEARCH_TERM_OCC4,True)
Call SetComboByKey("Search Direction",DT_FB70_0841_SEARCH_DIRCT)
Call TakeScreenShot
Call PressEnter
Call ClickButtonIfExist("Cancel   \(F12\)",True)
...
Call VerifyGridCellContent("", 1, "Cost Center", 0, "")
Call VerifyGridCellContent("", 2, "Cost Center", 0, DT_FB70_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_KOSTL)
Call VerifyGridCellContent("", 3, "Cost Center", 0, DT_FB70_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_KOSTL)
Call VerifyGridCellContent("", 4, "Cost Center", 0, "")
Call VerifyGridCellContent("", 1, "PRCTR", 0, DT_FB70_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_PRCTR)
Call VerifyGridCellContent("", 2, "PRCTR", 0, DT_FB70_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_PRCTR)
Call VerifyGridCellContent("", 3, "PRCTR", 0, DT_FB70_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_PRCTR)
Call VerifyGridCellContent("", 4, "PRCTR", 0, DT_FB70_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_3_PRCTR)
...
Call SetTextbox("Document date","RBLDAT-LOW","",ConvertDate(DT_FB70_1000_DOCUMENT_DATE),False)
...
Call SetTcode(DT_FB70_0120_OKCD)     
Call PressEnter()     
Call TakeScreenShot

DT_DOC_TITLE_IP = DT_FB70_1000_DOCUMENT_NUMBER&"/"&DT_FB70_1000_FISCAL_YEAR
