...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.05.01.05.07 Cheques Receivables received in HQ - Reversal of
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_09.05.01.05.07 Cheques Receivables received in HQ - Reversal of"
...
Call TakeScreenShot
Call VerifyifGuiLabelExistsByRelativeid(DT_FTR04_0120_CHECK_TEXT_OF_NO_NAME,"wnd\[0\]/usr/lbl\[71,8\]")
...
Call VerifyGridCellContent("", 2, "Currency", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_RF05A_UBAZW)

Call VerifyGridCellContent("", 1, "Amount", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_AZBET)
Call VerifyGridCellContent("", 2, "Amount", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_AZBET)
...
Call ClickButton("Execute   \(F8\)",False)
Call TakeScreenShot
Call VerifyifGuiLabelExistsByRelativeid(DT_FTR04_0120_CHECK_TEXT_OF_NO_NAME_OCC1,"wnd\[0\]/usr/lbl\[71,8\]")
...
Call VerifyGridCellContent("", 1, "BSCHL", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BSCHL_OCC1)
Call VerifyGridCellContent("", 2, "BSCHL", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_BSCHL_OCC1)

Call VerifyGridCellContent("", 1, "KTONR", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_KTONR_OCC1)
Call VerifyGridCellContent("", 2, "KTONR", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_KTONR_OCC1)
...
Call VerifyGridCellContent("", 1, "Currency", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_RF05A_UBAZW_OCC1)
Call VerifyGridCellContent("", 2, "Currency", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_RF05A_UBAZW_OCC1)

Call VerifyGridCellContent("", 1, "Amount", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_AZBET_OCC1)
Call VerifyGridCellContent("", 2, "Amount", 0, DT_FTR04_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_AZBET_OCC1)
...
Call GetTextboxValue("BKPF-BELNR",0,"DT_FTR04_0750_CHECK_TEXT_OF_DOCUMENT_NUMBER_OCC1_OUTPUTT",False)
Call WriteRunTimeDataToExcelGlobalSheet("DT_FTR04_0750_CHECK_TEXT_OF_DOCUMENT_NUMBER_OCC1_OUTPUTT",DT_FTR04_0750_CHECK_TEXT_OF_DOCUMENT_NUMBER_OCC1)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",GetRowNo)
