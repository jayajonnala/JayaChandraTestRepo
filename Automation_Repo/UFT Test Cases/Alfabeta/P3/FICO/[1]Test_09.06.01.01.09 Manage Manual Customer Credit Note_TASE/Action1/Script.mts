...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.06.01.01.09 Manage Manual Customer Credit Note
...
gstrTestCaseName = "Test_09.06.01.01.09 Manage Manual Customer Credit Note"
...
Call TakeScreenShot
Call SetComboByKey("INVFO-MWSKZ", DT_FB75_0510_INVFOMWSKZ)
Call TakeScreenShot
...
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",GetRowNo)
Call SetSpecialTextbox("1st line","EENO_DYNP-ZEILE","",DT_FB75_1001_1ST_LINE,True)
...
Call GetTextboxValue("RF05A-AZSAL","","DT_FB75_1200_CHECK_TEXT_OF_BAL_OUTPUT", False)
'Call WriteRunTimeDataToExcelGlobalSheet("DT_FB75_1200_CHECK_TEXT_OF_BAL_OUTPUT",DT_FB75_1200_CHECK_TEXT_OF_BAL)
'Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",GetRowNo)
'Wait(5)

Call SetTextbox("Amount","INVFO-WRBTR","",DT_FB75_1200_CHECK_TEXT_OF_BAL_OUTPUT,False)
Call PressEnter()
Call TakeScreenShot
...
Call VerifyGridCellContent("", 1, "HWAER", 0, DT_FB75_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_HWAER)
...
Call VerifyTextBoxContent("Information Message","MESSTXT1", "0",Lcase(DT_FB75_0010_CHECK_TEXT_OF_MESSTXT1), True)
Call ClickButtonIfExist("Continue   \(Enter\)",True)
