...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.04.01.01.09 Manage Manual Indirect Vendor Intercompany Domest
...
gstrTestCaseName = "Test_09.04.01.01.09 Manage Manual Indirect Vendor Intercompany Domest"
...
Call TakeScreenShot
Call SelectCheckbox("RTAX1U10-XMWST","0","ON",False)
Call TakeScreenShot
Call SelectCheckbox("RTAX1U10-XMWST","0","OFF",False)
Call TakeScreenShot


Call GetTableCellData("SAPLTAX1STEUER_CTRL", "Tax doc.currency", "1", "", "", "DT_FB60_0120_CHECK_TEXT_OF_NO_NAME_OUTPUT", False)
Call WriteRunTimeDataToExcelGlobalSheet ("DT_FB60_0120_CHECK_TEXT_OF_NO_NAME_OUTPUT",DT_FB60_0120_CHECK_TEXT_OF_NO_NAME)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",GetRowNo)

Call SelectTab("TS","Withholding tax",False)
Call TakeScreenShot
'Call VerifyTableCellContent(1, "Name of w/hld.tx typ", "SAPLFWTDWT_DIALOG", DT_FB60_0120_CHECK_TEXT_OF_TABLECELL_NAME_OF_WHLDTX_TYP_0)
Call TakeScreenShot
