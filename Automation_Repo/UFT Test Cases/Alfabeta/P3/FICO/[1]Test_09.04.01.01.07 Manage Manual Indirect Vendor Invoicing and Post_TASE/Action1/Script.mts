...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.04.01.01.07 Manage Manual Indirect Vendor Invoicing and Post
...
gstrTestCaseName = "Test_09.04.01.01.07 Manage Manual Indirect Vendor Invoicing and Post"
...
Call TakeScreenShot
Call GetTextboxValue("RF05A-AZSAL", ""," DT_TAX_OUTPUT", False)
...
Call SetTableData("SAPLTAX1STEUER_CTRL", "Tax doc.currency", 1, "", "", DT_TAX_OUTPUT, False)

Call WriteRunTimeDataToExcelGlobalSheet ("DT_TAX_OUTPUT",DT_TAX)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",GetRowNo)

Call SelectTab("TS","Withholding tax",False)
Call TakeScreenShot
Call VerifyTextBoxContent("Bal\.", "RF05A-AZSAL", "", DT_FB60_1100_CHECK_TEXT_OF_BAL, False)
Call SetTableData("SAPLFWTDWT_DIALOG", "W/tax code", "1", "", "", DT_FB60_0120_TABLECELL_WTAX_CODE_0, False)
