...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.07.01.02.11 Store Cash Management_Western Union manual_V3
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_09.07.01.02.11 Store Cash Management_Western Union manual_V3"
...
DT_ZFIGL_UPLOAD_POST_1000_FILE_PATH_NAME_IP = Left(DT_ZFIGL_UPLOAD_POST_1000_FILE_PATH_NAME,64)&"ΤΠΥ.xlsx"
Call WriteRunTimeDataToExcelGlobalSheet ("DT_INCREMENT",Cint(DT_INCREMENT)+1)

Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",GetRowNo)
Call SetSpecialTextbox("File path name","P_FILE", "",DT_ZFIGL_UPLOAD_POST_1000_FILE_PATH_NAME_IP, False)
Call PressEnter()
Call TakeScreenShot
...
Call SelectCheckbox("RB-LOG_DETAIL", "0", DT_ZFIGL_UPLOAD_POST_1010_SAPMSBDC_CCTC_APQI_OCC1, False)
Call TakeScreenShot
...
'Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL", "Message","2", "", "", "DT_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_2_OUTPUT", False)
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL", "Message",DT_RowNo, "No.", "312", "DT_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_2_OUTPUT", False)

Call WriteRunTimeDataToExcelGlobalSheet("DT_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_2_OUTPUT",DT_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_2)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",GetRowNo)
Call VerifyTableCellContent(DT_RowNo, "Message", "RSBDC_ANALYSETC_PROTOCOL", Lcase(DT_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_2_OCC1))
...
Call ClickButtonToolBar("&FIND",0)
Call TakeScreenShot
Call SetTextbox("Search Term:","GS_SEARCH-VALUE","",DT_ZFIGL_UPLOAD_POST_0500_SEARCH_TERM_OCC1,True)
Call SetComboByKey("Search Direction",DT_ZFIGL_UPLOAD_POST_0500_SEARCH_DIRCT)
Call TakeScreenShot
Call PressEnter
Call ClickButtonIfExist("Cancel   \(F12\)",True)
...
Call VerifyGridCellContent("", 1, "BUDAT", 0, ConvertDate(DT_ZFIGL_UPLOAD_POST_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BUDAT))
