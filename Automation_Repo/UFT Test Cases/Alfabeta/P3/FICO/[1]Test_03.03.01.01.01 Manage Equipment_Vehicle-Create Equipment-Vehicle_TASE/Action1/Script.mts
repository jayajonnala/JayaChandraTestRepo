...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_03.03.01.01.01 Manage Equipment_Vehicle-Create Equipment-Vehicle
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_03.03.01.01.01 Manage Equipment_Vehicle-Create Equipment-Vehicle"
...
Call GetTextboxValue("ITOB-SHTXT",0,DT_IE01_1525_DESCRIPTION_OUTPUT,False)
Call WriteRunTimeDataToExcelGlobalSheet ("DT_IE01_1525_DESCRIPTION_OUTPUT",DT_IE01_DESCRIPTION_OCC1)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
wait(2)
...
Call SetTextbox("Functional loc\.","IEQINSTALL-TPLNR","",DT_IE01_0100_FUNCTIONAL_LOC,True)
Call TakeScreenShot()
...
'Get TechIdentNo No
Call GetTextboxValue("ITOB-TIDNR",0,"DT_TECHINDENT_NO_OUTPUT",False)
...
Call GetStatusBar("item1","DT_IE01_EQUIPMENT_OUTPUT")
Call VerifyStatusBar("Equipment created with the number "&DT_IE01_EQUIPMENT_OUTPUT)
