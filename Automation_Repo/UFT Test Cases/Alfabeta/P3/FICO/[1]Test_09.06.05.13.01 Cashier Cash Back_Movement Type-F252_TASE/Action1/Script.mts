...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.06.05.13.01 Cashier Cash Back_Movement Type-F252
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_09.06.05.13.01 Cashier Cash Back_Movement Type-F252_TASE"
...
DT_FBL5N_1000_POSTINGDATE= "01.01."& CSTR(Year(Date)-7)
Call SetTextbox("Posting date","SO_BUDAT-LOW","",ConvertDate(DT_FBL5N_1000_POSTINGDATE),False)
Call SetTextbox("to","SO_BUDAT-HIGH","",ConvertDate(DT_FBL5N_1000_TO),False)
Call TakeScreenShot
...
Call TakeScreenShot
Call SetTextbox("Search Term:","GS_SEARCH-VALUE","",DT_FBL5N_0750_SEARCH_TERM,True)
Call SetComboByKey("Search Direction",DT_FBL5N_0750_SEARCH_DIRCT)
Call TakeScreenShot
Call PressEnter
...
Call VerifyGridCellContent("", 1, "HKONT", 0, DT_FBL5N_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_HKONT)
...
Call VerifyGridCellContent("", 2, "HKONT", 0, DT_FBL5N_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_HKONT)
