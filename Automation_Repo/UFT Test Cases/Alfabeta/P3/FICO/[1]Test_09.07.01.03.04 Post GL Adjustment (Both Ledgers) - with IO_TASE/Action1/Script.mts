...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.07.01.03.04 Post GL Adjustment (Both Ledgers) - with IO
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_09.07.01.03.04 Post GL Adjustment (Both Ledgers) - with IO"
...
Call VerifyGridCellContent("", 1, "AUFNR", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_AUFNR)
Call VerifyGridCellContent("", 2, "AUFNR", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_1_AUFNR)

Call VerifyGridCellContent("", 1, "SGTXT", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_SGTXT)
Call VerifyGridCellContent("", 2, "SGTXT", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_1_SGTXT)

Call VerifyGridCellContent("", 1, "DMSHB", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_DMSHB)
Call VerifyGridCellContent("", 2, "DMSHB", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_1_DMSHB)

Call VerifyGridCellContent("", 1, "BELNR", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BELNR)
Call VerifyGridCellContent("", 2, "BELNR", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_1_BELNR)

Call VerifyGridCellContent("", 1, "GSBER", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_GSBER)
Call VerifyGridCellContent("", 2, "GSBER", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_1_GSBER)


Call VerifyGridCellContent("", 1, "BLDAT", 0, ConvertDate(DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BLDAT))
Call VerifyGridCellContent("", 2, "BLDAT", 0, ConvertDate(DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_1_BLDAT))

Call VerifyGridCellContent("", 1, "BSCHL", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BSCHL)
Call VerifyGridCellContent("", 2, "BSCHL", 0, DT_F02_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_1_BSCHL)
