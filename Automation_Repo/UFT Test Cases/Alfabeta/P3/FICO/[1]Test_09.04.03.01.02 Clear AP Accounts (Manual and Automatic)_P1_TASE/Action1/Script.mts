...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.04.03.01.02 Clear AP Accounts (Manual and Automatic)_P1
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_09.04.03.01.02 Clear AP Accounts (Manual and Automatic)_P1"
...
Call VerifyTableCellContent("1", "Business area", "SAPLFSKBTABLE", DT_FB60_0100_CHECK_TEXT_OF_TABLECELL_BUSINESS_AREA_0)
Call VerifyTableCellContent("1", "Cost center", "SAPLFSKBTABLE", DT_FB60_0100_CHECK_TEXT_OF_TABLECELL_COST_CENTER_0)
Call TakeScreenShot

Call SelectTab("TS","Details",False)
Call TakeScreenShot
Call VerifyTextBoxContent("G/L", "INVFO-HKONT", "", DT_FB60_0050_CHECK_TEXT_OF_GL, False)
Call TakeScreenShot
