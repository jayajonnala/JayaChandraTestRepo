...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_09.06.05.10.06 Bank Deficit _Movement Type F405
...
gstrTestCaseName = "Test_09.06.05.10.06 Bank Deficit _Movement Type F405"
...
'Written this step as the data is not available for the recent years
...
Call ClickButton("Set Filter   \(Ctrl\+Shift\+F2\)",False)
Call SetTextbox("Text","%%DYN002-LOW","",DT_FAGLL03_1105_TEXT,True)
Call ClickButton("Execute   \(Enter\)",True)
Call TakeScreenshot
