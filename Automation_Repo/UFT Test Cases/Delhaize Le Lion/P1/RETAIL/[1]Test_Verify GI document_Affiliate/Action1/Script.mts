...
gstrTestCaseName = "Test_Verify GI document_Affiliate"
...
'Added belowline to select Display Article document
Call SetCombo("GODYNPRO-ACTION", DT_MIGO_2010_GODYNPROMAT_COMBO)
Call TakeScreenshot
...
call VerifyTextBoxContent("Article","GOITEM-MAKTX","",Lcase(DT_MIGO_0390_CHECK_TEXT_OF_ARTICLE),false)      ''index9
call VerifyTextBoxContent("Article","GOITEM-MATNR","",DT_MIGO_0390_CHECK_TEXT_OF_GODYNPROMATNR,false)  ''index8
Call ClickButtonIfExist("Open detail data",False)
