...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :04-02-Article MD- Fresh article BE creation via Matcopy_P5_GOLD
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "04-02-Article MD- Fresh article BE creation via Matcopy_P5_GOLD"
...
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID,DT_P_FIELD_ID_SELECT_ENVIORINMENT,"")
Call SendTEScreenKey ("A",DT_P_SEND_KEY)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C1,DT_P_FIELD_ID_ENVIORINMENT_775_C1,"")
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C1)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C2,DT_P_FIELD_ID_ACTIVATE_ENVIORINMENT_C2,"")
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C2)
Call SendTEScreenKey ("A",DT_P_KEY_C2)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C3,DT_P_FIELD_ID_ACTIVATE_ENVIORINMENT_C3,"")
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C3)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C4,DT_P_FIELD_ID_MENU_INITIALISE_C4,"")
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C4)
Call CaptureScreenshot_Mainframe("A")
Call SetTEField("A",DT_P_FIELD_NAME,DT_P_FIELD_ID_SELECT_COMMAND_LINE_OPTION_C5)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C5)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C5,DT_P_FIELD_ID_START_STR_SQL_C6,DT_DESC)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C6)
Call CaptureScreenshot_Mainframe("A")
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C6,DT_P_FIELD_ID_SQL_ENTRY_C7,DT_DESC_C1)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C7)
Call CaptureScreenshot_Mainframe("A")
Call VerifyTEFieldByID ("A",DT_P_FIELD_ID_C7,DT_P_FIELD_ID_VERIFY_ARTICLE_TEXT_C8,DT_DESC_C2)
Call SendTEScreenKey ("A",DT_P_KEY_C3)
Call SendTEScreenKey ("A",DT_P_KEY_C4)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C8,DT_P_FIELD_ID_EXIT_INTERACTIVE_SQL_C9,DT_DESC_C3)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C8)
Call SendTEScreenKey ("A",DT_P_KEY_C5)
Call SendTEScreenKey ("A",DT_P_KEY_C6)
Call SetTEField("A",DT_P_FIELD_NAME_C1,DT_P_FIELD_ID_FINISH_SESSION_C10)
