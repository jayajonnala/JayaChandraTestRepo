'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04-01-01-01-01-01-Manual Promo PO creation for Vendor_1VSR_Scope
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04-01-01-01-01-01-Manual Promo PO creation for Vendor_1VSR_Scope"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="S:\TASETestData\DLL\RETAIL\DT_04-01-01-01-01-01-Manual Promo PO creation for Vendor_1VSR_Scope_TASE.xls"
...
Call PressEnter()
Call TakeScreenShot
'''''Added 59,80,81 lines by KGARA on 26/7/22'''''
...
If DT_ME21N_1322_PROMOTION<> "" Then
Call SetTextbox("Promotion","MEPO1322-AKTNR","",DT_ME21N_1322_PROMOTION,False) 
	
End If
'
Call SelectMenuBar("Purchase Order;Save")
Call ClickButtonIfExist("Save",True) 
Call ClickButtonIfExist("Hold",True)'''If a pop-up of faulty document comes,this line can be used''''''
Call TakeScreenShot
