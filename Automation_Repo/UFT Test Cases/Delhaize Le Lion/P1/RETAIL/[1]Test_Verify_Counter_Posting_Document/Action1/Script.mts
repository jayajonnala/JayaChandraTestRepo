...
gstrTestCaseName = "Test_Verify_Counter_Posting_Document"
...
Call SetTextbox("Pur\. Order","MEPO_SELECT-EBELN","",DT_ME23N_0003_PUR_ORDER,True) ' - Line (4)
call ClickButton("Other Document.*",True)
Call TakeScreenShot()
Call ClickButtonIfExist("Expand Item Details Ctrl\+F4",False)
Call ClickButtonIfExist("Collapse Items Ctrl\+F6",False)
Call TakeScreenShot()
''Author - KGARA
''Added lines from 60 to 76
''ADDING script for selection of tab 7 in Item details window
''Getting Article doc. value of searched short text(RE-L)
Call SelectTab("ITEM_DETAIL","Purchase Order History",False)
'' SelectColumnGuiGrid(gridTitle, gridIndex, columnName, blnIsItPopup)
'Call SelectColumnGuiGrid("","","Short Text",False)
'Call TakeScreenShot()
'Call ClickButtonToolBar("&FIND",0)
' GetGridContentByRefColumn(gridTitle, gridIndex, refColumn, refFieldVal, columnName, dataTableColumnName)
Call GetGridContentByRefColumn("","","Short Text",DT_ME23N_0841_SEARCH_TERM,"Article Document","DT_ME23N_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_2_VALUE_OUTPUT")
'Call SetTextbox("Search Term:","GS_SEARCH-VALUE","",DT_ME23N_0841_SEARCH_TERM,TRUE) ' - Line (22)
'Call TakeScreenShot()
'Call ClickButton("OK   \(Enter\)",True)
' VerifyTextPopup(expectedValue)
...
'Call ClickCellGuiGrid("",1,"Article Document",3,"Short Text","RE-L",False)
'Call GetTextBoxValue("RBKPV-BELNR",0,"DT_ME23N_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_2_VALUE_OUTPUT",False)
Call TakeScreenShot()
...
Call PressEnter()
Call SetTextbox("Invoice Document No\.","RBKP-BELNR","",DT_ME23N_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_2_VALUE_OUTPUT,FALSE) ' - Line (22)
Call SetTextbox("Fiscal Year","RBKP-GJAHR","",DT_ME23N_6150_FISCAL_YEAR,FALSE) ' - Line (22)
call ClickButton("Display Document   \(F2\)",False)
Call TakeScreenShot()
'''' VerifyTextBoxContent(textboxAttachedText, textboxName, textboxIndex, expectedValue, blnIsItPopup)
CALL VerifyTextBoxContent("Reference","INVFO-XBLNR","",DT_ME23N_0010_CHECK_TEXT_OF_REFERENCE,FALSE)
