...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_Rebates contract creation RVI1_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_Rebates contract creation RVI1_TASE"
...
Call PressEnter()
Call TakeScreenshot
Call SelectTab("TABSTRIP","Sales",False)
Call TakeScreenshot
Call SetTextbox("Sales Organization","KOMWCOCOH-VKORG","",DT_WCOCO_0622_SALES_ORGANIZATION,False)
Call SetTextbox("Distribution Channel","KOMWCOCOH-VTWEG","",DT_WCOCO_0622_DISTRIBUTION_CHANNEL,False)
Call SetTextbox("Division","KOMWCOCOH-SPART","",DT_WCOCO_0622_DIVISION,False)
Call TakeScreenshot
Call PressEnter()
...
'SAPGuiSession("Session").SAPGuiWindow("Create DLL: Reb.based").InsightObject("InsightObject_3").Click
...
Call SetGridData("Business Volume Base","1","Purchasing Group",DT_WCOCO_0628_GRIDCELL_0_PURCH_GROUP,false)
Call SetGridData("Business Volume Base","1","Company Code",DT_WCOCO_0628_GRIDCELL_0_COMPANY_CODE,false)
Call TakeScreenshot
Call PressEnter()
...
Call TakeScreenshot
Call VerifyTextBoxContentIconName("A_RELEASE_ICON","0","S_LEDG",False)
