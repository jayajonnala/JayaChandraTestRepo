...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_Check_PO_Order_Proposal_After_Deletion_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_Check_PO_Order_Proposal_After_Deletion_TASE"
...
Call SelectTab("HEADER_DETAIL", "Delivery/Invoice", False)
Call TakeScreenShot
Wait 5
...
Call VerifyTableCellContent(1,"Deliv. Date", "SAPLMEGUITC_1211", ConvertDate(DT_ME23N_1211_CHECK_TEXT_OF_TABLECELL_DELIV_DATE_0))
...
Call VerifyTableCellContent(2,"Deliv. Date", "SAPLMEGUITC_1211", ConvertDate(DT_ME23N_1211_CHECK_TEXT_OF_TABLECELL_DELIV_DATE_1))
Call VerifyTableCellContent(2,"PO Quantity", "SAPLMEGUITC_1211", DT_ME23N_1211_CHECK_TEXT_OF_TABLECELL_PO_QUANTITY_1)
Call VerifyTableCellContent(3,"Article", "SAPLMEGUITC_1211", DT_ME23N_1211_CHECK_TEXT_OF_TABLECELL_ARTICLE_2)
Call VerifyTableCellContent(3,"Deliv. Date", "SAPLMEGUITC_1211", ConvertDate(DT_ME23N_1211_CHECK_TEXT_OF_TABLECELL_DELIV_DATE_2))
Call VerifyTableCellContent(3,"PO Quantity", "SAPLMEGUITC_1211", DT_ME23N_1211_CHECK_TEXT_OF_TABLECELL_PO_QUANTITY_2)
