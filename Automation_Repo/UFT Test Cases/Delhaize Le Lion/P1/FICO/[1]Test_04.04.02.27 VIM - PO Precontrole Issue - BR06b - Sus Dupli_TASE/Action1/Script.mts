...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.27 VIM - PO Precontrole Issue - BR06b - Sus Dupli
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.27 VIM - PO Precontrole Issue - BR06b - Sus Dupli"
...
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","105","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_0_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)

Call ClickButtonIfExist("Document is Not a Duplicate   \(Shift\+Ctrl\+0\)",False)
Call SetTextArea(DT_OPTVIM_7AX2_0011_TEXTEDIT_SHELL)
Call ClickButton("Save   \(Ctrl\+S\)",False)
 Wait 5
Call ClickButton("Refresh   \(F5\)",False)
Call VerifyGridCellContent("All Inbox.*",1,"DOCID",0,DT_GET_DOC)

Call ClickCellGuiGrid("All Inbox.*",0,"Execute",1,"","",False) 
Call TakeScreenShot()
Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","105","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_0_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
Call ClickButton("Save   \(Ctrl\+S\)",False)
