...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.49 VIM - PO Precontrole Issue - BR27 - Unit of Measure Mismatch (PO)
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.49 VIM-BR27-Unit of Measure Mismatch (PO)"
...
Call SetTableData("SAPLZTPVM_IDX_UITCTRL_ITEM_1220","Order Unit",1,"","",DT_UNIT_OF_MEASURE,False) 
Call SetTableData("SAPLZTPVM_IDX_UITCTRL_ITEM_1220","Order Unit",2,"","",DT_UNIT_OF_MEASURE_OCC1,False) 
Call PressEnter()     ' 
Call ClickButton("Save   \(Ctrl\+S\)",False)
Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","156","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_20_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)

Call SelectTab("TAB_MAIN","Line Items",False)
Call SetTableData("SAPLZTPVM_IDX_UITCTRL_ITEM_1220","Order Unit",1,"","",DT_UNIT_OF_MEASURE_OCC2,False) 
Call SetTableData("SAPLZTPVM_IDX_UITCTRL_ITEM_1220","Order Unit",2,"","",DT_UNIT_OF_MEASURE_OCC3,False) 
Call PressEnter()     ' 
Call ClickButton("Save   \(Ctrl\+S\)",False)   
Call VerifyStatusBar(DT_OPTVIM_7AX2_1000_CHECK_TEXT_OF_STATUSBAR)

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","156","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_20_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
'Call ClickButton("Save   \(Ctrl\+S\)",False)
