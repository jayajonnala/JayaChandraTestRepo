...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.39 VIM - PO Precontrole Issue - BR17 - Balance Not Zero
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.39 VIM - PO Precontrole Issue - BR17 - Balance Not Zero"
...
Call GetTextboxValue("/OPT/VIM_BL_1RIDX_OCR_DATA-GROSS_AMOUNT",0,"DT_OPTVIM_7AX2_2002_CHECK_TEXT_OF_GROSS_INV_AMOUNT_OUTPUT",False)
Call SetTextbox("Arch\.","S_ARCHIV_ID","",DT_OPTVIM_7AX2_0002_ARCH,False)
...
Call VerifyStatusBar(DT_OPTVIM_7AX2_0002_CHECK_TEXT_OF_STATUSBAR_OCC1_OUTPUT)
...
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","144","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_15_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)

Call SelectTab("TAB_MAIN","Basic Data",False)
Call SetTextboxNoLabel("GH_IDX_APPLICATION->MS_IDX_HEADER-GROSS_AMOUNT",0,DT_OPTVIM_7AX2_1100_GROSS_AMOUNT,False)
Call PressEnter()    
 
Call TakeScreenShot()

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","144","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_15_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
