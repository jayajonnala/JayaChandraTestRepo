...
gstrTestCaseName = "Test_04.04.02.46 VIM"
...
Call SetTextbox("Posting Date","GH_IDX_APPLICATION->MS_IDX_HEADER-BUDAT","",FormatBlank(DT_OPTVIM_7AX2_2002_POSTING_DATE),False)
Call PressEnter()
Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","912","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_18_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)

Call SelectTab("TAB_MAIN","Accounting",False)
Call SetTextbox("Posting Date","GH_IDX_APPLICATION->MS_IDX_HEADER-BUDAT","",ConvertDate(DT_OPTVIM_7AX2_9300_POSTING_DATE),False)
Call PressEnter()     ' 
' 
Call TakeScreenShot()

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","912","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_18_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
