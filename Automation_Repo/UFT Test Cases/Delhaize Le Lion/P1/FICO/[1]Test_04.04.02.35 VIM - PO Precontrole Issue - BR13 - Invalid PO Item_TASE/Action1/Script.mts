...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.35 VIM - PO Precontrole Issue - BR13 - Invalid PO Item
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.35 VIM - PO Precontrole Issue - BR13 - Invalid PO Item"
...
Call TakeScreenShot()
Call VerifyTextBoxContent("Arch\.","S_ARCHIV_ID",0,DT_OPTVIM_7AX2_0002_CHECK_TEXT_OF_ARCH,False)
...
Call SetTableData("/OPT/VIM_BL_M1_SUBSCREENSTC_INDEX_ITEMS","Line Number",1,"","",DT_OPTVIM_7AX2_0019_TABLECELL_LINE_NUMBER_0,False)
...
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
Call VerifyStatusBar(DT_OPTVIM_7AX2_0010_CHECK_TEXT_OF_MESSTXT1_OCC1)
'
''--------------------------------------------  /n/OPT/VIM_7AX2----------------------------------------------
...
Call SetTableData("SAPLZTPVM_IDX_UITCTRL_ITEM_1220","Item",1,"","",DT_ITEM_NUMBER_ROW,False) 
Call ClickButton("Save   \(Ctrl\+S\)",False)

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","115","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_11_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)

Call SelectTab("TAB_MAIN","Tax",False)
Call SelectTab("TAB_MAIN","Line Items",False)
Call SetTableData("SAPLZTPVM_IDX_UITCTRL_ITEM_1220","Item",1,"","",DT_OPTVIM_7AX2_1220_TABLECELL_ITEM_0,False)
Call ClickButton("Save   \(Ctrl\+S\)",False)
Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","115","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_11_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
