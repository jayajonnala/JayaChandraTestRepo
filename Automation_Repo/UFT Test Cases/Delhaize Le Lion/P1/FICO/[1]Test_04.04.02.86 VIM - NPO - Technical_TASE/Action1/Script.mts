...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.86 VIM - NPO - Technical
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.86 VIM - NPO - Technical"
...
Call VerifyGridCellContent("All Inbox.*",1,"DOCID",0,DT_OPTVIM_7AX2_1000_CHECK_GETCELLVALUE_OF_GRIDCELL_0_DOCID)
...
Call PressEnter() 
Call TakeScreenShot()
'''''Steps swapped based on Defect 20277
...
'''''SAPGuiSession("Session").SAPGuiWindow("Process DG - Non PO Invoice").Maximize
'''''SAPGuiSession("Session").SAPGuiWindow("Process DG - Non PO Invoice").SAPGuiGrid("GridViewCtrl").SelectCell 2,"Option"
'''''SAPGuiSession("Session").SAPGuiWindow("Process DG - Non PO Invoice").SAPGuiGrid("GridViewCtrl").ClickCell 2,"Option"
