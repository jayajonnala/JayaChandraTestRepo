...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.85 VIM - NPO - Standard_
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.85 VIM - NPO - Standard_"
...
Call PressEnter() 
Call TakeScreenShot()
'''''Steps swapped(136-138 -> 115-121) based on Defect 20277
...
If DT_OPTVIM_7AX2_2004_TABLECELL_EX_REA_OUTPUT =  DT_OPTVIM_7AX2_2004_TABLECELL_EX_REA Then
	...
	Call TakeScreenShot()
	Call ClickCellGuiGrid("All Inbox.*",0,"Execute",1,"","",False) 
	Call TakeScreenShot() @@ hightlight id_;_266476_;_script infofile_;_ZIP::ssf2.xml_;_
End If
'*********************************************************
...
Call SetTextbox("Document Processing Number","S_DOCID-LOW","",DT_OPTVIM_VA2_DOC_NUMBER,False)
