...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.37 VIM - PO Precontrole Issue - BR15 - Vendor Mismatch
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.37 VIM - PO Precontrole Issue - BR15 - Vendor Mismatch"
...
Call GetTextboxValue("/OPT/VIM_BL_1RIDX_OCR_DATA-LIFNR",0,"DT_VENDORNUMBER_OUTPUT",False)
Call SetTextbox("Arch\.","S_ARCHIV_ID","",DT_OPTVIM_7AX2_0002_ARCH,False)
...
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","153","Status",0,DT_OPTVIM_7AX2_1234_CHECK_GETCELLVALUE_OF_GRIDCELL_13_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)

Call SelectTab("TAB_MAIN","Basic Data",False)
Call SetTextbox("Vendor Number","GH_IDX_APPLICATION->MS_IDX_HEADER-LIFNR","",FormatBlank(DT_VENDORNUMBER),False)
Call PressEnter()    
Call PressEnter()     ' 
Call PressEnter()     ' 
' 
...
Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","153","Status",0,DT_OPTVIM_7AX2_1234_CHECK_GETCELLVALUE_OF_GRIDCELL_13_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
