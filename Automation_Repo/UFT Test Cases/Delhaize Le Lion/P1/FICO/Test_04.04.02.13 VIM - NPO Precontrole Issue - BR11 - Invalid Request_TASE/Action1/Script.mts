...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.13 VIM - NPO Precontrole Issue - BR11 - Invalid Request
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.13 VIM - NPO Precontrole Issue - BR11 - Invalid Request"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\Program Files (x86)\TCS\Test Automation Solution for Enterprise Applications\DEmopractice\Data\P1_DATA\P1_FICO\DT_04.04.02.13 VIM - NPO Precontrole Issue - BR11 - Invalid Request_TASE.xls"
'gstrInputExcelFilePathAndName="S:\TASETestData\Common\FICO\DT_04.04.02.13 VIM - NPO Precontrole Issue - BR11 - Invalid Request_TASE.xls"
...
Call GetStatusBar("item4","DT_OPTVIM_7AX2_1234_CHECK_MESSAGEPARAMETER_OF_STATUSBAR")
...
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","203","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_8_STATUS)
...
If DT_OPTVIM_7AX2_9100_GH_IDX_APPLICATIONMS_IDX_HEADERZZKOSTL <> "" Then
  Call SetTextboxNoLabel("GH_IDX_APPLICATION->MS_IDX_HEADER-ZZKOSTL",0,DT_OPTVIM_7AX2_9100_GH_IDX_APPLICATIONMS_IDX_HEADERZZKOSTL,False)
End If
If DT_ACCOUNTING_HEADER_EMAIL <>"" Then
	Call SetTextbox("Requester E-mail","GH_IDX_APPLICATION->MS_IDX_HEADER-EMAIL_ID","",DT_ACCOUNTING_HEADER_EMAIL,False)
End If
Call TakeScreenShot()
Call PressEnter()   ' 

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","203","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_8_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
Call TakeScreenShot()
