...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.24 VIM - PO Precontrole Issue - BR04 - Invalid Vendor
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.24 VIM - PO Precontrole Issue - BR04 - Invalid Vendor"
...
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","102","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_3_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)
Call SetTextbox("Vendor Number","GH_IDX_APPLICATION->MS_IDX_HEADER-LIFNR","",DT_OPTVIM_7AX2_1100_VENDOR_NUMBER,False)
Call TakeScreenShot()
Call PressEnter()   ' 

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","102","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_3_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
