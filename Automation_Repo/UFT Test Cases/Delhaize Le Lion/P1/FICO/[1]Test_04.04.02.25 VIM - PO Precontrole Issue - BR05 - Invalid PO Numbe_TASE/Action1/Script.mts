...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :]Test_04.04.02.25 VIM - PO Precontrole Issue - BR05 - Invalid PO Numbe
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.25 VIM - PO Precontrole Issue - BR05 - Invalid PO Numbe"
...
DT_DOC_NUM = DT_OPTVIM_DOC_NUM_OUTPUT
...
Call SetTextbox("Document Id","H1_DOID-LOW","",DT_DOC_NUM,False)
...
Call SetTextbox("Document Id","%%DYN001-LOW","",DT_DOC_NUM,False)
Call TakeScreenShot()
...
Call SetTextbox("PO Number","GH_IDX_APPLICATION->MS_IDX_HEADER-EBELN","",FormatBlank(DT_OPTVIM_7AX2_1100_PO_NUMBER),False)
Call PressEnter()    ' 

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","101","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_4_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)
Call SetTextbox("PO Number","GH_IDX_APPLICATION->MS_IDX_HEADER-EBELN","",FormatBlank(DT_OPTVIM_7AX2_1100_PO_NUMBER_OCC1),False)
Call TakeScreenShot()
Call PressEnter()   ' 

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","101","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_4_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
