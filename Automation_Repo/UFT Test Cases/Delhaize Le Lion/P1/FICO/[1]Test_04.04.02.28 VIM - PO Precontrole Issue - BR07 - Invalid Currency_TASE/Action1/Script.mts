...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.28 VIM - PO Precontrole Issue - BR07 - Invalid Currency
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.28 VIM - PO Precontrole Issue - BR07 - Invalid Currency"
...
Call SetTextbox("Gross Amount","GH_IDX_APPLICATION->MS_IDX_HEADER-WAERS","",FormatBlank(DT_OPTVIM_7AX2_1100_GROSS_AMOUNT),False)
Call PressEnter()    ' 

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","104","Status",0,DT_CHECK_REDLIGHT)
Call ClickButton("Exit   \(Shift\+F7\)",True)
Call SetTextbox("Gross Amount","GH_IDX_APPLICATION->MS_IDX_HEADER-WAERS","",FormatBlank(DT_OPTVIM_7AX2_1100_GROSS_AMOUNT_OCC1),False)
Call TakeScreenShot()
Call PressEnter()   ' 
Call SetTextbox("Gross Amount","GH_IDX_APPLICATION->MS_IDX_HEADER-WAERS","",FormatBlank(DT_OPTVIM_7AX2_1100_GROSS_AMOUNT_OCC1),False)
Call PressEnter()   ' 
...
Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","104","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_6_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)
'
