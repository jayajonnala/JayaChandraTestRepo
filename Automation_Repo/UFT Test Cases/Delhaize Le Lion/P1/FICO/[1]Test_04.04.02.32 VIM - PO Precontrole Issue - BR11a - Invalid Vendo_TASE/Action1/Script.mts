...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :]Test_04.04.02.32 VIM - PO Precontrole Issue - BR11a - Invalid Vendo
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "]Test_04.04.02.32 VIM - PO Precontrole Issue - BR11a - Invalid Vendo"
...
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","920","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_9_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)
Call SelectTab("TAB_MAIN","Process",False)
Call SelectTab("TAB_MAIN","Tax",False)
Call SetTextbox("Vendor Tax Number","GH_IDX_APPLICATION->MS_IDX_HEADER-VENDOR_TAX_NO","",FormatBlank(DT_OPTVIM_7AX2_9400_VENDOR_TAX_NUMBER),False)
Call PressEnter()    ' 

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","920","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_9_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
