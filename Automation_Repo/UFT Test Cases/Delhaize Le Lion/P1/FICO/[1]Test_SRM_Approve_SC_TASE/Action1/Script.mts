...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_SRM_Approve_SC 
'.................Author : TCS 	   :Kumar K
...
gstrTestCaseName = "Test_SRM_Approve_SC_TASE"
...
'Call ClickSAPFrameSAPButton(1,"Floor Plan Manager application for OIF","Process Now","SPAN","")
...
'Call ClickFrameSAPButton(1,"Approve Shopping Cart","Approve","SPAN",0)
Call ClickFrameSAPButton(1,"Approve Shopping Cart","Approve","DIV",0)
Wait 10
Call CaptureWebScreen(1,"Capture screen:Approve")
