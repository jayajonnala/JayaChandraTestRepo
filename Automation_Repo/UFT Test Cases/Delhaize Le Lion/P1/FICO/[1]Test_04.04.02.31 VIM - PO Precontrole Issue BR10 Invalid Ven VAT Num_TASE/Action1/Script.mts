...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.31 VIM - PO Precontrole Issue BR10 Invalid Ven VAT Num
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.31 VIM - PO Precontrole Issue BR10 Invalid Ven VAT Num"
...
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","120","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_7_STATUS)
Call ClickButton("Exit   \(Shift\+F7\)",True)
Call SelectTab("TAB_MAIN","Process",False)
Call SelectTab("TAB_MAIN","Tax",False)
Call SetTextbox("Vendor VAT Number","GH_IDX_APPLICATION->MS_IDX_HEADER-VENDOR_VAT_NO","",FormatBlank(DT_OPTVIM_7AX2_9400_VENDOR_VAT_NUMBER),False)
Call PressEnter()    ' 

Call ClickButton("Simulate and Bypass Business Rules   \(Ctrl\+Shift\+F9\)",False)
Call VerifyGridCellContentByRefColumn("","","PROCESS_TYPE","120","Status",0,DT_OPTVIM_7AX2_2004_CHECK_GETCELLVALUE_OF_GRIDCELL_7_STATUS_OCC1)
Call ClickButton("Exit   \(Shift\+F7\)",True)
