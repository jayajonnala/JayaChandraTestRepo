...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_04.04.02.17 VIM - NPO Precontrole Issue - BR13 - Process NPO Inv - Mpost
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_04.04.02.17 VIM"
...
Call SetTextboxNoLabel("GH_IDX_APPLICATION->MS_IDX_HEADER-ZZKOSTL",0,FormatBlank(DT_OPTVIM_7AX2_2004_TABLECELL_COST_CTR_0_OCC1),False)
Call PressEnter()  
Call PressEnter()  
...
Call ClickButtonIfExist("Refresh   \(F5\)",False)
 Wait 25
''Call ClickButton("BT_H_APPLY",False)
''wait 5
Call ClickButton("Refresh   \(F5\)",False)
...
''Call ClickCellGuiGrid("All Inbox.*",0,"Execute",1,"","",False)
''Call ClickButtonIfExist("Show Options   \(Ctrl\+F12\)",False)
''Call ClickCellGuiGrid("",0,"Option Short Text",3,"","",False)
''Call TakeScreenShot()
