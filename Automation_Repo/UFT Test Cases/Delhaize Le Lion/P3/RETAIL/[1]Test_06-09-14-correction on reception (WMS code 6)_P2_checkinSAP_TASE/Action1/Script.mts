...
gstrTestCaseName = "Test_06-09-14-correction  (WMS code 6)_P2_checkinSAP"
...
Call SetVerticalScrollBar(40, False)
...
outputVal=IfTableCellContentExists(4, "Fld Cont.", "IDOC_TREE_CONTROLINT_SEG_CONTROL", DT_ME21N_0003_PUR_ORDER) 
rowNum=1
...
'''Call SelectRowGuiGridbyRowNo("Selected IDocs", 0,1,False)
Call ClickButton("Back   \(F3\)",false)
Call GetGridContentByTitle("Selected IDocs", 0, "IDoc number", rowNum, "DT_IDOC_NO_OUTPUT")
