'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_02-04-01-05-01-Create new assortment-BABA 
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_02-04-01-05-01-Cr-BABA"
...
Call WriteRunTimeDataToExcelGlobalSheet ("DT_ASSORT_INCREMENT",Cint(DT_ASSORT_INCREMENT)+1)
GetRowNo = 2
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global","2")
...
Call SetTextbox("Hierarchy Node","WRFS_MATGRP_HLP-NODE","",DT_WSOA1_0015_HIERARCHY_NODE,False)
Call SetTextbox("Hierarchy","WRFS_MATGRP_HLP-HIER_ID","",DT_WSOA1_0015_HIERARCHY,False)
Call SetTextbox("SIZE/BASE","WRS1-ASSORDIMVAL1","",DT_WSOA1_0015_SIZEBASE,False)
Call SetTextbox("Module threshold","WRS1-ASSORDIMVAL3","",DT_WSOA1_0015_MODULE_THRESHOLD,False)
Call TakeScreenShot
Call PressEnter()
...
'Call VerifyTextBoxContent("Assortment","V_WRS1-NAME1","",DT_WSOA1_0010_CHECK_TEXT_OF_ASSORTMENT_OCC1,False)
