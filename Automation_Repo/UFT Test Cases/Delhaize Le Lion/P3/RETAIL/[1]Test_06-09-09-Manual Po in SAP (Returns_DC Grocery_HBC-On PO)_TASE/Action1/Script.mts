...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_06-09-09-Manual Po in SAP (Returns_DC Grocery_HBC-On PO)_TASEE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_06-09-09-(Returns_DC_HBC)"
...
''Call SetTableData("SAPLMEGUITC_1211","Article","2","","",DT_ME21N_1211_TABLECELL_ARTICLE_1,False)
 Call SetTableData("SAPLMEGUITC_1211","Article","1","","",DT_ME21N_1211_TABLECELL_ARTICLE_1,False)
...
Call SetTableData("SAPLMEGUITC_1211","PO Quantity","1","","",DT_ME21N_1211_TABLECELL_PO_QUANTITY_1,False)
...
Call SetTableData("SAPLMEGUITC_1211","Plnt","1","","",DT_ME21N_1211_TABLECELL_SITE_1,False)
Call PressEnter()
...
Call SetTableData("SAPLMEGUITC_1211","Deliv. Date","1","","",ConvertDate(DT_ME21N_1211_TABLECELL_DELIV_DATE_1),False) 
Call PressEnter()


Call TakeScreenShot()
Call SelectMenuBar("Purchase Order;Save")
'Call ClickButton("Save   \(Ctrl\+S\)",Fal
...
Call SetTextbox("Pur. Order","MEPO_SELECT-EBELN","",DT_ME21N_0014_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OUTPUT,True) 
...
Call TakeScreenShot
' VerifyTableCellContentByRef(tableName, refColumnName, refCellValue, TableColumnName, expectedValue)
'Call VerifyTableCellContentByRef("SAPDV70ATC_NAST3","ZWMS","S_TL_G","Status",DT_ME21N_0100_CHECK_TOOLTIP_OF_TABLECELL_STATUS_2)
...
Call VerifyTableCellContent(4, "Status", "SAPDV70ATC_NAST3", DT_ME21N_0100_CHECK_TOOLTIP_OF_TABLECELL_STATUS_2)
