...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................06 09 05 1 Broken pallet in Bloc zone   WMS code A _GET_PALLETE_NO_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "06 09 05 1 Broken WMS A _GET_PALLETE"
...
Call CaptureScreenshot_Mainframe("A")
Call SetTEField("A",DT_P_FIELD_NAME_C1,DT_P_FIELD_ID_VAL_SQL_C6)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C6)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C5,DT_P_FIELD_ID_VAL_QUERY_LINE_C7,"")
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C6,DT_P_FIELD_ID_VAL_QUERY_LINE_C8,"")
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C8)
Call CaptureScreenshot_Mainframe("A")
Call Get_TEFieldValue_byID("A",DT_P_FIELD_ID_C7,"DT_GET_OP_PALLET",DT_DESC)
Call SendTEScreenKey ("A",DT_P_KEY_C3)
Call SendTEScreenKey ("A",DT_P_KEY_C4)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C8,DT_P_FIELD_ID_VAL_EXIT_QUERY_C9,DT_DESC_C1)
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C8)
