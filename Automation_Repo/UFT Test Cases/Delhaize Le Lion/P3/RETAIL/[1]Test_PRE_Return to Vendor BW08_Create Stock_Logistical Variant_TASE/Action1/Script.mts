...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_PRE_Return to Vendor BW08_Create Stock_Logistical Variant_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_PRE_Return to Vendor BW08_Create Stock"
...
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C5,DT_P_FIELD_ID_VAL_INVENTORISTE_C8,"")
Call CaptureScreenshot_Mainframe("A")
Call SendTEScreenKey ("A",DT_P_KEY_C4)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C6,DT_P_FIELD_ID_VAL_ARTICLE_C9,"")
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C7,DT_P_FIELD_ID_VAL_ARTICLE_C10,"")
Call CaptureScreenshot_Mainframe("A")
Call SendTEScreenKey ("A",DT_P_KEY_C5)
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C8,DT_P_FIELD_ID_VAL_ADRESSE_C11,"")
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C9,ConvertDateTxt(DT_P_FIELD_ID_VAL_DATE_C12,DT_DATE_INCREMENT),"")
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C10,DT_P_FIELD_ID_VAL_MOUVEMENT_C13,"")
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C11,DT_P_FIELD_ID_VAL_POIDS_C14,"")
Call SendTEScreenKey ("A",DT_P_SEND_KEY_C7)
Call CaptureScreenshot_Mainframe("A")
Call VerifyTEFieldByID ("A",DT_P_FIELD_ID_C12,DT_P_FIELD_ID_VAL_VERIFY_C15,"")
Call SendTEScreenKey ("A",DT_P_KEY_C6)
Call logOffTEWindow("A","","PC5250","OK")
Call FinalStatus ()
'//------------------------------------------(       ......        UTILITY STATEMENTS    ......        )---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//

Call ConvertDateTxt(Date,2)
