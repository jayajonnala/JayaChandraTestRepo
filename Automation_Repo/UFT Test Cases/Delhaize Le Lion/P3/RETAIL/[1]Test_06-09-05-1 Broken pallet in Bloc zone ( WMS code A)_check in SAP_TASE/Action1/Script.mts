...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_06-09-05-1 Broken pallet in Bloc zone ( WMS code A)_check in SAP_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_06-09-05-1 Broken pallet in Bloc"
...
'Call SetTextbox("User Name","USNAM-LOW","",DT_USER,False)
...
Call ClickButton("\%\_BKTXT\_\%\_APP\_\%\-VALU\_PUSH",False)
'
'' SetTableData(tableName, columnName, rowNumber, refColumnName, refCellValue, cellValue, blnIsItPopup)
Call SetTableData("SAPLALDBSINGLE","Single value",1,"","","A",True)
'Call TakeScreenShot() 
...
Call GetGridContent("",0,"Article Document",1,"Document Header Text",DT_MB51_3010_TABLECELL_SINGLE_VALUE_0,"DT_MB51_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_MBLNR_OUTPUT")
