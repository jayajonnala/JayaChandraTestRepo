...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_06-09-68-Manual GR in WH (mvt type 101)_GOLD_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_06-09-68-Manual(mvt type 101)_GOLD"
...
Call Get_TEFieldValue_byID("A",DT_P_FIELD_ID_C9,"DT_OP_GET_DATE",DT_DESC)
'Call WriteRunTimeDataToExcelGlobalSheet("DT_OP_GET_DATE",DT_ME21N_0014_CHECK_MESSAGEPARAMETER_OF_STATUSBAR)
DataRowSet = 2
...
Call SetTEFieldBY_ID ("A",DT_P_FIELD_ID_C10,DT_P_FIELD_ID_VAL_ARTICLE_C14,"")
Call SendTEScreenKey ("A",DT_P_KEY_C10)
Call Get_TEFieldValue_byID("A",DT_P_FIELD_ID_C11,"DT_OP_GET_DATE_C1",DT_DESC_C1)
DataRowSet = 2
'Call WriteRunTimeDataToExcelGlobalSheet("DT_OP_GET_DATE",DT_ME21N_0014_CHECK_MESSAGEPARAMETER_OF_STATUSBAR)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
...
Call VerifyTEFieldByID ("A",DT_P_FIELD_ID_C12,DT_P_FIELD_ID_VERIFY_QTY_C16,DT_DESC_C2)
Call VerifyTEFieldByID ("A",DT_P_FIELD_ID_C13,DT_P_FIELD_ID_VAL_VERIFY_QTY_DELIVERED_C17,DT_DESC_C3)
Call SendTEScreenKey ("A",DT_P_KEY_C8)
Call VerifyTEFieldByID ("A",DT_P_FIELD_ID_C14,DT_P_FIELD_ID_VAL_CHECK_MENU_C18,DT_DESC_C4)
