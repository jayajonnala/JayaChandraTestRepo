...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_BOH BW12 (LW02 - BW09)_Blocked Stock_TASE
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "TC2_Test_BOH BW12 (LW02 - BW09)_Block"
...
wait 2
Call SelectCheckbox("GS_SEARCH-EXACT_WORD",1,DT_ENTIRE_BOX,True)
Call TakeScreenShot()
Call ClickButton("OK   \(Enter\)",True)
Call ClickButton("Cancel   \(F12\)",True)
Call TakeScreenShot()
Call VerifyGridCellContent("Full","1","Stock","",DT_MMBE_0300_CHECK_TEXT_OF_TREE_FULL_NODE)
...
'Call SetTableData("SAPLSE16NSELFIELDS_TC", "Fr.Value", 2, "", "", ConvertDate(DT_DOC_DATE_SE16N), False)
...
Call SetTableData("SAPLSE16NSELFIELDS_TC", "Fr.Value", 5, "", "", DT_STOR_LOCATION_SE16N, False)
Call TakeScreenShot
Call ClickButton("Online   \(F8\)",False)
Call TakeScreenShot
Call VerifyGridCellContentbyName("shell", 1, "Blocked", "", DT_CHECK_QTY_WMS)

'
Call LogOff()
'SAPGuiSession("Session_2").SAPGuiWindow("Stock Overview: Basic").Maximize
'SAPGuiSession("Session_2").SAPGuiWindow("Stock Overview: Basic").SAPGuiToolbar("ToolBarControl").PressButton "DETAILS"
Call FinalStatus ()
