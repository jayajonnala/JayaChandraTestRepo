'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_PRE_01_E10G07P02S01V01 Rep on Gen Tax Docs from BELUX for BE10  
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_PRE_01_E10G07P02S01V01 Rep on Gen Tax Docs from BELUX for BE10"
...
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL", "Message",3, "", "","DT_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_2", False)
Call TakeScreenShot
Call ClickButton("Last transaction   \(Ctrl\+F6\)",False)
Call ClickButton("Previous transaction   \(Ctrl\+F4\)",False)
Call TakeScreenShot
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL", "Message",4, "", "","DT_OP_FINAL_DOC", False)
GetRowNo =4
