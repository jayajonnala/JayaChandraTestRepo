'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_PRE_02_F_RQ113V00 Belgian Vat return NEW  
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_PRE_03_F_RQ113V00 Belgian Vat return NEW"
...
Call ClickButtonIfExist("Continue   \(Enter\)", True)
Call SetTableData("SAPLTAX1STEUER_CTRL", "Base Amount", 1, "", "",DT_FB60_0501_TABLECELL_BASE_AMOUNT_0, False)
Call TakeScreenShot
Call PressEnter()
Call ClickButtonIfExist("Continue   \(Enter\)", True)
