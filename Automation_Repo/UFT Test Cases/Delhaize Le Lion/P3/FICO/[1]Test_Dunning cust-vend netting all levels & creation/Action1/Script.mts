'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_Dunning cust-vend netting all levels & creation
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_Dunning cust-vend net& creati"
...
Call VerifyifGuiLabelExists_ByIndex(DT_F150_0120_CHECK_TEXT_OF_NO_NAME_OCC5, 0)
Call VerifyifGuiLabelExists_ByIndex(DT_F150_0120_CHECK_TEXT_OF_NO_NAME_OCC6, 0)
...
Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_2000_00_VERHOOGD_MET_EUR_5_00,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("1", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)

Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_GEBABEBB__MET_ALS_REFERENTIE_D3,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("1", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)
...
'''Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_NO_NAME_OCC6,True)
'''Call ClickButtonIfExist("Find   \(Enter\)", True)
'''Call TakeScreenShot
'''Call VerifyifGuiLabelExists_ByIndex("1", 0)
'''Call ClickButtonIfExist("Continue   \(Enter\)", True)

Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_LAATSTE_AANMANING__AANGETEKEND,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("1", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)

Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_NO_NAME_OCC8,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("1", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)

Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_NO_NAME_OCC9,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("1", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)

Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_NO_NAME_OCC10,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("1", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)

Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_NO_NAME_OCC11,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("1", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)
...
Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_NO_NAME_OCC12,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("3", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)
