...
gstrTestCaseName = "Test_FB60-FBL1N-Post invoice"
...
Wait 5
Call TakeScreenShot
Call VerifyTextBoxContentIconName("RF05A-AMPEL",0,DT_FB60_1100_CHECK_TOOLTIP_STATUS_OF_BAL, False)
...
Call SetTextbox("Vendor account","KD_LIFNR-LOW","","",False)
...
Call TakeScreenShot
'Enable this step if the Grid is getting displayed
...
'Call VerifyGridCellContentbyName("shell",1,"Assignment","",DT_FB60_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_XBLNR)
...
'Call VerifyGridCellContentbyName("shell",1,"Posting Date","",ConvertDate(DT_FB60_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BLDAT))
...
'Call VerifyGridCellContentbyName("shell",1,"Invoice reference","",DT_FB60_0500_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BELNR)
...
'Call ClickButtonIfExist("Hide Selected Fields (F6)",True)
