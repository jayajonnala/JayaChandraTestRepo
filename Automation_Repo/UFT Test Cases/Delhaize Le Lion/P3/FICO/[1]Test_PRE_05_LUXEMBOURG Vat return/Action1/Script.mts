'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_PRE_05_LUXEMBOURG Vat Return 
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_PRE_05_LUXEMBOURG Vat Return"
...
Call TakeScreenShot
Call ClickButton("Refresh",False)
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL", "Message",2, "", "","DT_OP_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_2", False)
'Call VerifyTableCellContent(4, "Message", "RSBDC_ANALYSETC_PROTOCOL", DT_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_3)
Call SelectRadioButton("RB-PRO_TCODE", "Transaction", False)
Call ClickButton("Refresh",False)
Call TakeScreenShot
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL", "Message",1, "", "","DT_OP_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_2", False)
Call SelectRadioButton("RB-PRO_SESSION", "Folder", False)
Call TakeScreenShot
Call VerifyTableCellContent(5, "Message", "RSBDC_ANALYSETC_PROTOCOL", DT_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_4)
Call VerifyTableCellContent(4, "Message", "RSBDC_ANALYSETC_PROTOCOL", DT_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_3)
GetRowNo =2
