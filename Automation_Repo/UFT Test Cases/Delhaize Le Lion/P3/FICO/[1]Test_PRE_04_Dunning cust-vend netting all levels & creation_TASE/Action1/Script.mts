'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_PRE_04_Dunning cust-vend netting all levels & creation 
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_PRE_04_Dunning cust-vend net& creati"
...
Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_MOMENTEEL_EUR___2000_00,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("1", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)

Call SetTextbox("Find","RSYSF-STRING","",DT_F150_0120_CHECK_TEXT_OF_D2_11005829,True)
Call ClickButtonIfExist("Find   \(Enter\)", True)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex("1", 0)
Call ClickButtonIfExist("Continue   \(Enter\)", True)
...
Call WriteRunTimeDataToExcelGlobalSheet ("DT_OP_F150_0110_JOB_TEXT_OF_F150VSJOB_OUTPUT",DT_F150_0110_JOB_TEXT_OF_F150VSJOB)
