'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_PRE_03_E10G07P02S01V01 Rep on Gen Tax Docs from BELUX for BE10 
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_PRE_03_E10G07P02S01V01 BELUX for BE10"
...
' Batch processing and file update needed
...
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL", "Message",3, "", "","DT_OP_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_3", False)
Call ClickButton("Last transaction   \(Ctrl\+F6\)",False)
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL", "Message",1, "", "","DT_OP_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_11", False)
Call ClickButton("Previous transaction   \(Ctrl\+F4\)",False)
Call GetTableCellData("RSBDC_ANALYSETC_PROTOCOL", "Message",4, "", "","DT_OP_ZFIGL_UPLOAD_POST_0400_CHECK_TEXT_OF_TABLECELL_MESSAGE_13", False)
GetRowNo =4
