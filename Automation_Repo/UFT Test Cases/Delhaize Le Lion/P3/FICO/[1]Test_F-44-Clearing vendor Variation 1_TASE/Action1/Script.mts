'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test_F-44-Clearing vendor Variation 1  
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_F-44-Clearing vendor Variation 1"
...
Call VerifyStatusBar("Document "&DT_F44_0131_CHECK_MESSAGEPARAMETER_OF_STATUSBAR&" was posted in company code BE10")
Call TakeScreenShot
...
Call VerifyGridCellContent("", 1, "Posting Key","",DT_F44_0750_CHECK_POSTING_KEY_0_BSCHL)
Call VerifyGridCellContent("", 2, "Posting Key","",DT_F44_0750_CHECK_POSTING_KEY_1_BSCHL)
Call VerifyGridCellContent("", 1, "Account","",DT_F44_0750_CHECK_ACCOUNT_0_KTONR)
Call VerifyGridCellContent("", 2, "Account","",DT_F44_0750_CHECK_ACCOUNT_1_KTONR)
Call VerifyGridCellContent("", 1, "Description","",DT_F44_0750_CHECK_DESCRIPTION_0_KOBEZ)
Call VerifyGridCellContent("", 2, "Description","",DT_F44_0750_CHECK_DESCRIPTION_1_KOBEZ)
Call VerifyGridCellContent("", 1, "Amount","",DT_F44_0750_CHECK_AMOUNT_0_AZBET)
Call VerifyGridCellContent("", 2, "Amount","",DT_F44_0750_CHECK_AMOUNT_1_AZBET)
Call VerifyGridCellContent("", 1, "Currency","",DT_F44_0750_CHECK_CURRENCT_0_PSWSL)
Call VerifyGridCellContent("", 2, "Currency","",DT_F44_0750_CHECK_CURRENCT_1_PSWSL)
