...
'
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_2.3.1.1.3. Create Customer with Account Group ZCXT - DG External_TASE
'.................Author : TCS        :Bitan
...
gstrTestCaseName = "Test_2.3.1.1.3. Create Customer with Account Group ZCXT - DG External_TASE"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\TASE Files\DATA\DT_2.3.1.1.3. Create Customer with Account Group ZCXT - DG External_TASE.xls"
''//---------------------------------------------------------------------------------------------------------------------------------------------------AUTOMATION TEST SCRIPT------------------------------------------------------------------------------------------------------------------------------------------------------------//
'
''''Login'''
'DataRowSet=2
...
Call ClickLabel(DT_XD01_7211_RECON_ACCOUNT,"",True)
...
Call ClickLabel(DT_XD01_7211_SORT_KEY,"",True)
Call ClickButtonIfExist("Copy   \(Enter\)",True)
Call TakeScreenShot()
...
Call SendKey("{F4}")
Wait(1)
Call SetTableDataNoRef("SAPMF02DTCTRL_ZAHLWEGE","Indicator: Payment mtd selected(outgoing)?",2,DT_XD01_7216_PAYMENT_METHODS,True)
Call ClickButtonIfExist("Continue   \(Enter\)",True)
Call TakeScreenShot()
...
Wait(3)
Call GetStatusBar("item1","DT_CUST_NO_OUTPUT")
