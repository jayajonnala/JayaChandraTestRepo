...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_2.1.1.6. Create Article via Web Application - Common article_AltUoM_P1
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_2.1.1.6. Create Article via Web Application - Common article_AltUoM_P1"
...
Wait(1)
Call CaptureWebScreen(0,"Create New Article")
'Call SetWebEdit(0,"","Article_View\.Artc_Basic_Info\.sap_ref_article","text",0,DT_ARTICLE_VIEWARTC_VENDOR_DATAVEND_LIFNR,False)
'Wait(1)
...
Wait(5)
Call SelectWebCheckbox(0,"","Article_View\.Artc_Alt_Units\[1\]\.vend_po_uom_flag","INPUT",0,"ON",False)
Call SelectWebCheckbox(0,"","Article_View\.Artc_Alt_Units\[1\]\.vend_deli_uom_flag","INPUT",0,"ON",False)
...
Wait(1)
Call SelectWebList(0,"","Article_View\.Artc_Alt_Units\[1\]\.vend_unit_of_wt",0,DT_ARTICLE_VIEWARTC_ALT_UNITS1VEND_UNIT_OF_WT,False)
Wait(1)
Call SelectWebList(0,"","Article_View\.Artc_Alt_Units\[1\]\.vend_unit_dim",0,DT_ARTICLE_VIEWARTC_ALT_UNITS1VEND_UNIT_DIM,False)
Wait(1)
...
Wait(1)
Call SetWebEdit(0,"","Article_View\.Artc_Alt_Vend_GTINs\[1\]\.vend_gtin","text",0,DT_ARTICLE_VIEWARTC_ALT_VEND_GTINS1VEND_GTIN,False)
...
Wait(1)
Call SetWebEdit(0,"","Article_View\.Artc_Vendor_Data\.vend_gln","text",0,DT_ARTICLE_VIEWARTC_VENDOR_DATAVEND_GLN,False)
Wait(1)
