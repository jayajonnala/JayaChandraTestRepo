...
'
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_Returns from store - CC RS02 RS01_p1_TASE
'.................Author : TCS        :Bitan
...
gstrTestCaseName = "Test_Returns from store - CC RS02 RS01_p1"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\TASE Files\DATA\DT_Returns from store - CC RS02 RS01_p1_TASE.xls"
''//---------------------------------------------------------------------------------------------------------------------------------------------------AUTOMATION TEST SCRIPT------------------------------------------------------------------------------------------------------------------------------------------------------------//
'
''''Login'''
'DataRowSet=2
...
Call WriteRunTimeDataToExcelGlobalSheet ("DT_DELIVERY_NOTE_INC",(Cint(DT_DELIVERY_NOTE_INC)+1))
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
'
'''----------------------Tcode ME21N----------------------------
'Enter the Tcode
...
Call GetStatusBar("item2","DT_ME21N_0014_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OCC1_OUPUT")
'reload data sheet
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
...
Call PressEnter()
Call SelectCheckbox("GODYNPRO-DETAIL_TAKE",0,DT_OK_CHECKBOX_SELECTED,False)
'Capture the screenshot
Call TakeScreenShot()
...
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
'verify statusbar with datasheet feed
Call VerifyStatusBar(DT_ME21N_0001_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OUTPUT)
Call VerifyStatusBarMessageType(DT_EXPECTEDVALUE_OCC1)
