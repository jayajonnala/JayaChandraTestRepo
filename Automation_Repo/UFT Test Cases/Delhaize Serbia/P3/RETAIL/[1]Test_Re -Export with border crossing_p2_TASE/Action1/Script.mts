...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_Re -Export with border crossing_p2
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_Re -Export with border crossing_p2"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\Program Files (x86)\TCS\Test Automation Solution for Enterprise Applications\InputDatasheet\DT_Re -Export with border crossing_p2.xls"
...
'Call VerifyTableCellContent(1,"Status","SAPDV70ATC_NAST3",DT_VL03N_0100_CHECK_TEXT_OF_TABLECELL_OUTPUT_TYPE_0)
...
'Enter the delivery No
Call SetTextbox("Outbound Delivery","LIKP-VBELN","",DT_VL03N_0101_DELIVERY,False)
Call TakeScreenShot()
Call PressEnter()
Call TakeScreenShot()
...
'Click on GUI Tree
Call ActivateItemGuiTree(0,"#1;#1;#1","#2")
Wait(2)
Call TakeScreenShot()
