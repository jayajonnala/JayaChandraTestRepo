'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_Manual Posting of GL Document both ledgers_p12
'.................Author : TCS        
'................ Creation Date    :
'.................Modified By :
...
gstrTestCaseName = "Test_Manual Posting of GL Document both ledgers_p12_TASE"
...
Call SetTextbox("Period","BKPF-MONAT","",Cstr(Month(DT_FB01_0100_PERIOD)),False)
...
Call SetTextbox("Doc\.Header Text","BKPF-BKTXT","",DT_FB01_0100_REFERENCE,False)
Call TakeScreenShot
Call PressEnter()
Call TakeScreenShot

Call SetTextbox("Amount","BSEG-WRBTR","",DT_FB01_0303_AMOUNT,False)
Call SetTextbox("Due on","BSEG-ZFBDT","",ConvertDate(DT_FB01_0303_DUE_ON),False)
...
Call SetTextbox("Account","RF05A-NEWKO","1",DT_FB01_0303_ACCOUNT,False)
Call TakeScreenShot
Call PressEnter
Call TakeScreenShot
Call PressEnter
