'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_PRE1_Manage Asset Transfer_Create assets_TASE
'.................Author : TCS        :Bitan
'................ Creation Date    : 15th March
'.................Modified By :
...
gstrTestCaseName = "Test_PRE1_Manage Asset Transfer_Create assets_TASE"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\TASE Files\DATA\DT_PRE1_Manage Asset Transfer_Create assets_TASE.xls"
''//---------------------------------------------------------------------------------------------------------------------------------------------------AUTOMATION TEST SCRIPT------------------------------------------------------------------------------------------------------------------------------------------------------------//
'
''''Login'''
'DataRowSet=2
...
Call WriteRunTimeDataToExcelGlobalSheet ("DT_INCREMENT",(Cint(DT_INCREMENT)+3))
...
'Capture the screenshot
Call TakeScreenShot()
Call SetTableDataNoRef("SAPLAISTTC_ANLB","DKey",1,DT_AS01_1190_TABLECELL_DKEY_0,False)
'Capture the screenshot
Call TakeScreenShot()
