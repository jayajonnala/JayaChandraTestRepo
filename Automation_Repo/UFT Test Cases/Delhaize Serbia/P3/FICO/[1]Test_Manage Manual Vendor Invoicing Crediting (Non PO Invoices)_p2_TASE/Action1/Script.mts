...
'
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_Manage Manual Vendor Invoicing Crediting (Non PO Invoices)_p2_TASE
'.................Author : TCS        :Bitan
...
gstrTestCaseName = "Test_Manage Manual Vendor Invoicing Crediting (Non PO Invoices)_p2_TASE"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\TASE Files\DATA\DT_Manage Manual Vendor Invoicing  Crediting (Non PO Invoices)_p2_TASE.xls"
''//---------------------------------------------------------------------------------------------------------------------------------------------------AUTOMATION TEST SCRIPT------------------------------------------------------------------------------------------------------------------------------------------------------------//
'
''''Login'''
'DataRowSet=2
...
'Call SetTextbox("Company Code","BKPF-BUKRS","",DT_FB65_0010_COMPANY_CODE,True)
Call SetTextboxPopupIfExist("BKPF-BUKRS","Company Code",DT_FB65_0010_COMPANY_CODE)
'Capture the screenshot
Call TakeScreenShot()
...
Call SetTextbox("Pmnt Terms","INVFO-ZTERM","",DT_FB65_0020_PAYT_TERMS,False)
'Capture the screenshot
Call TakeScreenShot()
...
Call Clickbuttonifexist("Continue   \(Enter\)",True)
wait(1)
Call SetTextbox("Part\. bank","INVFO-BVTYP","",DT_FB65_0020_PART_BANK,False)
'Capture the screenshot
Call TakeScreenShot()
...
Call SetTextArea(DT_FB65_0040_TEXTEDIT_SHELL)
'Capture the screenshot
Call TakeScreenShot()
...
Wait(3)
Call SetTextbox("Account","%%DYN001-LOW","",DT_FB65_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_KTONR,True)
Call ClickButton("Execute   \(Enter\)",True)
Wait(1)
Call VerifyifGuiLabelExists(DT_FB65_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_BSCHL)
Call VerifyifGuiLabelExists(DT_FB65_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_KTONR) 

Call ClickLabel("Account","",False)
Call ClickButton("Define filter criteria   \(Ctrl\+Shift\+F2\)",False)
Wait(3)
Call SetTextbox("Account","%%DYN001-LOW","",DT_FB65_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_KTONR,True)
Call ClickButton("Execute   \(Enter\)",True)
Wait(1)
Call VerifyifGuiLabelExists(DT_FB65_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_BSCHL)
Call VerifyifGuiLabelExists(DT_FB65_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_KTONR) 
