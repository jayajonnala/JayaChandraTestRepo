...
gstrTestCaseName = "Test_Reverse AP Document_p11_TASE"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\TASE Files\DATA\DT_Reverse AP Document_p11_TASE.xls"
''//---------------------------------------------------------------------------------------------------------------------------------------------------AUTOMATION TEST SCRIPT------------------------------------------------------------------------------------------------------------------------------------------------------------//
'
...
'Call SetTextboxIfExists("Company Code","BKPF-BUKRS","",DT_FB08_0105_COMPANY_CODE,True)
Call TakeScreenShot()
...
Call SetComboByKey("RF05A-BUSCS",DT_FB08_1100_TRANSACTN_OCC1)
...
Call SetTextbox("Incg Doc\. Nmbr","INVFO-INWARDNO_HD","",DT_FB60_0010_REFERENCE_2,False)
