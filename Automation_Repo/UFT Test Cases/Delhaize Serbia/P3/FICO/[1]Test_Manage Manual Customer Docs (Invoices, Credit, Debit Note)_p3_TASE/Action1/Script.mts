...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_Manage Manual Customer Docs (Invoices, Credit, Debit Note)_p3
'.................Author : TCS        :Jaya
'................ Creation Date    : 
'.................Modified By :
...
gstrTestCaseName = "Test_Manage Manual Customer Docs (Invoices, Credit, Debit Note)_p3_TASE"
...
Call SetComboByKey("INVFO-BLART", DT_FB75_0510_DOCUMENT_TYPE_OCC1)
...
Call GetStatusBar("item1","DT_FB75_1200_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OUTPUT")
Call VerifyStatusBar("Document "&DT_FB75_1200_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OUTPUT&" was posted in company code RS01")
Call WriteRunTimeDataToExcelGlobalSheet("DT_FB75_1200_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OUTPUT",DT_FB75_1200_CHECK_MESSAGEPARAMETER_OF_STATUSBAR)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
