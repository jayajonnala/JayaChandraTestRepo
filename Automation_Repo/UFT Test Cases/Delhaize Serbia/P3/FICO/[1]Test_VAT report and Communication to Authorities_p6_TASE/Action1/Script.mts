...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name :Test_VAT report and Communication to Authorities_p6
'.................Author : TCS 
'................ Creation Date :
'.................Modified By :
...
gstrTestCaseName = "Test_VAT report and Communication to Authorities_p6"
...
Call SetTextbox("Tax on sales/purchases code","SEL_MWKZ-LOW","","",False)
...
Call SetTextboxNOLabel("SEL_MONA-LOW","","",False)
Call TakeScreenShot
Call ClickButton("Execute   \(F8\)", False)
Call TakeScreenShot
Call VerifyifGuiLabelExists_ByIndex(DT_S_ALR_87012357_0120_CHECK_TEXT_OF_RS01,0)
Call VerifyifGuiLabelExists_ByIndex(DT_S_ALR_87012357_0120_CHECK_TEXT_OF_MS,0)
