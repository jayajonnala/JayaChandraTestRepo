...
'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_Manage Manual Vendor Invoicing Crediting (Non PO Invoices)_p1_TASE
'.................Author : TCS        :Bitan
'................ Creation Date    : 26th April
'.................Modified By :
'.................Modified Date/Details :

'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//

gstrTestCaseName = "Test_Manage Manual Vendor Invoicing Crediting (Non PO Invoices)_p1_TASE"
gstrTCDescription = ""'.....Please give TestCase Description.
gstrTCPrerequisite = ""'.....Please mention the pre-requisites for TestCase If any.
'gstrInputExcelFilePathAndName="C:\TASE Files\DATA\DT_Manage Manual Vendor Invoicing  Crediting (Non PO Invoices)_p1_TASE.xls"
''//---------------------------------------------------------------------------------------------------------------------------------------------------AUTOMATION TEST SCRIPT------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
Call ClickLabel("Account","",False)
Call ClickButton("Define filter criteria   \(Ctrl\+Shift\+F2\)",False)
Wait(3)
Call SetTextbox("Account","%%DYN001-LOW","",DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_KTONR,True)
...
Call ClickButton("Define filter criteria   \(Ctrl\+Shift\+F2\)",False)
Wait(3)
Call SetTextbox("Account","%%DYN001-LOW","",DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_KTONR,True)
Call ClickButton("Execute   \(Enter\)",True)
Wait(1)
Call VerifyifGuiLabelExists(DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_BSCHL)
Call VerifyifGuiLabelExists(DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_KTONR) 

Call SelectMenuBar("Edit;Delete filter")
Wait(2)
...
Call SetTextbox("Invoice date","INVFO-BLDAT","",Replace((DT_FB60_0010_INVOICE_DATE_OCC1),"/","."),False)
...
'Select Calculate Tax field as true
Call SelectCheckbox("INVFO-XMWST",0,DT_FB60_0010_CALCULATE_TAX_OCC1,False)
Call Clickbuttonifexist("Continue   \(Enter\)",True)
Call PressEnter()
Call Clickbuttonifexist("Continue   \(Enter\)",True)

'set table data
Call SetTableDataNoRef("SAPLFSKBTABLE","G/L acct",1,DT_FB60_0100_TABLECELL_GL_ACCT_0_OCC1,False)
Call SetTableDataNoRef("SAPLFSKBTABLE","Amount in doc.curr.",1,DT_FB60_0100_TABLECELL_AMOUNT_IN_DOCCURR_0_OCC1,False)
Call SetTableDataNoRef("SAPLFSKBTABLE","Tax code",1,DT_FB60_0100_TABLECELL_TAX_CODE_0_OCC1,False)
Call SetTableDataNoRef("SAPLFSKBTABLE","Business area",1,DT_FB60_0100_TABLECELL_BUSINESS_AREA_0_OCC1,False)
Call SetTableDataNoRef("SAPLFSKBTABLE","Cost center",1,DT_FB60_0100_TABLECELL_COST_CENTER_0_OCC1,False)
Call PressEnter()
'Capture the screenshot
Call TakeScreenShot()
...
Call Clickbuttonifexist("Continue   \(Enter\)",True)
wait(1)
Call SetTextbox("Part\. bank","INVFO-BVTYP","",DT_FB60_0020_PART_BANK_OCC1,False)
Call PressEnter()
'Capture the screenshot
Call TakeScreenShot()
...
Call SetTextArea(DT_FB60_0040_TEXTEDIT_SHELL_OCC1)
'Capture the screenshot
Call TakeScreenShot()
...
'validate components
Call VerifyifGuiLabelExists(DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_BSCHL_OCC1)
Call VerifyifGuiLabelExists(DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_0_KTONR_OCC1)

Call ClickLabel("Account","",False)
Call ClickButton("Define filter criteria   \(Ctrl\+Shift\+F2\)",False)
Wait(1)
Call SetTextbox("Account","%%DYN001-LOW","",DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_KTONR_OCC1,True)
Call ClickButton("Execute   \(Enter\)",True)
Wait(1)
Call VerifyifGuiLabelExists(DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_BSCHL_OCC1)
Call VerifyifGuiLabelExists(DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_1_KTONR_OCC1) 

Call ClickLabel("Account","",False)
Call ClickButton("Define filter criteria   \(Ctrl\+Shift\+F2\)",False)
Wait(1)
Call SetTextbox("Account","%%DYN001-LOW","",DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_KTONR_OCC1,True)
Call ClickButton("Execute   \(Enter\)",True)
Wait(1)
Call VerifyifGuiLabelExists(DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_BSCHL_OCC1)
Call VerifyifGuiLabelExists(DT_FB60_0750_CHECK_GETCELLVALUE_OF_GRIDCELL_2_KTONR_OCC1) 
...
Call TakeScreenShot()
'Validate If document is posted and get the status bar nummber
Call GetStatusBar("item1","DT_FB60_1100_CHECK_MESSAGEPARAMETER_OF_STATUSBAR_OCC1_OUTPUT")
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)

VerifyStatusBar(DT_FB60_1100_CHECK_TEXT_OF_STATUSBAR_OCC1)
'Capture the screenshot
Call TakeScreenShot()
