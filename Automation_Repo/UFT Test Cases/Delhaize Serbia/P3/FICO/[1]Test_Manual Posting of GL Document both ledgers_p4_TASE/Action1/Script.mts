'//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
'.................Test Script Name : Test_Manual Posting of GL Document both ledgers_p4
'.................Author : TCS        
'................ Creation Date    : 
'.................Modified By :
...
gstrTestCaseName = "Test_Manual Posting of GL Document both ledgers_p4_TASE"
...
Call GetStatusBar("item1","DT_FB01_0100_CHECK_TEXT_OF_STATUSBAR_OUTPUT")
Call TakeScreenShot
Call VerifyStatusBar("Document "&DT_FB01_0100_CHECK_TEXT_OF_STATUSBAR_OUTPUT&" was posted in company code RS01")
Call WriteRunTimeDataToExcelGlobalSheet ("DT_FB01_0100_CHECK_TEXT_OF_STATUSBAR_OUTPUT",DT_FB01_0100_CHECK_TEXT_OF_STATUSBAR)
Call GetInputFromExcel(gstrInputExcelFilePathAndName,"Global",DataRowSet)
