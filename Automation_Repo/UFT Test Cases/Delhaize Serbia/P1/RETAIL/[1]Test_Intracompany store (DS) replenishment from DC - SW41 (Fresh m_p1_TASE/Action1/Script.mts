...
gstrTestCaseName = "Test_Intracompany store (DS) SW41 (Fresh m_p1"
...
'''Call GetTableCellData("SAPLMEGUITC_1211","Item",1,"Article",DT_ME21N_1211_TABLECELL_ARTICLE_0,"DT_ME21N_1211_CHECK_TEXT_OF_TABLECELL_ITM_0",False)
...
'Call SetTableData("SAPLMEGUITC_1211","Cent. Contract Item","1","","",DT_CENTRALCONTRACTITEM,False)
'Call TakeScreenShot()
'Call VerifyTableCellContent(1,"Cent. Contract Item","SAPLMEGUITC_1211",DT_ME21N_1211_CHECK_TEXT_OF_TABLECELL_CENT_CONTRACT_ITEM_1)
'Call SetTableData("SAPLMEGUITC_1211","Cent. Contract Item","2","","",DT_CENTRALCONTRACTITEM_1,False)
'Call SetTableData("SAPLMEGUITC_1211","Cent. Contract Item","3","","",DT_CENTRALCONTRACTITEM_2,False)
Call PressEnter()
...
''''''''''''Lines of code from Line 158 to Line 192  implemented as part of the resolution provided for the defect 34372"""""""""""""""""""
...
''''''''''''''Lines of code from Line 192 to Line 227  implemented as part of the resolution provided for the defect 34372"""""""""""""""""""
''
''Call SetTcode(DT_VL10G_0500_OKCD) 
''Call PressEnter()  
''Call TakeScreenShot
