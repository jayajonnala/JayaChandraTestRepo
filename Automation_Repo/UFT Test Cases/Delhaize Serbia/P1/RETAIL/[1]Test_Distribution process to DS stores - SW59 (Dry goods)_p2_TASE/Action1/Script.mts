...
gstrTestCaseName = "Test_Distribution process to DS stores - SW59 (Dry goods)_p2"
...
Call FindRowNumber("SAPDV70ATC_NAST3", "Output Type", DT_VL03N_0100_CHECK_TEXT_OF_TABLECELL_OUTPUT_TYPE_3, "DT_RowNumber")
wait(2)
Call VerifyTableCellContent(DT_RowNumber,"Output Type","SAPDV70ATC_NAST3",DT_VL03N_0100_CHECK_TEXT_OF_TABLECELL_OUTPUT_TYPE_3)
