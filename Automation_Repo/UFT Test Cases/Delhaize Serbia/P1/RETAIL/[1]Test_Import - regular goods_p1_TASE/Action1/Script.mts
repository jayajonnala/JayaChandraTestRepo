...
Call TakeScreenShot()
'
'Navigate to Conditions Tab and Set Net Price
...
Call TakeScreenshot()
Call SetTextboxNoLabel("MEPO_SELECT-EBELN","",DT_PO_RETAIL_ORDER_OUTPUT,FALSE)
Call TakeScreenshot()
...
Call FindRowNumber("SAPDV70ATC_NAST3","Output Type","ZWMS","DT_ROW_NUMBER")
Call VerifyTableCellContent(DT_ROW_NUMBER,"Output Type","SAPDV70ATC_NAST3","ZWMS")
Call VerifyTableCellContent(DT_ROW_NUMBER,"Status","SAPDV70ATC_NAST3","S_TL_G")
